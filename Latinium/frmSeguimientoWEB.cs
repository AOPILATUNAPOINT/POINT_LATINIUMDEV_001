...
namespace Latinium
{
	...
	public class frmSeguimientoWEB : System.Windows.Forms.Form
	{
		...
		private void frmSeguimientoWEB_Load(object sender, System.EventArgs e)
		{
			...
			miAcceso = new Acceso(cdsSeteoF, "0229");

			if (!Funcion.Permiso("1508",cdsSeteoF))
			{				
				MessageBox.Show("No puede ingresar a Seguimiento Clientes", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop);
