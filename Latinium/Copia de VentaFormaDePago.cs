...
namespace Latinium
{
	...
	//	int IdBodega= 0;
		...
		public VentaFormaDePago(int idFormaPago, decimal dValor, int iOrigen, bool bPagoCredito, DateTime DTFecha, int idBodega)
		{
			InitializeComponent();
		...
		public VentaFormaDePago(int idCompra, int idFormaPago, decimal dValor, int iOrigen, DateTime DTFecha, int idBodega)
		{
			InitializeComponent();
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(VentaFormaDePago));
			...
			ultraGridColumn26.CellButtonAppearance = appearance7;
			...
			this.spnEfectivo.Appearance = appearance13;
			...
			this.spnRetencion.Appearance = appearance14;
		...
		{			
			...
			this.cmbFormaPago.DataSource = Funcion.dvProcedimiento(cdsSeteoF, string.Format("Exec FormasDePagoIngresoDeCaja {0}, {1}, {2}, {3}, {4}, {5}, {6}, {7}", 
				IdFormaDePago, IdOrigen, BAnticipoFact, BRetencionFact, BNotaDeCreditoFact, BCredito, bModificaCaja, IdBodega));
