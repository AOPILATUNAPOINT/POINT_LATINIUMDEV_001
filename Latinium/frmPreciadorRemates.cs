...
namespace Latinium
{
	...
	public class frmPreciadorRemates : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn4 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Impreso");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn8 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Fecha_Llegada");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn10 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("DescPorc");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn11 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Descuento");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn12 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Precio_Normal");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn13 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Precio_Remate");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn14 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("ValorCuota");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn6 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Impreso");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn10 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Fecha_Llegada");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn12 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("DescPorc");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn14 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Precio_Normal");
			Infragistics.Win.Appearance appearance7 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn15 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Precio_Remate");
			Infragistics.Win.Appearance appearance8 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn16 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("ValorCuota");
			...
			this.btnExcel.Location = new System.Drawing.Point(1148, 39);
			...
			this.btnImprimir.Location = new System.Drawing.Point(1060, 40);
			...
			ultraGridColumn6.Header.Caption = "I";
			...
			ultraGridColumn15.Header.Caption = "Precio Remate";
			...
			ultraGridColumn16.Header.Caption = "Valor Cuota";
			...
			this.ultraGrid1.Size = new System.Drawing.Size(1218, 272);
			...
			this.groupBox1.Size = new System.Drawing.Size(1236, 8);
			...
			this.optFiltro.Location = new System.Drawing.Point(606, 6);
			...
			this.label2.Location = new System.Drawing.Point(943, 10);
			...
			this.cmbBodega.Location = new System.Drawing.Point(1007, 7);
		...
		private void frmPreciadorRemates_Load(object sender, System.EventArgs e)
		{
			...
			this.cmbBodega.DataSource = Funcion.dvProcedimiento(cdsSeteoF, string.Format("Exec FacturacionListaBodegasRemate {0}", MenuLatinium.IdUsuario));
		...
		private void Consulta()
		{
			...
			string sSQL = string.Format("Exec RMListaImpresionDePrecios {0}, {1}, '{2}', {3}, {4}", 
				idSubgrupo, (int)this.rdgPreciador.EditValue, this.txtBuscar.Text.ToString(), 0, iBodega);
		...
		{			
			...
			string sSQL = string.Format("Select DirPrecRemGrande, DirPrecRemMediano, DirPrecRemPequeño From Bodega Where Bodega = {0}", (int)this.cmbBodega.Value);
...
//			Consulta();
		...
		private void ultraGrid1_AfterCellUpdate(object sender, Infragistics.Win.UltraWinGrid.CellEventArgs e)
		{
			...
			{	
				...
				decimal dNuevoPrecioSinIVA = Convert.ToDecimal(e.Cell.Row.Cells["Precio_Remate"].Value)/dIVA; // 1.15m;
