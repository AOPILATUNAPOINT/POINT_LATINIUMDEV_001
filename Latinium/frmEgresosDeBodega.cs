...
namespace Latinium
{
	...
	public class frmEgresosDeBodega : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtIdCompra.ValueChanged += new System.EventHandler(this.txtIdCompra_ValueChanged);
			// 
			// txtIdCliente
			// 
		...
		private void btnNuevo_Click(object sender, System.EventArgs e)
		{
			...
			bAutorizaEgreso = Funcion.bEscalarSQL(cdsSeteoF, "SELECT AutorizaEgreso FROM SeteoF", true);
		...
		private void btnGuardar_Click(object sender, System.EventArgs e)
		{
			...
			using (SqlConnection oConexion = new SqlConnection("Password=Bl45o6$9;Persist Security Info=True;User ID= " + MenuLatinium.stUsuario + ";Initial Catalog=" + MenuLatinium.stDirFacturacion + ";Data Source=" + MenuLatinium.stDirServidor + ";Max Pool Size = 1024;"))
			{
				...
				{							
					...
					if(!bAutorizaEgreso)
					{
						oCmdActualiza.CommandText = string.Format("Exec GuardaMovimientosInventario {0}, 8", (int)this.txtIdCompra.Value);
						oCmdActualiza.ExecuteNonQuery();
					}
		...
		private void txtIdCompra_ValueChanged(object sender, System.EventArgs e)
		{
