...
namespace Latinium
{
	...
	/// </summary>
	public class MMarca : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridBand ultraGridBand1 = new Infragistics.Win.UltraWinGrid.UltraGridBand("MarceloMarca", -1);
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idMarceloMarca");
			...
			this.ultraGrid1.DataMember = "MarceloMarca";
			this.ultraGrid1.DataSource = this.cdsMMarca;
		...
		private void MMarca_Load(object sender, System.EventArgs e)
		{
			...
			Funcion.EjecutaSQL(cdsMMarca , stAudita, true);
		}
