...
{
	/// <summary>
	/// Descripción breve de frmArtCapacidad.
	/// </summary>
	public class frmArtCapacidad : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idArtCapacidad");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn2 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Capacidad");
			Infragistics.Win.Appearance appearance2 = new Infragistics.Win.Appearance();
			Infragistics.Win.Appearance appearance3 = new Infragistics.Win.Appearance();
			Infragistics.Win.Appearance appearance4 = new Infragistics.Win.Appearance();
			Infragistics.Win.Appearance appearance5 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn1 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idArtCapacidad");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn2 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Capacidad");
			...
			this.Name = "frmArtCapacidad";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Capacidad";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmArtCapacidad_KeyDown);
			this.Load += new System.EventHandler(this.frmArtCapacidad_Load);
		...
		private void frmArtCapacidad_Load(object sender, System.EventArgs e)
		{
			this.ultraGrid1.DataSource = Funcion.dvProcedimiento(cdsSeteoF, string.Format("Select idArtCapacidad, Capacidad From ArtCapacidad Order By Capacidad"));
		}
		...
		private void frmArtCapacidad_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
		...
		private void btAceptar_Click(object sender, System.EventArgs e)
		{
			...
			{
				if ((int)drr.Cells["idArtCapacidad"].Value == 0 || (int)drr.Cells["idArtCapacidad"].Value > 0)
				{
					string sSQLDetalle = string.Format("Exec InsertaAtributosArticulos {0}, '{1}', {2}", 
						drr.Cells["idArtCapacidad"].Value,
						drr.Cells["Capacidad"].Value.ToString(), 11);     
		...
		{
			e.Row.Cells["idArtCapacidad"].Value = 0;
		}
