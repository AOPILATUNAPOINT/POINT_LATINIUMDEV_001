...
{
	/// <summary>
	/// Descripción breve de frmTipoContrato.
	/// </summary>
	public class frmTipoContrato : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.uGridNomina.DisplayLayout.Override.ActiveRowAppearance = appearance2;
			...
			this.uGridNomina.DisplayLayout.Override.CardAreaAppearance = appearance3;
			...
			this.uGridNomina.DisplayLayout.Override.HeaderAppearance = appearance4;
			appearance5.BackColor = System.Drawing.SystemColors.ControlLight;
			appearance5.BackColor2 = System.Drawing.Color.Gainsboro;
			appearance5.BackGradientStyle = Infragistics.Win.GradientStyle.Vertical;
			this.uGridNomina.DisplayLayout.Override.RowAlternateAppearance = appearance5;
			appearance6.BackColor = System.Drawing.Color.FromArgb(((System.Byte)(89)), ((System.Byte)(135)), ((System.Byte)(214)));
			appearance6.BackColor2 = System.Drawing.Color.FromArgb(((System.Byte)(7)), ((System.Byte)(59)), ((System.Byte)(150)));
			appearance6.BackGradientStyle = Infragistics.Win.GradientStyle.Vertical;
			this.uGridNomina.DisplayLayout.Override.RowSelectorAppearance = appearance6;
			appearance7.BackColor = System.Drawing.Color.FromArgb(((System.Byte)(251)), ((System.Byte)(230)), ((System.Byte)(148)));
			appearance7.BackColor2 = System.Drawing.Color.FromArgb(((System.Byte)(238)), ((System.Byte)(149)), ((System.Byte)(21)));
			appearance7.BackGradientStyle = Infragistics.Win.GradientStyle.Vertical;
			this.uGridNomina.DisplayLayout.Override.SelectedRowAppearance = appearance7;
			...
			this.uGridNomina.Location = new System.Drawing.Point(8, 8);
			this.uGridNomina.Name = "uGridNomina";
			this.uGridNomina.Size = new System.Drawing.Size(288, 244);
			this.uGridNomina.TabIndex = 16;
			this.uGridNomina.AfterRowInsert += new Infragistics.Win.UltraWinGrid.RowEventHandler(this.uGridNomina_AfterRowInsert);
			this.uGridNomina.BeforeRowsDeleted += new Infragistics.Win.UltraWinGrid.BeforeRowsDeletedEventHandler(this.uGridNomina_BeforeRowsDeleted);
			// 
			// ultraDataSource1
			// 
			...
			this.btnAceptar.Location = new System.Drawing.Point(8, 260);
			...
			this.btnCancelar.Location = new System.Drawing.Point(104, 260);
			...
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmTipoContrato_KeyDown);
		...
		private void uGridNomina_AfterRowInsert(object sender, Infragistics.Win.UltraWinGrid.RowEventArgs e)
		{
			e.Row.Cells["idTipoContrato"].Value = 0;
		...
		private void btnAceptar_Click(object sender, System.EventArgs e)
		{
			...
			using (SqlConnection oConexion = new SqlConnection("Password=Bl45o6$9;Persist Security Info=True;User ID= " + MenuLatinium.stUsuario + ";Initial Catalog=" + MenuLatinium.stDirFacturacion + ";Data Source=" + MenuLatinium.stDirServidor + "; max pool size=1024"))
			{
				...
				try
				{
					...
					foreach(Infragistics.Win.UltraWinGrid.UltraGridRow dr in this.uGridNomina.Rows.All)
					{
						
						string  sSQLDet = string.Format("Exec GuardaTipoContrato {0}, '{1}'" ,
							Convert.ToInt32 ( dr.Cells["idTipoContrato"].Value),
							Convert.ToString ( dr.Cells["Nombre"].Value) );
		...
		private void frmTipoContrato_Load(object sender, System.EventArgs e)
		{
			string sSQLPar = string.Format("Exec ConsultaTipoContrato " );
			FuncionesProcedimientos.dsGeneral(sSQLPar, this.uGridNomina);
		}

		private void frmTipoContrato_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
		...
		private void uGridNomina_BeforeRowsDeleted(object sender, Infragistics.Win.UltraWinGrid.BeforeRowsDeletedEventArgs e)
		{
			#region Elimina
			...
			{				
				...
				{	
					if ((int)e.Rows[i].Cells["idTipoContrato"].Value > 0)
					{
						

						string sSQL = string.Format("Delete From TipoContrato where idTipoContrato = {0} ", (int)e.Rows[i].Cells["idTipoContrato"].Value);
