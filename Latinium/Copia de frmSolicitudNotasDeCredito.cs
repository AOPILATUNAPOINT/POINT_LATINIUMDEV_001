...
namespace Latinium
{
	...
	public class frmSolicitudNotasDeCredito : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.uGridFacturas.DisplayLayout.Override.ActiveRowAppearance = appearance3;
			appearance4.BackColor = System.Drawing.Color.Transparent;
			this.uGridFacturas.DisplayLayout.Override.CardAreaAppearance = appearance4;
			...
			this.uGridFacturas.DisplayLayout.Override.HeaderAppearance = appearance5;
			...
			this.uGridFacturas.DisplayLayout.Override.RowAlternateAppearance = appearance6;
			appearance7.BackColor = System.Drawing.Color.FromArgb(((System.Byte)(89)), ((System.Byte)(135)), ((System.Byte)(214)));
			appearance7.BackColor2 = System.Drawing.Color.FromArgb(((System.Byte)(7)), ((System.Byte)(59)), ((System.Byte)(150)));
			appearance7.BackGradientStyle = Infragistics.Win.GradientStyle.Vertical;
			this.uGridFacturas.DisplayLayout.Override.RowSelectorAppearance = appearance7;
			appearance8.BackColor = System.Drawing.Color.FromArgb(((System.Byte)(251)), ((System.Byte)(230)), ((System.Byte)(148)));
			appearance8.BackColor2 = System.Drawing.Color.FromArgb(((System.Byte)(238)), ((System.Byte)(149)), ((System.Byte)(21)));
			appearance8.BackGradientStyle = Infragistics.Win.GradientStyle.Vertical;
			this.uGridFacturas.DisplayLayout.Override.SelectedRowAppearance = appearance8;
			...
			this.cmbMotivos.Appearance = appearance12;
			...
			this.cmbMotivos.Location = new System.Drawing.Point(64, 40);
		...
		private void frmSolicitudNotasDeCredito_Load(object sender, System.EventArgs e)
		{
			...
			int iBodPred = Funcion.iEscalarSQL(cdsSeteoF, sSQL);
		...
		private void Consulta()
		{
			...
			if(miAcceso.Buscar)
			{
				if(idMotivo == 4)
				{
					string sSQL = string.Format("Exec SolicitudNotasDeCredito '{0}', {1}, {2}, {3}, '{4}', 0,1", 
			...
			{
				string sSQL = string.Format("Exec SolicitudNotasDeCredito '{0}', {1}, {2}, {3}, '{4}', 0,0", 
					dtFecha.ToString("yyyyMMdd"), iBodega, (int)this.optEstados.Value, idMotivo, this.txtBusqueda.Text.ToString());
				FuncionesProcedimientos.dsGeneral(sSQL, this.uGridFacturas);
			}
		}
...
//				idBloqueaTransacciones = Funcion.iEscalarSQL(cdsSeteoF, sSQLBloqueo, true);
				...
				using (SqlConnection oConexion = new SqlConnection("Password=Bl45o6$9;Persist Security Info=True;User ID= " + MenuLatinium.stUsuario + ";Initial Catalog=" + MenuLatinium.stDirFacturacion + ";Data Source=" + MenuLatinium.stDirServidor + "; max pool size=1024"))
				{
					...
					try
					{
						...
						//						oCmdActualiza.CommandText = string.Format("Exec RegistraBloqueoTransacciones {0}, 0, {1}, 1", idBloqueaTransacciones, (int)this.txtNumIdCompra.Value);
						//						oCmdActualiza.ExecuteNonQuery	();
...
//				if ((int)e.Cell.Row.Cells["EstadoSolNC"].Value == 4) return;
				...
				if ((int)e.Cell.Row.Cells["EstadoSolNC"].Value == 1)
				{
					#region Aprobacion Solicitud Hasta 5 dias de la factura
					if (iDias > 0 && iDias < 6)
					{
						if (!miAcceso.B30DiasCobro)
						{
							MessageBox.Show("No Tiene Acceso a Aprobar Notas De Credito", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop); 
							return;
						}
				...
				if ((int)e.Cell.Row.Cells["EstadoSolNC"].Value == 2)
				{									
					if ((int)this.cmbMotivos.Value == 45 )
					{
						using(frmVenta Venta = new frmVenta((int)e.Cell.Row.Cells["idCompra"].Value, true, (int)this.cmbMotivos.Value, Convert.ToDecimal(e.Cell.Row.Cells["Total"].Value)))
