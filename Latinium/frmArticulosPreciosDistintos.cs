...
{
	/// <summary>
	/// Summary description for frmArticulosPreciosDistintos.
	/// </summary>
	public class frmArticulosPreciosDistintos : DevExpress.XtraEditors.XtraForm
	{
		...
		public frmArticulosPreciosDistintos()
		{
			//
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn4 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Distribuidor");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn4 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Distribuidor");
			...
			this.uGridArticulos.Location = new System.Drawing.Point(8, 8);
			this.uGridArticulos.Name = "uGridArticulos";
			this.uGridArticulos.Size = new System.Drawing.Size(506, 328);
			this.uGridArticulos.TabIndex = 660;
			this.uGridArticulos.UpdateMode = Infragistics.Win.UltraWinGrid.UpdateMode.OnCellChange;
			// 
			// ultraDataSource1
			// 
			...
			this.Name = "frmArticulosPreciosDistintos";
			this.Text = "frmArticulosPreciosDistintos";
			this.Load += new System.EventHandler(this.frmArticulosPreciosDistintos_Load);
		...
		private void frmArticulosPreciosDistintos_Load(object sender, System.EventArgs e)
		{
			this.uGridArticulos.DataSource = Funcion.dvProcedimiento (cdsSeteoF, "Exec ValidaPreciosArticulos");
		}
	}
}
