...
namespace Latinium
{
	...
	public class frmReportesArticulosPorComprar : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.uGridTransferencias.Size = new System.Drawing.Size(1238, 352);
			...
			this.groupBox1.Size = new System.Drawing.Size(1254, 8);
			...
			this.btnCalcular.Location = new System.Drawing.Point(1174, 5);
			...
			this.btnExcel.Location = new System.Drawing.Point(1174, 37);
			...
			this.lblEstado.Location = new System.Drawing.Point(945, 7);
			...
			this.ClientSize = new System.Drawing.Size(1254, 446);
		...
		private void btnCalcular_Click(object sender, System.EventArgs e)
		{
			...
			string sSQL = string.Format("Exec CalculoArticulosCompra '{0}', {1}, {2}", 
				Convert.ToDateTime(this.dtFecha.Value).ToString("yyyyMMdd"), (int)this.txtRangoDias.Value, (int)this.txtDiasAbastecimiento.Value);
