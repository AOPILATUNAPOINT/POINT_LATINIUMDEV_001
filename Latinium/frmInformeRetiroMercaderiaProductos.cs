...
namespace Latinium
{
	...
	public class frmInformeRetiroMercaderiaProductos : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn59 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Valor");
			Infragistics.Win.Appearance appearance21 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn60 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("btnRevisionDT", 0);
			...
			Infragistics.Win.UltraWinGrid.SummarySettings summarySettings9 = new Infragistics.Win.UltraWinGrid.SummarySettings("", Infragistics.Win.UltraWinGrid.SummaryType.Sum, null, "Valor", 58, true, "Band 0", 0, Infragistics.Win.UltraWinGrid.SummaryPosition.UseSummaryPositionColumn, "Valor", 58, true);
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn59 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Valor");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn60 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idDTEstado");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn61 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Descripcion");
			Infragistics.Win.UltraWinGrid.UltraGridBand ultraGridBand2 = new Infragistics.Win.UltraWinGrid.UltraGridBand("Band 0", -1);
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn61 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idDTEstado");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn63 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Bodega");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn64 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Nombre");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn65 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Codigo", 0);
			Infragistics.Win.Appearance appearance42 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinGrid.UltraGridBand ultraGridBand4 = new Infragistics.Win.UltraWinGrid.UltraGridBand("Band 0", -1);
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn66 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Bodega");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn67 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Nombre");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn68 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Codigo", 0);
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn62 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idSubgrupo");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn63 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("SubGrupo");
			Infragistics.Win.Appearance appearance43 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinGrid.UltraGridBand ultraGridBand5 = new Infragistics.Win.UltraWinGrid.UltraGridBand("Band 0", -1);
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn69 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idSubgrupo");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn70 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("SubGrupo");
			...
			ultraGridColumn19.Header.VisiblePosition = 56;
			...
			ultraGridColumn59.CellAppearance = appearance21;
			...
			ultraGridColumn60.CellButtonAppearance = appearance22;
			...
			summarySettings5.Appearance = appearance27;
			summarySettings5.DisplayFormat = "{0: #,##0.00}";
			summarySettings5.ShowCalculatingText = Infragistics.Win.DefaultableBoolean.False;
			appearance28.TextHAlign = Infragistics.Win.HAlign.Right;
			summarySettings6.Appearance = appearance28;
			summarySettings6.DisplayFormat = "{0: #,##0.00}";
			summarySettings6.ShowCalculatingText = Infragistics.Win.DefaultableBoolean.False;
			appearance29.TextHAlign = Infragistics.Win.HAlign.Right;
			summarySettings7.Appearance = appearance29;
			summarySettings7.DisplayFormat = "{0: #,##0.00}";
			summarySettings7.ShowCalculatingText = Infragistics.Win.DefaultableBoolean.False;
			appearance30.TextHAlign = Infragistics.Win.HAlign.Right;
			summarySettings8.Appearance = appearance30;
			summarySettings8.DisplayFormat = "{0: #,##0.00}";
			summarySettings8.ShowCalculatingText = Infragistics.Win.DefaultableBoolean.False;
			appearance31.TextHAlign = Infragistics.Win.HAlign.Right;
			summarySettings9.Appearance = appearance31;
			...
			this.uGridInformacion.DisplayLayout.Override.CardAreaAppearance = appearance32;
			appearance33.ForeColor = System.Drawing.Color.Black;
			appearance33.ForeColorDisabled = System.Drawing.Color.Black;
			this.uGridInformacion.DisplayLayout.Override.CellAppearance = appearance33;
			...
			this.uGridInformacion.DisplayLayout.Override.HeaderAppearance = appearance34;
			...
			this.uGridInformacion.DisplayLayout.Override.RowSelectorAppearance = appearance35;
			...
			this.uGridInformacion.DisplayLayout.Override.SelectedRowAppearance = appearance36;
			...
			this.optTipo.Appearance = appearance39;
			this.optTipo.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid;
			this.optTipo.ItemAppearance = appearance40;
			...
			this.cmbBodegaDestino.Appearance = appearance42;
			...
			this.cmbSubGrupo.Appearance = appearance43;
			...
			ultraGridColumn70.Header.Caption = "Subgrupo";
			ultraGridColumn70.Header.VisiblePosition = 1;
			ultraGridColumn70.Width = 300;
		...
		{		
			...
			if (!Funcion.Permiso("641", cdsSeteoF))
			{				
				MessageBox.Show("No Puede Ingresar a Informe de Retiro de Mercaderia por Articulo", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop);
			...
			this.cmbBodega.DataSource = Funcion.dvProcedimiento(cdsSeteoF, "Select Codigo, Nombre, Bodega From Bodega Where Bodega In (20, 95)");
			...
			{
				this.cmbBodegaDestino.DataSource = Funcion.dvProcedimiento(cdsSeteoF, 
					string.Format("Select Codigo, Nombre, Bodega From Bodega Where Remates = 1 And '{0}' Between FechaApertura And ISNULL(FechaCierre, '20301231') Order By Nombre", DateTime.Today.ToString("yyyyMMdd")));
				//this.cmbBodegaDestino.Value = 79;
			...
			if (e.Cell.Column.ToString() == "btnRevisionDT")
			{
				...
				{					
					...
					{						
						...
						decimal dNuevoCosto = Convert.ToDecimal(e.Cell.Row.Cells["NuevoCosto"].Value);
						if ((string)e.Cell.Row.Cells["Origen"].Value == "RETIRO NUEVO") dNuevoCosto = Convert.ToDecimal(e.Cell.Row.Cells["NuevoCosto"].Value);
						...
						using (frmComprasEstado EstadosDT = new frmComprasEstado((int)e.Cell.Row.Cells["idDetalleIngresoRetiro"].Value, 
										 ...
										 dNuevoCosto, //Convert.ToDecimal(e.Cell.Row.Cells["NuevoCosto"].Value), 
...
//			this.uGridInformacion.DisplayLayout.Bands[0].Columns["EstadoAccesoriosM"].Hidden = bEstado;
		...
		private void btnTransferir_Click(object sender, System.EventArgs e)
		{
			...
			#region Valida serial duplicada
...
//					bool bSerialD = false;
//
//					foreach(Infragistics.Win.UltraWinGrid.UltraGridRow dr1 in uGridInformacion.Rows.All)
//					{
//						if ((bool)dr1.Cells["SelTF"].Value)
//						{
//							if (sSerial == dr1.Cells["Serial"].Value.ToString())
//							{
//								MessageBox.Show(string.Format("La serial {0} esta duplicada", dr.Cells["Serial"].Value.ToString()), "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop);														
//								bSerialD = true;
//								break;
//							}							
//						}
...
//				}
//			}
			#endregion Valida serial duplicada
			...
			using (SqlConnection oConexion = new SqlConnection("Password=Bl45o6$9;Persist Security Info=True;User ID= " + MenuLatinium.stUsuario + ";Initial Catalog=" + MenuLatinium.stDirFacturacion + ";Data Source=" + MenuLatinium.stDirServidor + ";Max Pool Size = 2048;"))
			{
				...
				{							
					...
					string sSQLIE = string.Format("Exec CreaIEBodegaTFDTRemates {0}, {1}, {2}", idTransferencia, iBodega, iBodegaDestino);
				  ...
				  #region Guarda Detalle de transferencia
					...
					oCmdActualiza.CommandText = string.Format("Exec GuardaMovimientosInventario {0}, 8", idCompraE);
					oCmdActualiza.ExecuteNonQuery();

					#region Asiento
					oCmdActualiza.CommandText = string.Format("Exec AsientoTransferencias {0}, 8", 
						idCompraE);
					oCmdActualiza.ExecuteNonQuery();
					#endregion Asiento
