...
namespace Latinium
{
	...
	public class frmPlanificacionHorariosDeCarpa : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtNotasAprobacion.Appearance = appearance16;
...
//			if (miAcceso.BAprobarCarpa) this.txtNotasAprobacion.Enabled = true;
		...
		private void ultraGrid1_BeforeSelectChange(object sender, Infragistics.Win.UltraWinGrid.BeforeSelectChangeEventArgs e)
		{
			...
			string sSQL = string.Format("Select COUNT(*) From HorariosDeCarpa Where idHorariosDeCarpa = {0} And '{1}' Between CONVERT(Date, Desde) And CONVERT(Date, Hasta)", 
		...
		private void btnAprobar_Click(object sender, System.EventArgs e)
		{
			...
			Funcion.EjecutaSQL(cdsSeteoF, string.Format("Update HorariosDeCarpa Set Estado = 3, NotasAprobacion = '{0}' Where idHorariosDeCarpa = {1}", this.txtNotasAprobacion.Text.ToString(), idHorariosDeCarpa));
