...
{
	/// <summary>
	/// Summary description for frmListaAnticiposCliente.
	/// </summary>
	public class frmListaAnticiposCliente : DevExpress.XtraEditors.XtraForm
	{
		...
		public frmListaAnticiposCliente()
		{
			//
		...
		public frmListaAnticiposCliente(int IdCliente)
		{
			//
			// Required for Windows Form Designer support
			//
		...
		private void InitializeComponent()
		{
			...
			this.btnAceptar.Location = new System.Drawing.Point(7, 216);
			this.btnAceptar.Name = "btnAceptar";
			this.btnAceptar.Size = new System.Drawing.Size(88, 23);
			this.btnAceptar.TabIndex = 266;
			...
			this.btnCancelar.Location = new System.Drawing.Point(103, 216);
			...
			this.uGrid.Location = new System.Drawing.Point(4, 8);
			this.uGrid.Name = "uGrid";
			this.uGrid.Size = new System.Drawing.Size(781, 200);
			this.uGrid.TabIndex = 265;
			// 
			// frmListaAnticiposCliente
			// 
			...
			this.Name = "frmListaAnticiposCliente";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Anticipos Pendientes";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmListaAnticiposCliente_KeyDown);
			this.Load += new System.EventHandler(this.frmListaAnticiposCliente_Load);
		...
		private void frmListaAnticiposCliente_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
			if (e.KeyCode == Keys.Escape) this.DialogResult = DialogResult.No;
		}

		private void frmListaAnticiposCliente_Load(object sender, System.EventArgs e)
		{
			string sSQL = string.Format("Exec ListaAnticiposPendientesDeCruzar {0}", idCliente);
