...
namespace Latinium
{
	...
	public class frmEntregaRecepcionMercaderia : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn19 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Fecha", -1, null, 0, Infragistics.Win.UltraWinGrid.SortIndicator.Ascending, false);
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn22 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("LLegada");
			Infragistics.Win.Appearance appearance17 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn23 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Hora");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn19 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("LLegada");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn20 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Hora");
			...
			this.btnImprimir.Location = new System.Drawing.Point(485, 84);
			...
			this.uGridArticulos.Size = new System.Drawing.Size(914, 294);
			...
			ultraGridColumn23.Format = "HH:mm";
			...
			this.lblContadorTransacciones.Location = new System.Drawing.Point(645, 84);
...
*/
			...
			string sSQLProc = string.Format("Exec ProcesarTransferencias {0}, {1}", (int)this.uGridTransacciones.ActiveRow.Cells["idCompra"].Value, (int)this.cmbTipoFactura.Value);
			Funcion.EjecutaSQL(cdsSeteoF, sSQLProc);							
			...
			Funcion.EjecutaSQL(cdsSeteoF, string.Format("Exec MailControlTransferencias {0}", (int)this.uGridTransacciones.ActiveRow.Cells["idCompra"].Value), true);

			DateTime dtFechaTR = (DateTime)this.uGridTransacciones.ActiveRow.Cells["Fecha"].Value;
			string sSQLActConteo = string.Format("Exec ActualizaTransferidoConteo '{0}', {1}, {2}", dtFechaTR.ToString("yyyyMMdd"), (int)this.cmbBodega.Value, (int)this.uGridTransacciones.ActiveRow.Cells["idCompra"].Value);
			...
			if ((int)this.cmbTipoFactura.Value == 9)
			{
				int idCompraIMR = Funcion.iEscalarSQL(cdsSeteoF, string.Format("Exec ERMIBRecepcionIncompleta {0}", (int)this.uGridTransacciones.ActiveRow.Cells["idCompra"].Value));
			...
			string sSQLDesbloqueoFin = string.Format("Exec RegistraBloqueoTransacciones {0}, 0, {1}, 1", idBloqueaTransacciones, (int)this.uGridTransacciones.ActiveRow.Cells["idCompra"].Value);
			Funcion.EjecutaSQL(cdsSeteoF, sSQLDesbloqueoFin, true);
		...
		private void btnGuiaDeRemision_Click(object sender, System.EventArgs e)
		{
			...
			using (frmGuiaDeRemision GuiaDeRemision = new frmGuiaDeRemision((int)this.uGridTransacciones.ActiveRow.Cells["idCompra"].Value, (int)this.cmbTipoFactura.Value, (int)this.cmbBodega.Value, bAutomatico))
			{
				...
				{	
					...
					if (bAutomatico) if (GuiaDeRemision.bNuevo) GuiaDeRemision.txtNumero.Text = Funcion.sEscalarSQL(cdsSeteoF, string.Format("Exec NumeracionLocales 30, {0}, 0", (int)this.cmbBodega.Value));
