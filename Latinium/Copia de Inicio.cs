...
namespace Latinium
{
	...
	public class Inicio : DevExpress.XtraEditors.XtraForm
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Inicio));
			...
			this.btCancelar.Location = new System.Drawing.Point(384, 168);
			...
			this.txtClave.Location = new System.Drawing.Point(296, 112);
			...
			this.btAceptar.Location = new System.Drawing.Point(296, 168);
			...
			this.txtNombre.Location = new System.Drawing.Point(296, 88);
			...
			this.cmbEmpresas.Location = new System.Drawing.Point(296, 136);
		...
		private void btAceptar_Click(object sender, System.EventArgs e)
		{
			...
			SqlConnection Conexion = new SqlConnection(@"Password=Bl45o6$9;Persist Security Info=True;User ID= 'Infoelect';Initial Catalog='INICIO';Data Source='192.168.1.186'");
			...
			string sSQL = string.Format("Select Empresa, BaseDeDatos, DirReportes, Servidor From Empresas Where idEmpresa = {0}", (int)this.cmbEmpresas.Value);
			...
			SqlConnection oConexion = new SqlConnection(@"Password=Bl45o6$9;Persist Security Info=True;User ID= 'Infoelect';Initial Catalog= " + MenuLatinium.stDirFacturacion + ";Data Source=" + MenuLatinium.stDirServidor);
			...
			if (MenuLatinium.stDirFacturacion == "INICIO") sSQLId = string.Format("Select idGrupo, idUsuario From Usuarios Where Nombre = '{0}' And Clave = '{1}' And Activo = 1", this.txtNombre.Text.ToString(), this.txtClave.Text.ToString());
...
//			if (DialogResult.No == MessageBox.Show("¿Desea usar accesos seguros?", "Confirmación", MessageBoxButtons.YesNo, MessageBoxIcon.Question)) return;
		...
		private void txtClave_Validated(object sender, System.EventArgs e)
		{
			...
			{
				SqlConnection oConexion = new SqlConnection(@"Password=Bl45o6$9;Persist Security Info=True;User ID= 'Infoelect';Initial Catalog='INICIO';Data Source='192.168.1.186'");
				...
				oCmd.CommandText = string.Format("Select e.idEmpresa, e.Empresa From Empresas e Inner Join EmpresasUsuarios eu On eu.idEmpresa = e.idEmpresa Where eu.idUsuario = {0} Order By e.Empresa", idUsuario);
				...
				SqlCommand oCmdEmp = new SqlCommand(string.Format("Select Top 1 e.idEmpresa From Empresas e Inner Join EmpresasUsuarios eu On eu.idEmpresa = e.idEmpresa Where eu.idUsuario = {0} Order By e.idEmpresa", idUsuario), oConexion);
				oConexion.Open();
