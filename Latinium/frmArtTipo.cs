...
{
	/// <summary>
	/// Descripción breve de frmArtTipo.
	/// </summary>
	public class frmArtTipo : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idArtTipo");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn1 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idArtTipo");
			...
			this.txtIdUnidadMedida.Location = new System.Drawing.Point(408, 360);
			...
			this.btCancelar.Location = new System.Drawing.Point(96, 360);
			...
			this.ultraGrid1.Size = new System.Drawing.Size(426, 344);
			...
			this.Name = "frmArtTipo";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Tipo";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmArtTipo_KeyDown);
			this.Load += new System.EventHandler(this.frmArtTipo_Load);
		...
		private void frmArtTipo_Load(object sender, System.EventArgs e)
		{
			this.ultraGrid1.DataSource = Funcion.dvProcedimiento(cdsSeteoF, string.Format("Select idArtTipo, Tipo From ArtTipo Order By Tipo"));
		

		}

		private void frmArtTipo_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
		...
		private void btAceptar_Click(object sender, System.EventArgs e)
		{
			...
			{
				if ((int)drr.Cells["idArtTipo"].Value == 0 || (int)drr.Cells["idArtTipo"].Value > 0)
				{
					string sSQLDetalle = string.Format("Exec InsertaAtributosArticulos {0}, '{1}', {2}", 
						drr.Cells["idArtTipo"].Value,
						drr.Cells["Tipo"].Value.ToString(),26);     
