...
namespace Latinium
{
	...
	public class frmModificaEntFinanciera : DevExpress.XtraEditors.XtraForm
	{
		...
		{
			miAcceso = new Acceso(cdsSeteoF, "0815");

			if (!Funcion.Permiso("575", cdsSeteoF))
			{		
				MessageBox.Show("No tiene Acceso a Modificar Entidad Financiera", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop);
