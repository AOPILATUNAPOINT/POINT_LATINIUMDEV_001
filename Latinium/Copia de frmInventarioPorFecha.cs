...
namespace Latinium
{
	...
	public class frmInventarioPorFecha : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.ultraGrid1.Size = new System.Drawing.Size(784, 336);
			...
			this.btnExportar.Location = new System.Drawing.Point(708, 7);
		...
		private void btnVer_Click(object sender, System.EventArgs e)
		{
			...
			string sSQL = string.Format("Exec InventariosPorFecha '{0}', {1}, '{2}'", dtHasta.ToString("yyyyMMdd"), Bodega, this.txtBuscar.Text.ToString());
