...
{
	/// <summary>
	/// Descripción breve de frmArtMarca.
	/// </summary>
	public class frmArtMarca : System.Windows.Forms.Form
	{
		...
		int idArtMarca = 0;
		public frmArtMarca(int IdArtMarca)
		{
			idArtMarca = IdArtMarca;
			//
			// Necesario para admitir el Diseñador de Windows Forms
			//
			InitializeComponent();
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idArtMarca");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn1 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idArtMarca");
			...
			this.Name = "frmArtMarca";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Marca";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmArtMarca_KeyDown);
			this.Load += new System.EventHandler(this.frmArtMarca_Load);
		...
		private void btAceptar_Click(object sender, System.EventArgs e)
		{
			...
			{
				if ((int)drr.Cells["idArtMarca"].Value == 0 || (int)drr.Cells["idArtMarca"].Value > 0)
				{
					string sSQLDetalle = string.Format("Exec InsertaAtributosArticulos {0}, '{1}', {2}", 
						drr.Cells["idArtMarca"].Value,
						drr.Cells["Marca"].Value.ToString(), 4);     
		...
		{
			e.Row.Cells["idArtMarca"].Value = 0;
		}
		...
		private void frmArtMarca_Load(object sender, System.EventArgs e)
		{
			this.ultraGrid1.DataSource = Funcion.dvProcedimiento(cdsSeteoF, string.Format("Select idArtMarca, Marca From ArtMarca Order By Marca"));
		}

		private void frmArtMarca_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
			if (e.KeyCode == Keys.Escape) this.DialogResult = DialogResult.No;
		}
	}
