...
{
	/// <summary>
	/// Descripción breve de frmListaAnticipos.
	/// </summary>
	public class frmListaAnticipos : System.Windows.Forms.Form
	{
		...
		int idCliente = 0;
		int idBodega = 0;
		public frmListaAnticipos(int IdCliente, int IdBodega)
		{
			//
			// Necesario para admitir el Diseñador de Windows Forms
			//
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn10 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Sel", 0);
			...
			this.uGrid.Location = new System.Drawing.Point(3, 8);
			this.uGrid.Name = "uGrid";
			this.uGrid.Size = new System.Drawing.Size(1002, 208);
			this.uGrid.TabIndex = 266;
			...
			this.btnAceptar.Location = new System.Drawing.Point(8, 234);
			...
			this.btnCancelar.Location = new System.Drawing.Point(104, 234);
			...
			// groupBox1
			// 
			this.groupBox1.Location = new System.Drawing.Point(-128, 220);
			...
			this.Name = "frmListaAnticipos";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Anticipos";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmListaAnticipos_KeyDown);
			this.Load += new System.EventHandler(this.frmListaAnticipos_Load);
		...
		private void frmListaAnticipos_Load(object sender, System.EventArgs e)
		{
			string sSQL = string.Format("Exec ListaAnticipos {0}, {1}", idCliente, idBodega);
			this.uGrid.DataSource = Funcion.dvProcedimiento(cdsSeteoF, sSQL);
		}

		private void frmListaAnticipos_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
