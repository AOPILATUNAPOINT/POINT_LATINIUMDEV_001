...
namespace Latinium
{
	...
	public class frmReporteRangoMorosidad : System.Windows.Forms.Form
	{
		...
		public System.Windows.Forms.Button btnCuotaCero;
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.btnExcel.Location = new System.Drawing.Point(1250, 9);
			...
			this.label8.Location = new System.Drawing.Point(928, 13);
			...
			this.cmbEntidadFinanciera.Location = new System.Drawing.Point(976, 11);
			...
			this.cmbEntidadFinanciera.Visible = false;
			// 
			// lblContador
			// 
			...
			this.lblContador.Location = new System.Drawing.Point(928, 13);
			...
			this.btnConsultar.Location = new System.Drawing.Point(448, 10);
			...
			this.label3.Location = new System.Drawing.Point(992, 48);
			...
			this.groupBox2.Size = new System.Drawing.Size(1530, 8);
			...
			this.groupBox1.Size = new System.Drawing.Size(1530, 8);
			...
			this.txtdos.Location = new System.Drawing.Point(992, 64);
			...
			this.txttres.Location = new System.Drawing.Point(1104, 64);
			...
			this.txtcuatro.Location = new System.Drawing.Point(320, 64);
			...
			this.txtcinco.Location = new System.Drawing.Point(432, 64);
			...
			this.txtseis.Location = new System.Drawing.Point(544, 64);
			...
			this.txtsiete.Location = new System.Drawing.Point(768, 64);
			...
			this.label5.Location = new System.Drawing.Point(1104, 48);
			...
			this.label10.Location = new System.Drawing.Point(768, 48);
			...
			this.txtPorcentaje2.Location = new System.Drawing.Point(992, 88);
			...
			this.txtPorcentaje2.Visible = false;
			...
			this.txtPorcentaje3.Location = new System.Drawing.Point(1104, 88);
			...
			this.txtPorcentaje3.Visible = false;
			// 
			// txtPorcentaje4
			// 
			...
			this.txtPorcentaje4.Location = new System.Drawing.Point(320, 88);
			...
			this.txtPorcentaje5.Location = new System.Drawing.Point(432, 88);
			...
			this.txtPorcentaje6.Location = new System.Drawing.Point(544, 88);
			...
			this.txtPorcentaje7.Location = new System.Drawing.Point(768, 88);
			...
			this.optPOrcentajes.Location = new System.Drawing.Point(184, 8);
			...
			this.label13.Location = new System.Drawing.Point(880, 48);
			...
			this.txtRatioM.Location = new System.Drawing.Point(880, 88);
			...
			this.ugridcolores.Size = new System.Drawing.Size(258, 176);
			...
			this.txtPorcentaje8.Location = new System.Drawing.Point(656, 88);
			...
			this.txtOcho.Location = new System.Drawing.Point(656, 64);
			...
			this.label14.Location = new System.Drawing.Point(656, 48);
			...
			// btnCuotaCero
			// 
			this.btnCuotaCero.BackColor = System.Drawing.Color.FromArgb(((System.Byte)(230)), ((System.Byte)(230)), ((System.Byte)(230)));
			this.btnCuotaCero.CausesValidation = false;
			this.btnCuotaCero.Font = new System.Drawing.Font("Tahoma", 8.25F);
			this.btnCuotaCero.ForeColor = System.Drawing.Color.FromArgb(((System.Byte)(50)), ((System.Byte)(50)), ((System.Byte)(50)));
			...
			this.btnCuotaCero.Location = new System.Drawing.Point(536, 10);
			this.btnCuotaCero.Name = "btnCuotaCero";
			this.btnCuotaCero.Size = new System.Drawing.Size(80, 23);
			this.btnCuotaCero.TabIndex = 1036;
			...
			this.ClientSize = new System.Drawing.Size(1330, 470);
...
//ReporteReporteRangoMorosidad
			string sSQLPa = string.Format("Exec ReporteReporteRangoMorosidadActualizado  '{0}', {1}, '{2}', {3}", 
			...
			string ssql= string.Format ("Exec ReporteReporteRangoMorosidadActualizado '{0}', {1}, '{2}', {3} ", 
			...
			{	
				...
				if (dra.GetValue(2) != System.DBNull.Value)this.txtcuatro.Value = dra.GetDecimal(2);
				if (dra.GetValue(3) != System.DBNull.Value)this.txtcinco.Value = dra.GetDecimal(3);
				if (dra.GetValue(4) != System.DBNull.Value)this.txtseis.Value = dra.GetDecimal(4);
				if (dra.GetValue(5) != System.DBNull.Value)this.txtOcho.Value = dra.GetDecimal(5);
				if (dra.GetValue(6) != System.DBNull.Value)this.txtsiete.Value = dra.GetDecimal(6);
			}
			dra.Close();
			...
			this.txtRatioM.Value = 		((decimal) this.txtPorcentaje1.Value + (decimal) this.txtPorcentaje2.Value 
				 + (decimal) this.txtPorcentaje3.Value +(decimal) this.txtPorcentaje4.Value 
				+(decimal) this.txtPorcentaje5.Value +	(decimal) this.txtPorcentaje6.Value
				+(decimal) this.txtPorcentaje8.Value);
				//+(decimal) this.txtPorcentaje8.Value );
		...
		private void DiseñoGridRatioM(Infragistics.Win.UltraWinGrid.UltraGrid uGrid)
		{
			...
			{
				if (dr.Cells["1-30"].Value.ToString().Trim().Length == 0)  dr.Cells["1-30"].Value = 0;
				...
				dr.Cells["Ratio M"].Value =  
					Convert.ToDecimal(dr.Cells["1-30"].Value) +
					Convert.ToDecimal(dr.Cells["31-60"].Value)  + 
					Convert.ToDecimal(dr.Cells["61-90"].Value) +Convert.ToDecimal(dr.Cells["91-99"].Value) 
					+ Convert.ToDecimal(dr.Cells["100-180"].Value) ;
		...
		private void DiseñoGridColor(Infragistics.Win.UltraWinGrid.UltraGrid uGrid)
		{
			...
			foreach(Infragistics.Win.UltraWinGrid.UltraGridRow dr in this.uGridInformacion.Rows.All)
			{
				for (int i = 2; i < iContColumnas; i++)
				{
					...
					double dSumC=  Convert.ToDouble(dr.Cells["0-0"].Value) +  Convert.ToDouble(dr.Cells["1-30"].Value) ;
		...
		private void uGridInformacion_ClickCellButton(object sender, Infragistics.Win.UltraWinGrid.CellEventArgs e)
		{
			...
			if (e.Cell.Column.ToString() == sColumna)
			{
				...
				if (iDesde >=100 )	
				{
                  if (!miAcceso.BVerMayor100dias) return;
				}
...
//			using (frmReporteFDGClientes CCJ = new frmReporteFDGClientes ((DateTime)this.dtFecha.Value, idEntidadFinanciera,
//							 sLocal , 0, 0, true, miAcceso.BExportar))
//			{
//		
//				if (DialogResult.OK == CCJ.ShowDialog())
//				{
