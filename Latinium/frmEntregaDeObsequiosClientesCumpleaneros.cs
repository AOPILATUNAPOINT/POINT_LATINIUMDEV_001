...
namespace Latinium
{
	...
	public class frmEntregaDeObsequiosClientesCumpleaneros : System.Windows.Forms.Form
	{
		...
		private void frmEntregaDeObsequiosClientesCumpleaneros_Load(object sender, System.EventArgs e)
		{
			...
			if (!Funcion.Permiso("1354", cdsSeteoF))
			{				
				MessageBox.Show("No Tiene Acceso Al Modulo Seleccionado", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop);
		...
		private void btnCliente_Click(object sender, System.EventArgs e)
		{
			...
			{
				FuncionesProcedimientos.AbreFacturacionClientes(5, this.txtCedula.Text.ToString(), true, false);
			}
		...
		{
			if (bEdicion)
				FuncionesProcedimientos.AbreFacturacionClientes(5, this.txtCedula.Text.ToString(), false, false);
		}
	}
}
