...
{
	/// <summary>
	/// Descripción breve de frmTipoBonos.
	/// </summary>
	public class frmTipoBonos : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("IdTipoBono");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn2 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Nombre");
			Infragistics.Win.Appearance appearance2 = new Infragistics.Win.Appearance();
			Infragistics.Win.Appearance appearance3 = new Infragistics.Win.Appearance();
			Infragistics.Win.Appearance appearance4 = new Infragistics.Win.Appearance();
			Infragistics.Win.Appearance appearance5 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn1 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("IdTipoBono");
			...
			this.txtIdUnidadMedida.Location = new System.Drawing.Point(368, 424);
			...
			this.txtIdUnidadMedida.TabIndex = 294;
			...
			this.ultraGrid1.Size = new System.Drawing.Size(376, 392);
			this.ultraGrid1.TabIndex = 291;
			...
			this.Name = "frmTipoBonos";
			this.Text = "Tipo de Bonos";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmTipoBonos_KeyDown);
			this.Load += new System.EventHandler(this.frmTipoBonos_Load);
		...
		private void frmTipoBonos_Load(object sender, System.EventArgs e)
		{
		this.ultraGrid1.DataSource = Funcion.dvProcedimiento(cdsSeteoF, string.Format("Select IdTipoBono, Nombre From TipoBono Order By Nombre"));
		}
		...
		private void btAceptar_Click(object sender, System.EventArgs e)
		{
			...
			{
				if ((int)drr.Cells["IdTipoBono"].Value == 0 || (int)drr.Cells["IdTipoBono"].Value > 0)
				{
					string sSQLDetalle = string.Format("Exec GrabaTipoBono {0}, '{1}'", 
						drr.Cells["IdTipoBono"].Value,
		...
		{
			e.Row.Cells["IdTipoBono"].Value = 0;
		}

		private void frmTipoBonos_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
