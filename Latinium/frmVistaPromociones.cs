...
namespace Latinium
{
	...
	public class frmVistaPromociones : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.cmbPromocion.Size = new System.Drawing.Size(512, 21);
			...
			this.rtbDescripcion.Size = new System.Drawing.Size(1176, 616);
			...
			this.pbCompetencia.Location = new System.Drawing.Point(1384, 72);
			...
			this.pbCompetencia.Visible = false;
			// 
			// frmVistaPromociones
			// 
		...
		{
			miAcceso = new Acceso(cdsSeteoF, "0737");
			if (!Funcion.Permiso("1554", cdsSeteoF))
			{		
				MessageBox.Show("No tiene Acceso a Promociones Activas", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop);
