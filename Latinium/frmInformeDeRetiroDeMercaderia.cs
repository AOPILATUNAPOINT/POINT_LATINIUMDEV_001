...
namespace Latinium
{
	...
	public class frmInformeDeRetiroDeMercaderia : System.Windows.Forms.Form
	{
		...
		{				
			...
			miAcceso = new Acceso(cdsSeteoF, "1005");
			
			if (!Funcion.Permiso("640", cdsSeteoF))
			{				
				MessageBox.Show("No Puede Ingresar a Informe de Retiro de Mercaderia", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop);
