		...
		private void bntGrabar_Click(object sender, System.EventArgs e)
		{
			...
			else
			{
				...
				if (Convert.ToDecimal(this.txtTotal.Value)!=0)
					using (VentaFPagoLot miCobro = new VentaFPagoLot(idCpaFC, (int)this.cmbFormaPago.Value, (decimal)this.txtTotal.Value, NumFactura, false, 0, 0, false, 0, false, 0, false, 0, 0, 0, idClint, 0, 0, 0, 0))
