...
{
	/// <summary>
	/// Descripción breve de frmBuscaOrdenesDeProduccion.
	/// </summary>
	public class frmBuscaOrdenesDeProduccion : System.Windows.Forms.Form
	{
		...
		public frmBuscaOrdenesDeProduccion()
		{
			//
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmBuscaOrdenesDeProduccion));
			...
			this.ultraGrid1.Size = new System.Drawing.Size(613, 176);
			...
			this.rdgTipo.Appearance = appearance6;
			...
			this.rdgTipo.ItemAppearance = appearance7;
			...
			this.rdgTipo.Location = new System.Drawing.Point(528, 8);
			this.rdgTipo.Name = "rdgTipo";
			this.rdgTipo.Size = new System.Drawing.Size(96, 50);
			this.rdgTipo.TabIndex = 4;
			...
			this.btnBuscar.Location = new System.Drawing.Point(248, 39);
			...
			this.lblContador.Location = new System.Drawing.Point(336, 41);
			this.lblContador.Name = "lblContador";
			this.lblContador.Size = new System.Drawing.Size(0, 19);
			this.lblContador.TabIndex = 263;
			...
			this.Name = "frmBuscaOrdenesDeProduccion";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Buscar";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmBuscaOrdenesDeProduccion_KeyDown);
			this.Load += new System.EventHandler(this.frmBuscaOrdenesDeProduccion_Load);
		...
		{
			string sSQL = string.Format("Exec ConsultaGeneralOrdenProduccion '{0}', '{1}', '{2}', {3}", 
				this.txtBuscar.Text.ToString(), Convert.ToDateTime(this.dtDesde.Value).ToString("yyyyMMdd"), Convert.ToDateTime(this.dtHasta.Value).ToString("yyyyMMdd"), (int)this.rdgTipo.Value);
		...
		private void Aceptar()
		{
			...
			else if (this.ultraGrid1.ActiveRow.Cells["idOrdenProd"].Value == System.DBNull.Value)
			{
				MessageBox.Show("Seleccione un documento", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Information);				
			}
			else 
		...
		private void frmBuscaOrdenesDeProduccion_Load(object sender, System.EventArgs e)
		{
		...
		private void frmBuscaOrdenesDeProduccion_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
