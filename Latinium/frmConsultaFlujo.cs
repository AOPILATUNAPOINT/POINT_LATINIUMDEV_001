...
{
	/// <summary>
	/// Descripción breve de frmConsultaFlujo.
	/// </summary>
	public class frmConsultaFlujo : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idMaestroFlujo");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn1 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idMaestroFlujo");
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmConsultaFlujo));
			...
			this.groupBox2.Size = new System.Drawing.Size(724, 8);
			...
			this.btnCancelar.TabIndex = 1003;
			...
			this.uGridInformacion.Size = new System.Drawing.Size(632, 224);
			...
			this.txtDescripcion.Location = new System.Drawing.Point(64, 40);
			this.txtDescripcion.Multiline = true;
			this.txtDescripcion.Name = "txtDescripcion";
			this.txtDescripcion.Size = new System.Drawing.Size(304, 21);
			...
			this.optEstado.Size = new System.Drawing.Size(208, 26);
			this.optEstado.TabIndex = 998;
			...
			this.dtHasta.Location = new System.Drawing.Point(248, 11);
			...
			this.Name = "frmConsultaFlujo";
			this.ShowInTaskbar = false;
			this.Text = "Consulta Conciliación ";
			this.Load += new System.EventHandler(this.frmConsultaFlujo_Load);
		...
		private void frmConsultaFlujo_Load(object sender, System.EventArgs e)
		{
		...
		private void Aceptar()
		{
			...
			else if (this.uGridInformacion.ActiveRow.Cells["idMaestroFlujo"].Value == System.DBNull.Value)
			{
				MessageBox.Show("Seleccione un registro", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Information);				
			}
		...
		private void button1_Click(object sender, System.EventArgs e)
		{
			...
			string sSQL = string.Format("Exec ConsultaMaestroFlujos '{0}', '{1}', {2}, '{3}'", 
