...
namespace Latinium
{
	...
	public class frmGuiaDeRemisionCarpa : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtEstado.Location = new System.Drawing.Point(592, 157);
			...
			this.txtIdCompra.Location = new System.Drawing.Point(616, 157);
			...
			this.txtIdGuiaRemision.Location = new System.Drawing.Point(640, 157);
			...
			this.btnImprimir.Location = new System.Drawing.Point(322, 605);
			...
			this.btnGuardar.Location = new System.Drawing.Point(243, 605);
			...
			this.btnAnular.Location = new System.Drawing.Point(402, 605);
			...
			this.btnCancelar.Location = new System.Drawing.Point(481, 605);
			...
			this.btnNuevo.Location = new System.Drawing.Point(8, 605);
			...
			this.btnConsultar.Location = new System.Drawing.Point(83, 605);
			...
			this.btnEditar.Location = new System.Drawing.Point(164, 605);
			...
			this.btnSalir.Location = new System.Drawing.Point(556, 605);
			...
			this.uGridArticulos.Size = new System.Drawing.Size(656, 165);
			...
			this.ClientSize = new System.Drawing.Size(672, 635);
		...
		private void Consultar(int idMaestroGuiaDeRemision)
		{
			try
			{
				...
				dr.Close();			
				this.cmbResponsable.Value = iResponsable;
		...
		private void cmbBodega_ValueChanged(object sender, System.EventArgs e)
		{
			...
			if (this.cmbBodega.ActiveRow != null)
		  	...
		  	this.cmbResponsable.DataSource = Funcion.dvProcedimiento(cdsSeteoF, string.Format("select idChoferes as idPersonal, Nombre from DBO.choferes "));
...
//			paramFields.Add (Compra);
		...
		//	this.txtRucTransportista.Text = Funcion.sEscalarSQL(cdsSeteoF, string.Format("Select Cedula From choferes Where idChoferes = {0}", (int)this.cmbResponsable.Value));
			this.txtPlaca.Text = Funcion.sEscalarSQL(cdsSeteoF, string.Format("Select Placa From choferes Where idChoferes = {0}", (int)this.cmbResponsable.Value));
