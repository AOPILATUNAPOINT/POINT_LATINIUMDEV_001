...
{
	/// <summary>
	/// Summary description for frmVistaAgendaGestionCliente.
	/// </summary>
	public class frmVistaAgendaGestionCliente : DevExpress.XtraEditors.XtraForm
	{
		...
		int IdCompra = 0;
		public frmVistaAgendaGestionCliente(int idCompra)
		{
			//
		...
		private void InitializeComponent()
		{
			...
			this.ultraGrid1.Size = new System.Drawing.Size(866, 312);
			...
			this.ultraDataSource1.Band.Columns.AddRange(new object[] {
																																 ...
																																 ultraDataColumn3});
			// 
			// frmVistaAgendaGestionCliente
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 14);
			this.ClientSize = new System.Drawing.Size(882, 326);
			this.Controls.Add(this.ultraGrid1);
			this.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedDialog;
			this.KeyPreview = true;
			this.MaximizeBox = false;
			this.MinimizeBox = false;
			this.Name = "frmVistaAgendaGestionCliente";
			this.ShowInTaskbar = false;
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmVistaAgendaGestionCliente_KeyDown);
			this.Load += new System.EventHandler(this.frmVistaAgendaGestionCliente_Load);
		...
		private void frmVistaAgendaGestionCliente_Load(object sender, System.EventArgs e)
		{
			string sSQL = string.Format("Exec ReporteGestionesCotizacion {0}", IdCompra);
			this.ultraGrid1.DataSource = Funcion.dvProcedimiento(cdsSeteoF, sSQL);
		}

		private void frmVistaAgendaGestionCliente_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
