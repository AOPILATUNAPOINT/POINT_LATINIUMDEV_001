...
{
	/// <summary>
	/// Descripción breve de frmCre_Proyeccion_Pagos_Pichincha.
	/// </summary>
	public class frmCre_Proyeccion_Pagos_Pichincha : System.Windows.Forms.Form
	{
		...
		public frmCre_Proyeccion_Pagos_Pichincha(DateTime DTFecha)
		{
			//
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmCre_Proyeccion_Pagos_Pichincha));
			...
			this.ultraGrid1.Size = new System.Drawing.Size(211, 544);
			...
			this.btnExcel.Location = new System.Drawing.Point(8, 560);
			this.btnExcel.Name = "btnExcel";
			this.btnExcel.Size = new System.Drawing.Size(208, 24);
			this.btnExcel.TabIndex = 647;
			this.btnExcel.Text = "Excel";
			this.btnExcel.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.btnExcel.Click += new System.EventHandler(this.btnExcel_Click);
			// 
			// frmCre_Proyeccion_Pagos_Pichincha
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(223, 592);
			...
			this.Name = "frmCre_Proyeccion_Pagos_Pichincha";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Proyección De Pagos";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmCre_Proyeccion_Pagos_Pichincha_KeyDown);
			this.Load += new System.EventHandler(this.frmCre_Proyeccion_Pagos_Pichincha_Load);
		...
		private void frmCre_Proyeccion_Pagos_Pichincha_Load(object sender, System.EventArgs e)
		{
			FuncionesProcedimientos.dsGeneral(string.Format("Select Fecha_Envio, SUM(Abono) As Valor From Cre_Lista_Pagos_Cartera_Pichincha Where CONVERT(Date, Fecha) = '{0}' Group By Fecha_Envio Order By Fecha_Envio", dtFecha.ToString("yyyyMMdd")), this.ultraGrid1);
		}
		...
		private void frmCre_Proyeccion_Pagos_Pichincha_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
