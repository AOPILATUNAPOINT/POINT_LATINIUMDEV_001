...
namespace Latinium
{
	...
	public class frmInformeOperadora : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnAsignacion.Location = new System.Drawing.Point(512, 136);
		...
		private void frmInformeCobrador_Load(object sender, System.EventArgs e)
		{
			...
			if (!Funcion.Permiso("947", cdsSeteoF))
			{		
				MessageBox.Show("No tiene Acceso INFORMES OPERADORA", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop);
