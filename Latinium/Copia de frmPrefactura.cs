...
namespace Latinium
{
	...
	public class frmPrefactura : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.ultraGrid2.DisplayLayout.Override.CellAppearance = appearance16;
			...
			this.ultraGrid2.InitializeRow += new Infragistics.Win.UltraWinGrid.InitializeRowEventHandler(this.ultraGrid1_InitializeRow);
			...
			this.txtCuotaAsignada.Appearance = appearance22;
			...
			this.txtCuotaDisponible.Appearance = appearance23;
			...
			this.txtCuotaUsada.Appearance = appearance24;
			...
			this.txtValorCuotas.Appearance = appearance25;
			...
			this.lblEstado.Location = new System.Drawing.Point(784, 102);
			...
			this.lblUsuario.Location = new System.Drawing.Point(480, 424);
			...
			this.txtIvaTotal.Appearance = appearance27;
			...
			this.txtDescIvaTotal.Appearance = appearance28;
			...
			this.txtNumero.Appearance = appearance30;
			...
			this.txtComprobante.Appearance = appearance31;
			...
			this.chkVerificar.Appearance = appearance32;
			this.chkVerificar.BackColor = System.Drawing.Color.Transparent;
			this.chkVerificar.Enabled = false;
			this.chkVerificar.Location = new System.Drawing.Point(480, 356);
			...
			this.txtObservaciones.Appearance = appearance33;
			...
			this.chkAutorizar.Appearance = appearance34;
			this.chkAutorizar.BackColor = System.Drawing.Color.Transparent;
			this.chkAutorizar.Enabled = false;
			this.chkAutorizar.Location = new System.Drawing.Point(536, 356);
			...
			appearance35.BackColor = System.Drawing.Color.FromArgb(((System.Byte)(230)), ((System.Byte)(230)), ((System.Byte)(230)));
			appearance35.ForeColor = System.Drawing.Color.FromArgb(((System.Byte)(50)), ((System.Byte)(50)), ((System.Byte)(50)));
			this.txtBodegaPredef.Appearance = appearance35;
			...
			this.txtDescIva0Total.Appearance = appearance36;
			...
			this.txtIva0.Appearance = appearance37;
			...
			this.txtProteccionDD.Appearance = appearance38;
...
//			}
				...
				try
				{
					if (bActualiza) 
					{
						...
						if (e.Cell.Column.ToString() == "Codigo")
						{
							bActualiza = false;
							if (!bModificaColor)
								FuncionesInventario.FacturacionCargaArticulos(sender, e, this.ultraGrid2, 9, 4, (int)this.cmbBodega.Value, (int)this.cmbBodega1.Value, 0, 0, 0, 0, Convert.ToDateTime(this.dtFecha.Value), 43, true, true, true, true, (int)this.txtNumCuotas.Value, (int)this.txtidEntidadFinanciera.Value, (int)this.txtNumIdCliente.Value, 0, 0, bCuponWeb, false, 0, cdsSeteoF);
						...
						{		
							...
							if (!Facturacion.bValidaDescuentos(e, this.ultraGrid2, (int)this.cmbBodega.Value, bDescuentoActivo, dClavePorcDscto, 43, miAcceso.CambiarDescuento, 4, 0, 0, 0, 0, dPorcentajeCuponWeb, dDsctoReiterativo, bCuponWeb, idMail, bEmpleado, cdsSeteoF))
							{							
								cmdTotal();
								bActualiza = true;
								return;
		...
		private void CargaCliente()
		{
			...
			if (dDsctoReiterativo > 0.00m)
				this.lblClienteReiterativo.Text = string.Format("CLIENTE TIENE DESCUENTO DE {0} %", dDsctoReiterativo);
					...
					using (SqlConnection oConexion = new SqlConnection("Password=Bl45o6$9;Persist Security Info=True;User ID= " + MenuLatinium.stUsuario + ";Initial Catalog=" + MenuLatinium.stDirFacturacion + ";Data Source=" + MenuLatinium.stDirServidor + ";Max Pool Size = 1024;"))
					{
						...
						{							
							...
							string sSQLTransforma = string.Format("Exec CompraTransformaCopia {0}, 1, {1}, {2}, {3}, {4}, '{5}'",
								(int)this.txtNumIdCompra.Value, (int)this.cmbBodega.Value, (bool)CA.optTipos.Value, bRevisado, false, CA.txtNotas.Text.ToString().Trim());
		...
		private void btnAnular_Click(object sender, System.EventArgs e)
		{
			...
			if (DialogResult.Yes == MessageBox.Show("¿Esta seguro de anular esta Prefactura?.", "Point Technology", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2))
			{
				using (frmJustAnulaVenta Nota = new frmJustAnulaVenta())
				{
					if (DialogResult.OK == Nota.ShowDialog())
					{
						Funcion.EjecutaSQL(cdsSeteoF, string.Format("Update Compra Set FechaAnulacion = GETDATE(), Borrar = 1, Notas = '{1}' Where idCompra = {0}", (int)this.txtNumIdCompra.Value, Nota.txtNotas.Text.ToString()));
		...
		private void btnEditar_Click(object sender, System.EventArgs e)
		{
			...
			if (iContDYD > 0)
			{
				MessageBox.Show("No puede editar una Pre Factura con Proteccion D & D.\n\nsi necesita modificar información primero anule e ingrese una nueva prefactura", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop);	
				return;
			}
...
//				this.btnEditar.Enabled = false;
		...
		private void btnGuardar_Click(object sender, System.EventArgs e)
		{
			...
			if (bEmpleado)
			{
				...
				if (Convert.ToDecimal(this.txtValorCuotas.Value) > 56.00m)
				{
					MessageBox.Show("El valor minimo de cuotas no puede ser menor a 56.00 usd", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop);
					return;
				}
			}
			cmdTotal();
...
//					{
//						MessageBox.Show("Con 60 dias de gracia o cuotas de pago mayor a 18 es obligatorio Protección D & D", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Information);
//
//						FuncionesInventario.FacturacionCargaDYD(this.ultraGrid2, Convert.ToDecimal(this.txtProteccionDD.Value), dPorcIva, cdsSeteoF);
//					}
//					else if (DialogResult.Yes == MessageBox.Show("¿Desea cargar Protección D & D?", "Point Technology", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2)) 
//						FuncionesInventario.FacturacionCargaDYD(this.ultraGrid2, Convert.ToDecimal(this.txtProteccionDD.Value), dPorcIva, cdsSeteoF);
//				}
//			}			
			#endregion Seguros
...
//
				...
				if (e.Cell.Column.ToString() == "DescuentoPorc")
				{
					Validacion.ModificaDescuentos(e, bEmpleado);
