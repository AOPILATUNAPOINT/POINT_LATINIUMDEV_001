			...
			{	
				...
				using (SqlConnection oConexion = new SqlConnection("Password=Bl45o6$9;Persist Security Info=True;User ID= " + MenuLatinium.stUsuario + ";Initial Catalog=" + MenuLatinium.stDirFacturacion + ";Data Source=" + MenuLatinium.stDirServidor + ";Max Pool Size = 1024;"))
				{
					...
					{							
						...
						oCmdActualiza.CommandText = "Exec DTCreaIEBodegaRemates 20";
						...
						foreach(Infragistics.Win.UltraWinGrid.UltraGridRow dr in this.uGridIngresos.Rows.All)			
						{
							...
							{										
								...
								sSQL = string.Format("Exec DTCreaDetalleIEBodegaRemates {0}, {1}, {2}, {3}, {4}, {5}, {6}", 
									idCompraE, idCompraI, (int)dr.Cells["idArticulo"].Value, idArticuloNuevo, (int)dr.Cells["idSerial"].Value, 20, dUltimoCosto);
								oCmdActualiza.CommandText = sSQL;
								oCmdActualiza.ExecuteNonQuery();

								sSQL = string.Format("Exec GuardaDT_Procesos {0}, 20, 23, {1}, '{2}', 0, '', 0, 0, {3}, 0, '', '19000101', {4}", 
									(int)dr.Cells["idIngreso"].Value, idPersonal, dr.Cells["Notas"].Value.ToString(), (int)dr.Cells["idSerial"].Value, idCompraI);
								oCmdActualiza.CommandText = sSQL;
								oCmdActualiza.ExecuteNonQuery();
							}								
						}
