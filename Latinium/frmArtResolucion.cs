...
{
	/// <summary>
	/// Descripción breve de frmArtResolucion.
	/// </summary>
	public class frmArtResolucion : System.Windows.Forms.Form
	{
		...
		public frmArtResolucion(int IdArtResolucion)
		{
			idArtResolucion = IdArtResolucion;
			//
			// Necesario para admitir el Diseñador de Windows Forms
			//
			InitializeComponent();
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idArtResolucion");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn2 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Resolucion");
			Infragistics.Win.Appearance appearance2 = new Infragistics.Win.Appearance();
			Infragistics.Win.Appearance appearance3 = new Infragistics.Win.Appearance();
			Infragistics.Win.Appearance appearance4 = new Infragistics.Win.Appearance();
			Infragistics.Win.Appearance appearance5 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn1 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idArtResolucion");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn2 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Resolucion");
			...
			ultraGridColumn1.Width = 194;
			ultraGridColumn2.Case = Infragistics.Win.UltraWinGrid.Case.Upper;
			ultraGridColumn2.Header.Caption = "Resolución";
			...
			this.txtIdUnidadMedida.TabIndex = 299;
			...
			this.Name = "frmArtResolucion";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Resolución";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmArtResolucion_KeyDown);
			this.Load += new System.EventHandler(this.frmArtResolucion_Load);
		...
		private void frmArtResolucion_Load(object sender, System.EventArgs e)
		{
			this.ultraGrid1.DataSource = Funcion.dvProcedimiento(cdsSeteoF, string.Format("Select idArtResolucion, Resolucion From ArtResolucion Order By Resolucion"));
		}
		...
		private void btAceptar_Click(object sender, System.EventArgs e)
		{
			...
			{
				if ((int)drr.Cells["idArtResolucion"].Value == 0 || (int)drr.Cells["idArtResolucion"].Value > 0)
				{
					string sSQLDetalle = string.Format("Exec InsertaAtributosArticulos {0}, '{1}', {2}", 
						drr.Cells["idArtResolucion"].Value,
						drr.Cells["Resolucion"].Value.ToString(), 10);     
		...
		{
			e.Row.Cells["idArtResolucion"].Value = 0;
		}
		...
		private void frmArtResolucion_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
