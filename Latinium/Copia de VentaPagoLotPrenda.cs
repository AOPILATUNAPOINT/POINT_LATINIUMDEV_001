...
{
	/// <summary>
	/// Summary description for VentaPagoLotPrenda.
	/// </summary>
	public class VentaPagoLotPrenda : DevExpress.XtraEditors.XtraForm
	{
		...
		public VentaPagoLotPrenda(int idFormaPago, decimal  dValor, int iOrigen, bool bPagoCredito)
		{
			InitializeComponent();
		...
		public VentaPagoLotPrenda(int idCompra, int idFormaPago, decimal  dValor, int iOrigen)
		{
			InitializeComponent();
		...
		public VentaPagoLotPrenda(int idCompra, int iFormaPag, decimal  dValor, decimal  dEfectivo, decimal  dSaldo, bool bAnticipo, decimal  dAnticipo, bool bNuevo, string sNumNC, decimal  dRetenido, int iOrigen, int iEstado, bool bPagoCredito, int idCliente)
		{
			//
			// Required for Windows Form Designer support
			//
		...
		private void InitializeComponent()
		{
			...
			this.Name = "VentaPagoLotPrenda";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Cobro PRENDA";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.VentaPagoLotPrenda_KeyDown);
			this.Closing += new System.ComponentModel.CancelEventHandler(this.VentaPagoLotPrenda_Closing);
			this.Load += new System.EventHandler(this.VentaPagoLotPrenda_Load);
		...
		bool bLoad = false;
		public void VentaPagoLotPrenda_Load(object sender, System.EventArgs e)
		{
			string stTipo = "0703";
			...
			this.cmbFormaPago.DataSource = Funcion.dvProcedimiento(cdsSeteoF, string.Format("Exec CompraFPagoPrenda"));
			...
			if (!BPagoCredito)
			{
				...
				/* Cobro de Prenda */
				if (Funcion.iEscalarSQL(cdsSeteoF, string.Format("Select COUNT(*) From DetalleFormaPago Where idCompra = {0} And Origen = 1 and idFormaPago=16 and Cobrado=1", IdCompraFact)) == 0)
				{	
...
//			else e.Cell.Row.Cells["Valor"].Value = 0;
		...
		private void VentaPagoLotPrenda_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
...
//			}
		...
		private void VentaPagoLotPrenda_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
