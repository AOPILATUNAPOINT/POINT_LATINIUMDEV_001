		...
		private void ultraGrid1_ClickCellButton(object sender, Infragistics.Win.UltraWinGrid.CellEventArgs e)
		{
			if (e.Cell.Column.ToString() == "btnLiquidar")
			{
				...
				if (e.Cell.Row.Cells["idDepositosPorLiquidar"].Value != System.DBNull.Value)
				{
					...
					using (frmLiquidaDepositosPendientes LDP = new frmLiquidaDepositosPendientes())
					{
						if (DialogResult.OK == LDP.ShowDialog())
						{
							...
							Facturacion.Impresion(idCompra, false, 7, true, true, false, false, 5, 0.00m, 0, 0, "", DateTime.Today, 0, "", cdsSeteoF);			
						}
