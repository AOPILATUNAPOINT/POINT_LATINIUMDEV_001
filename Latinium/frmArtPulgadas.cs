...
{
	/// <summary>
	/// Descripción breve de frmArtPulgadas.
	/// </summary>
	public class frmArtPulgadas : System.Windows.Forms.Form
	{
		...
		public frmArtPulgadas(int IdArtPulgadas)
		{
			idArtPulgadas = IdArtPulgadas;
			//
			// Necesario para admitir el Diseñador de Windows Forms
			//
			InitializeComponent();
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn1 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idArtPulgadas");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn2 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Pulgadas");
			...
			this.txtIdUnidadMedida.TabIndex = 290;
			...
			this.Name = "frmArtPulgadas";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Pulgadas";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmArtPulgadas_KeyDown);
			this.Load += new System.EventHandler(this.frmArtPulgadas_Load);
		...
		private void frmArtPulgadas_Load(object sender, System.EventArgs e)
		{
			this.ultraGrid1.DataSource = Funcion.dvProcedimiento(cdsSeteoF, string.Format("Select idArtPulgadas, Pulgadas From ArtPulgadas Order By Pulgadas"));
		}
		...
		private void btAceptar_Click(object sender, System.EventArgs e)
		{
			...
			{
				if ((int)drr.Cells["idArtPulgadas"].Value == 0 || (int)drr.Cells["idArtPulgadas"].Value > 0)
				{
					string sSQLDetalle = string.Format("Exec InsertaAtributosArticulos {0}, '{1}', {2}", 
						drr.Cells["idArtPulgadas"].Value,
						drr.Cells["Pulgadas"].Value.ToString(), 1);     
		...
		{
			e.Row.Cells["idArtPulgadas"].Value = 0;
		}
		...
		private void frmArtPulgadas_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
