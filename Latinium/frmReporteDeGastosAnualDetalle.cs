...
{
	/// <summary>
	/// Descripción breve de frmReporteDeGastosAnualDetalle.
	/// </summary>
	public class frmReporteDeGastosAnualDetalle : System.Windows.Forms.Form
	{
		...
		public frmReporteDeGastosAnualDetalle(string SCodigo , string SDescripcion , string SYear , int ITipo  )
		{
			//
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn4 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Debe");
			Infragistics.Win.Appearance appearance2 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinGrid.SummarySettings summarySettings1 = new Infragistics.Win.UltraWinGrid.SummarySettings("", Infragistics.Win.UltraWinGrid.SummaryType.Sum, "", "Debe", 3, true, "Band 0", 0, Infragistics.Win.UltraWinGrid.SummaryPosition.UseSummaryPositionColumn, "Debe", 3, true);
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn11 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idCuentaAgrupa");
			...
			this.uGridInformacion.Location = new System.Drawing.Point(8, 16);
			this.uGridInformacion.Name = "uGridInformacion";
			this.uGridInformacion.Size = new System.Drawing.Size(488, 416);
			...
			this.ultraDataSource2.Band.Columns.AddRange(new object[] {
																																 ...
																																 ultraDataColumn14});
			// 
			// frmReporteDeGastosAnualDetalle
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(504, 446);
			this.Controls.Add(this.uGridInformacion);
			this.KeyPreview = true;
			this.Name = "frmReporteDeGastosAnualDetalle";
			this.Text = "Detalle";
			this.Load += new System.EventHandler(this.frmReporteDeGastosAnualDetalle_Load);
		...
		private void frmReporteDeGastosAnualDetalle_Load(object sender, System.EventArgs e)
		{
			string sSQL = string.Format("Exec [ReporteDeGastosAnualDetalle] '{0}','{1}','{2}',{3}", sCodigo, sDescripcion, sYear, iTipo );
