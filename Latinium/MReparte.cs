...
{
	/// <summary>
	/// Descripción breve de MReparte.
	/// </summary>
	public class MReparte : DevExpress.XtraEditors.XtraForm
	{
		private C1.Data.C1DataView cdvTalla;
		private C1.Data.C1DataSet cdsTalla;
		private Infragistics.Win.UltraWinEditors.UltraTextEditor txtIdCodigo;
		private Infragistics.Win.Misc.UltraButton btRepartir;
		private Infragistics.Win.UltraWinGrid.UltraGrid grdTalla;
		private System.Windows.Forms.Label label3;
		private Infragistics.Win.UltraWinEditors.UltraTextEditor txtidMarceloMaestro;
		private C1.Data.C1DataSet cdsMarceloMaestro;

		C1.Data.C1DataRow drMarceloMaestro ;
		private Infragistics.Win.UltraWinEditors.UltraTextEditor txtDescripcion;
		private BarraDatoSQL.BarraDatoSQL barraDato1;
		private Infragistics.Win.Misc.UltraButton btActualiza;
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridBand ultraGridBand1 = new Infragistics.Win.UltraWinGrid.UltraGridBand("MarceloCodigo", -1);
			...
			this.cdvTalla = new C1.Data.C1DataView();
			this.cdsTalla = new C1.Data.C1DataSet();
			this.txtIdCodigo = new Infragistics.Win.UltraWinEditors.UltraTextEditor();
			...
			this.txtidMarceloMaestro = new Infragistics.Win.UltraWinEditors.UltraTextEditor();
			this.barraDato1 = new BarraDatoSQL.BarraDatoSQL();
			this.btActualiza = new Infragistics.Win.Misc.UltraButton();
			this.dtFecha = new DevExpress.XtraEditors.DateEdit();
			((System.ComponentModel.ISupportInitialize)(this.cdvTalla)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.cdsTalla)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.txtIdCodigo)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.txtidMarceloMaestro)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.dtFecha.Properties)).BeginInit();
			this.SuspendLayout();
			// 
			// cdvTalla
			// 
			this.cdvTalla.BindingContextCtrl = this;
			this.cdvTalla.DataSet = this.cdsTalla;
			this.cdvTalla.TableName = "";
			this.cdvTalla.TableViewName = "MarceloCodigo";
			// 
			// cdsTalla
			// 
			...
			this.cdsTalla.DataSetDef = "MarceloCodigo";
			this.cdsTalla.FillOnRequest = false;
			...
			this.txtIdCodigo.Appearance = appearance1;
			this.txtIdCodigo.DataBindings.Add(new System.Windows.Forms.Binding("Value", this.cdvTalla, "idMarceloCodigo"));
			this.txtIdCodigo.DisplayStyle = Infragistics.Win.EmbeddableElementDisplayStyle.Office2003;
			this.txtIdCodigo.Location = new System.Drawing.Point(576, 288);
			this.txtIdCodigo.Name = "txtIdCodigo";
			this.txtIdCodigo.Size = new System.Drawing.Size(72, 21);
			this.txtIdCodigo.TabIndex = 128;
			this.txtIdCodigo.Visible = false;
			// 
			// btRepartir
			// 
			this.btRepartir.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			this.btRepartir.ButtonStyle = Infragistics.Win.UIElementButtonStyle.Office2003ToolbarButton;
			this.btRepartir.Location = new System.Drawing.Point(264, 296);
			this.btRepartir.Name = "btRepartir";
			this.btRepartir.Size = new System.Drawing.Size(208, 23);
			this.btRepartir.TabIndex = 131;
			this.btRepartir.Text = "Unir en un solo envio";
			...
			this.grdTalla.DataSource = this.cdvTalla;
			...
			this.grdTalla.Location = new System.Drawing.Point(16, 72);
			this.grdTalla.Name = "grdTalla";
			this.grdTalla.Size = new System.Drawing.Size(648, 200);
			this.grdTalla.TabIndex = 132;
			...
			this.txtDescripcion.DataBindings.Add(new System.Windows.Forms.Binding("Value", this.cdsMarceloMaestro, "MarceloMaestro.Descripcion"));
			this.txtDescripcion.DisplayStyle = Infragistics.Win.EmbeddableElementDisplayStyle.Office2003;
			this.txtDescripcion.Location = new System.Drawing.Point(120, 16);
			...
			this.txtidMarceloMaestro.Appearance = appearance8;
			this.txtidMarceloMaestro.DataBindings.Add(new System.Windows.Forms.Binding("Value", this.cdsMarceloMaestro, "MarceloMaestro.idMarceloMaestro"));
			this.txtidMarceloMaestro.DisplayStyle = Infragistics.Win.EmbeddableElementDisplayStyle.Office2003;
			this.txtidMarceloMaestro.Location = new System.Drawing.Point(0, 24);
			this.txtidMarceloMaestro.Name = "txtidMarceloMaestro";
			this.txtidMarceloMaestro.Size = new System.Drawing.Size(24, 21);
			this.txtidMarceloMaestro.TabIndex = 135;
			this.txtidMarceloMaestro.Visible = false;
			// 
			// barraDato1
			// 
			this.barraDato1.BarraMovimiento = true;
			this.barraDato1.DataMember = "MarceloMaestro";
			...
			this.barraDato1.Location = new System.Drawing.Point(16, 296);
			this.barraDato1.Name = "barraDato1";
			this.barraDato1.Size = new System.Drawing.Size(304, 24);
			this.barraDato1.TabIndex = 136;
			...
			// btActualiza
			// 
			this.btActualiza.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			this.btActualiza.ButtonStyle = Infragistics.Win.UIElementButtonStyle.Office2003ToolbarButton;
			this.btActualiza.Location = new System.Drawing.Point(480, 296);
			this.btActualiza.Name = "btActualiza";
			this.btActualiza.Size = new System.Drawing.Size(84, 23);
			this.btActualiza.TabIndex = 137;
			this.btActualiza.Text = "Actualiza";
			this.btActualiza.Click += new System.EventHandler(this.btActualiza_Click);
			// 
			// dtFecha
			// 
			this.dtFecha.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.cdsMarceloMaestro, "MarceloMaestro.Fecha"));
			...
			this.Controls.Add(this.txtidMarceloMaestro);
			...
			this.Name = "MReparte";
			this.Text = "MReparte";
			this.Load += new System.EventHandler(this.MReparte_Load);
			((System.ComponentModel.ISupportInitialize)(this.cdvTalla)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.cdsTalla)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.txtIdCodigo)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.txtidMarceloMaestro)).EndInit();
		...
		private void MReparte_Load(object sender, System.EventArgs e)
		{
			C1.Data.FilterCondition fcPadre = new 
				C1.Data.FilterCondition(this.cdsTalla , "MarceloCodigo", "idmarcelomaestro=0");
			C1.Data.FilterConditions fcTotal = new C1.Data.FilterConditions();
			fcTotal.Add(fcPadre);

			this.cdsTalla.Fill(fcTotal, false);
			
			
			//cdvTalla.RowFilter ="idmarcelomaestro=0";
			//cdvTalla.Refresh();
...
//   		}
			 if (sum>0)
			{
				...
				string stSelect ="update marcelocodigo set idmarcelomaestro="+ barraDato1.IdRegistro  +" where idmarcelomaestro=0 and unir=1" ;
  			Funcion.EjecutaSQL (cdsTalla ,stSelect);
  			MessageBox.Show("Se han unido en solo envio con exito")  ;
			}
			else
			 {
				 barraDato1.DeshacerRegistro();  
				 MessageBox.Show("No existen codigos a unir");  
			 }
				 this.Close();
			}
