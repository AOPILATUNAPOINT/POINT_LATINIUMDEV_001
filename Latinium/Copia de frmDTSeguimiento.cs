...
namespace Latinium
{
	...
	public class frmDTSeguimiento : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn23 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Informe");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn23 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Informe");
			...
			this.ugIngresosDT.Location = new System.Drawing.Point(8, 48);
			...
			this.btnGuardar.Location = new System.Drawing.Point(88, 464);
			...
			this.ugInformesDT.Size = new System.Drawing.Size(680, 112);
			...
			this.btnImprimir.Location = new System.Drawing.Point(168, 464);
			...
			this.btnCancelar.Location = new System.Drawing.Point(248, 464);
		...
		private void btnGuardar_Click(object sender, System.EventArgs e)
		{
			...
			string sSQL = string.Format("Exec GuardaDT_Procesos {0}, 20, {1}, {2}, '{3}', 0, '', 0, 0, 0, 0, '{4}', '{5}', 0", 
				idIngreso, (int)this.cmbEstados.Value, idPersonal, this.txtInforme.Text.ToString().Trim(), this.txtIngreso.Text.ToString().Trim(), dtRetorno.ToString("yyyyMMdd"));
		...
		private void cmbEstados_ValueChanged(object sender, System.EventArgs e)
		{
			...
			if ((int)this.cmbEstados.Value == 19 || (int)this.cmbEstados.Value == 20 || (int)this.cmbEstados.Value == 21) this.dtFechaRetorno.Enabled = true;	
