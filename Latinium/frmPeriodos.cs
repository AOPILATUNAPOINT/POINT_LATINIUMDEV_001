...
namespace Latinium
{
	...
	public class frmPeriodos : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn15 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Presupuesto");
		...
		/*	this.cmbAño.Items.Add("2014");
			...
			this.cmbAño.Items.Add("2020");
			this.cmbAño.Items.Add("2021");
			this.cmbAño.Items.Add("2022");
			this.cmbAño.Items.Add("2023");
			this.cmbAño.Items.Add("2024");
			this.cmbAño.Items.Add("2025");
			this.cmbAño.Text = "2023";						
		}
		...
		private void ultraGrid2_CellChange(object sender, Infragistics.Win.UltraWinGrid.CellEventArgs e)
		{
			if (e.Cell.Row.Cells["idPeriodo"].Value != System.DBNull.Value)
			{
				...
				{
					this.ultraGrid2.UpdateData();
					Funcion.EjecutaSQL(cdsSeteoF, string.Format("Exec ActualizaEstadoPeriodo {0}, {1}, 'Presupuesto'", (int)e.Cell.Row.Cells["idPeriodo"].Value, (bool)e.Cell.Row.Cells["Presupuesto"].Value));
				}
