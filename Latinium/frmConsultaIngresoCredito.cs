...
{
	/// <summary>
	/// Descripción breve de frmConsultaIngresoCredito.
	/// </summary>
	public class frmConsultaIngresoCredito : System.Windows.Forms.Form
	{
		...
		public frmConsultaIngresoCredito()
		{
			//
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idIngresoCobrador");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn1 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idIngresoCobrador");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn4 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idIngresoCobrador");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn7 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idRegion");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn10 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("fechaSalida");
			...
			this.ultraLabel1.TabIndex = 988;
			this.ultraLabel1.Text = "Cedula/Nombre";
			// 
			// btnBuscar
			// 
			...
			this.txtBusqueda.Location = new System.Drawing.Point(104, 9);
			this.txtBusqueda.Name = "txtBusqueda";
			this.txtBusqueda.Size = new System.Drawing.Size(192, 21);
			this.txtBusqueda.TabIndex = 986;
			// 
			// uGridCreditos
			// 
			...
			this.uGridCreditos.DisplayLayout.Override.ActiveRowAppearance = appearance3;
			...
			this.uGridCreditos.DisplayLayout.Override.CardAreaAppearance = appearance4;
			appearance5.ForeColor = System.Drawing.Color.Black;
			appearance5.ForeColorDisabled = System.Drawing.Color.Black;
			this.uGridCreditos.DisplayLayout.Override.CellAppearance = appearance5;
			...
			this.uGridCreditos.Location = new System.Drawing.Point(8, 56);
			this.uGridCreditos.Name = "uGridCreditos";
			this.uGridCreditos.Size = new System.Drawing.Size(480, 160);
			this.uGridCreditos.TabIndex = 989;
			// 
			// ultraDataSource2
			// 
			...
			this.btnAceptar.Location = new System.Drawing.Point(16, 224);
			this.btnAceptar.Name = "btnAceptar";
			this.btnAceptar.TabIndex = 990;
			...
			this.btnCancelar.Location = new System.Drawing.Point(96, 224);
			this.btnCancelar.Name = "btnCancelar";
			this.btnCancelar.TabIndex = 991;
			...
			this.Name = "frmConsultaIngresoCredito";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Buscar";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmConsultaIngresoCredito_KeyDown);
			this.Load += new System.EventHandler(this.frmConsultaIngresoCredito_Load);
		...
		private void Aceptar()
		{
			...
			else if (this.uGridCreditos.ActiveRow.Cells["idIngresoCobrador"].Value == System.DBNull.Value)
			{
				MessageBox.Show("Seleccione un documento.", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Information);				
			}
			else 
		...
		private void frmConsultaIngresoCredito_Load(object sender, System.EventArgs e)
		{
		...
		{
			string sSQLPa = string.Format("Exec ConsultaGeneralIngresoCobrador '{0}'", 
				this.txtBusqueda.Text);

			FuncionesProcedimientos.dsGeneral(sSQLPa, this.uGridCreditos);
		}

		private void frmConsultaIngresoCredito_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
