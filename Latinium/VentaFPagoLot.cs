...
{
	/// <summary>
	/// Summary description for VentaFPagoLot.
	/// </summary>
	public class VentaFPagoLot : DevExpress.XtraEditors.XtraForm
	{
		...
		int IdCliente = 0;
		decimal DObtValorAnticipo = 0.00m;
		int VValFPago = 0;
		bool iCoutAnticipo = false;
		int ICountFP = 0;
		int IdFacOriginal = 0;
		int ITipoCliente = 0;
		public decimal dRetValorAnticipo = 0.00m;
		int iTarjeta = 0;
		bool BAbonoCliente = false;
		...
		public Infragistics.Win.UltraWinEditors.UltraNumericEditor spnAbonoVisita;
		private Acceso miAcceso;
		bool BCobroAnticipado = false;
		decimal DCobroAnticipado = 0.00m;
		bool BPromocionActiva = false;
		decimal DPromocionActiva = 0.00m;
		int IdAnticipoPromocionActiva = 0;

		public VentaFPagoLot()
		{
			//
		...
		public VentaFPagoLot(int idFormaPago, decimal  dValor, int iOrigen, bool bPagoCredito)
		{
			InitializeComponent();
		...
		public VentaFPagoLot(int idCompra, int idFormaPago, decimal  dValor, int iOrigen, int vValFPago)
		{
			InitializeComponent();
		...
		public VentaFPagoLot(int idCompra, int iFormaPag, decimal  dValor, decimal  dEfectivo, decimal  dSaldo, bool bAnticipo, decimal  dAnticipo, bool bNuevo, string sNumNC, decimal  dRetenido, int iOrigen, int iEstado, bool bPagoCredito, int idCliente)
		{
			//
			// Required for Windows Form Designer support
			//
		...
		public VentaFPagoLot(int idCompra, int idFormaPago, decimal  dValor, string sNumero, bool bNotaDeCredito, int idNotaDeCredito, decimal  dValorNotaDeCredito, bool bRetencion, decimal  dValorRetencion, bool bAnticipo, decimal  dValorAnticipo, bool bCrediPoint, decimal  dValorCrediPoint, decimal  dEntrada, int idOrigen, int idCliente, int idBanco, int idTarjeta, int idPlan, int idPlazo, decimal dObtValorAnticipo, int vValFPago, int iCountFP, int idFacOriginal, int iTipoCliente, bool bAbonoCliente, bool bUsoGiftCard, decimal dGiftCard, bool bUsoCupon, decimal dValorCupon, bool bCobroAnticipado, decimal dCobroAnticipado, bool bPromocionActiva, decimal dPromocionActiva, int idAnticipoPromocionActiva)
		{
			InitializeComponent();
			...
			IdPlan = idPlan;
			IdPlazo = idPlazo;
			DObtValorAnticipo = dObtValorAnticipo;
			VValFPago = vValFPago;
			ICountFP = iCountFP;
			IdFacOriginal = idFacOriginal;
			ITipoCliente = iTipoCliente;
			BAbonoCliente = bAbonoCliente;
			BUsoGiftCard = bUsoGiftCard;
			DGiftCard = dGiftCard;
			BUsoCupon = bUsoCupon;
			DValorCupon = dValorCupon;
			BCobroAnticipado = bCobroAnticipado;
			DCobroAnticipado = dCobroAnticipado;
			BPromocionActiva = bPromocionActiva;
			DPromocionActiva = dPromocionActiva;
			IdAnticipoPromocionActiva = idAnticipoPromocionActiva;
		}
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn22 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("I");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn23 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("DescripcionPrenda");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn22 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("I");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn23 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("DescripcionPrenda");
			...
			this.spnAbonoVisita = new Infragistics.Win.UltraWinEditors.UltraNumericEditor();
			...
			((System.ComponentModel.ISupportInitialize)(this.spnAbonoVisita)).BeginInit();
			this.SuspendLayout();
			// 
			// cmbFormaPago
			// 
			...
			this.ultraGrid1.Size = new System.Drawing.Size(320, 248);
			...
			// btGrabar
			// 
			this.btGrabar.Location = new System.Drawing.Point(8, 416);
			...
			this.label4.Text = "ABONO PROX. VISITA";
			// 
			// spnAbonoVisita
			// 
			appearance14.ForeColorDisabled = System.Drawing.Color.Black;
			this.spnAbonoVisita.Appearance = appearance14;
			this.spnAbonoVisita.ButtonStyle = Infragistics.Win.UIElementButtonStyle.Office2003ToolbarButton;
			this.spnAbonoVisita.Enabled = false;
			this.spnAbonoVisita.FormatString = "#,##0.00";
			this.spnAbonoVisita.Location = new System.Drawing.Point(136, 381);
			this.spnAbonoVisita.MaskInput = "nnn";
			this.spnAbonoVisita.MinValue = -2147483647;
			this.spnAbonoVisita.Name = "spnAbonoVisita";
			this.spnAbonoVisita.NumericType = Infragistics.Win.UltraWinEditors.NumericType.Double;
			this.spnAbonoVisita.PromptChar = ' ';
			this.spnAbonoVisita.Size = new System.Drawing.Size(162, 22);
			this.spnAbonoVisita.TabIndex = 175;
			// 
			// VentaFPagoLot
			// 
			...
			this.Controls.Add(this.spnAbonoVisita);
			...
			this.Name = "VentaFPagoLot";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Detalle de Cobro";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.VentaFPagoLot_KeyDown);
			this.Closing += new System.ComponentModel.CancelEventHandler(this.VentaFPagoLot_Closing);
			this.Load += new System.EventHandler(this.VentaFPagoLot_Load);
			...
			((System.ComponentModel.ISupportInitialize)(this.spnAbonoVisita)).EndInit();
		...
		bool bLoad = false;
		decimal dVGiftCard = 0.00m;
		decimal dVCupones = 0.00m;

		public void VentaFPagoLot_Load(object sender, System.EventArgs e)
		{
			string stTipo = "0703";
			...
			if(BAnticipoFact)
				this.cmbFormaPago.DataSource = Funcion.dvProcedimiento(cdsSeteoF, string.Format("Exec CompraFPagoCarga {0}", 6));
			else
				this.cmbFormaPago.DataSource = Funcion.dvProcedimiento(cdsSeteoF, string.Format("Exec CompraFPagoCarga {0}", VValFPago));			
			#endregion Carga Formas de Pago
	
			if (!BPagoCredito)
			{
				this.spnTotal.Value = Math.Round(DValorFact, 2);
					
				bool hayFormasPago = Funcion.iEscalarSQL(cdsSeteoF, string.Format("Select COUNT(*) From DetalleFormaPago Where idCompra = {0} And Origen = {1}", IdCompraFact, IdOrigen)) > 0;

				if (!hayFormasPago)
				{	
					#region Anticipos - Retenciones - Notas de Crédito - Cupon
					if (IdOrigen == 1 || IdOrigen == 6)
					{	
						if (BCobroAnticipado && DCobroAnticipado > 0)
						{
							this.ultraGrid1.DisplayLayout.Bands[0].AddNew();
							this.ultraGrid1.ActiveRow.Cells["idDetFormaPago"].Value = 0;
							this.ultraGrid1.ActiveRow.Cells["idFormaPago"].Value = 39;
							this.ultraGrid1.ActiveRow.Cells["Valor"].Value = DCobroAnticipado;
						...
						if (BPromocionActiva)
						{
							this.ultraGrid1.DisplayLayout.Bands[0].AddNew();
							this.ultraGrid1.ActiveRow.Cells["idDetFormaPago"].Value = 0;
							this.ultraGrid1.ActiveRow.Cells["idFormaPago"].Value = 37;
							this.ultraGrid1.ActiveRow.Cells["Valor"].Value = DPromocionActiva;
							this.ultraGrid1.ActiveRow.Cells["Origen"].Value = IdOrigen;
							this.ultraGrid1.ActiveRow.Cells["idDocumento"].Value = IdAnticipoPromocionActiva;
						}
						...
						if(BUsoGiftCard)
						{
							if (DGiftCard > DValorFact) dVGiftCard = DValorFact;
							else if (DGiftCard <= DValorFact) dVGiftCard = DGiftCard;
					
							this.ultraGrid1.DisplayLayout.Bands[0].AddNew();
							this.ultraGrid1.ActiveRow.Cells["idDetFormaPago"].Value = 0;
							this.ultraGrid1.ActiveRow.Cells["idFormaPago"].Value = 22;
							this.ultraGrid1.ActiveRow.Cells["Valor"].Value = dVGiftCard;
							this.ultraGrid1.ActiveRow.Cells["Origen"].Value = IdOrigen;
							if (BCredito) DEntrada = DEntrada - DValorFact;
						}

						if(BUsoCupon)
						{
							if (DValorCupon > DValorFact) dVCupones = DValorFact;
							else if (DValorCupon <= DValorFact) dVCupones = DValorCupon;
					
							this.ultraGrid1.DisplayLayout.Bands[0].AddNew();
							this.ultraGrid1.ActiveRow.Cells["idDetFormaPago"].Value = 0;
							this.ultraGrid1.ActiveRow.Cells["idFormaPago"].Value = 8;
							this.ultraGrid1.ActiveRow.Cells["Valor"].Value = dVCupones;
							this.ultraGrid1.ActiveRow.Cells["Origen"].Value = IdOrigen;
							if (BCredito) DEntrada = DEntrada - DValorFact;
						}
					}
					#endregion Anticipos - Retenciones - Notas de Crédito - Cupon

					#region Carga fila con Forma de pago
					if (!BCredito)
					{
						decimal dValorFactura = Math.Round(DValorFact - dVAnticipo - DValorRetencion - DValorNotaDeCredito - DGiftCard - DValorCupon - DCobroAnticipado - DPromocionActiva, 2);
						if (dValorFactura > 0)
						{
							this.ultraGrid1.DisplayLayout.Bands[0].AddNew();
							this.ultraGrid1.ActiveRow.Cells["idDetFormaPago"].Value = 0;
							...
							this.ultraGrid1.ActiveRow.Cells["idFormaPago"].Value = IdFormaDePago;
							this.ultraGrid1.ActiveRow.Cells["Valor"].Value = Math.Round(DValorFact - DValorAnticipo - DValorRetencion - DValorNotaDeCredito - DGiftCard - DValorCupon - DCobroAnticipado - DPromocionActiva, 2);
							this.ultraGrid1.ActiveRow.Cells["Origen"].Value = IdOrigen;
						}
				...
				{
					string sSQL = string.Format("Exec ConsultaDetalleFormaPagoLT {0}, {1}", IdCompraFact, IdOrigen);
					this.ultraGrid1.DataSource = Funcion.dvProcedimiento(cdsSeteoF, sSQL);

					foreach (UltraGridRow row in ultraGrid1.Rows)
					{
						if (row.Cells["idFormaPago"].Value != DBNull.Value &&
							Convert.ToInt32(row.Cells["idFormaPago"].Value) == 39)
						{
					...
					if (IdOrigen == 1 || IdOrigen == 6)
					{
						if (BCobroAnticipado && DCobroAnticipado > 0)
						{
							if (Funcion.iEscalarSQL(cdsSeteoF, string.Format("Select Count(*) From DetalleFormaPago Where idCompra = {0} And Origen = {1} And idFormaPago = 39", IdCompraFact, IdOrigen)) == 0)
							{
								this.ultraGrid1.DisplayLayout.Bands[0].AddNew();
								this.ultraGrid1.ActiveRow.Cells["idDetFormaPago"].Value = 0;
								this.ultraGrid1.ActiveRow.Cells["idCompra"].Value = IdCompraFact;
								this.ultraGrid1.ActiveRow.Cells["idFormaPago"].Value = 39;
								this.ultraGrid1.ActiveRow.Cells["Valor"].Value = DCobroAnticipado;
								this.ultraGrid1.ActiveRow.Cells["Origen"].Value = IdOrigen;
						...
						if (BUsoGiftCard)
						{
							if (Funcion.iEscalarSQL(cdsSeteoF, string.Format("Select Count(*) From DetalleFormaPago Where idCompra = {0} And Origen = {1} And idFormaPago = 22", IdCompraFact, IdOrigen)) == 0)
							{
								if (DGiftCard > DValorFact) dVGiftCard = DValorFact;
								else if (DGiftCard <= DValorFact) dVGiftCard = DGiftCard;
								...
								this.ultraGrid1.ActiveRow.Cells["idDetFormaPago"].Value = 0;
								this.ultraGrid1.ActiveRow.Cells["idFormaPago"].Value = 22;
								this.ultraGrid1.ActiveRow.Cells["Valor"].Value = DGiftCard;
								this.ultraGrid1.ActiveRow.Cells["Origen"].Value = IdOrigen;
					...
					#region Calcula saldo a efectivo si existen formas guardadas

					decimal dTotalFormasPago = 0.00m;
					decimal dSaldoEfectivo = 0.00m;
					bool bExisteEfectivo = false;

					foreach (UltraGridRow dr in ultraGrid1.Rows)
					{
						if (dr.Cells["idFormaPago"].Value != DBNull.Value &&
							dr.Cells["idFormaPago"].Value != null)
						{
							if (Convert.ToInt32(dr.Cells["idFormaPago"].Value) == 1)
							{
								bExisteEfectivo = true;
							}

							if (dr.Cells["Valor"].Value != DBNull.Value &&
								dr.Cells["Valor"].Value != null)
							{
								dTotalFormasPago = dTotalFormasPago + Convert.ToDecimal(dr.Cells["Valor"].Value);
							}
						}
					}

					dSaldoEfectivo = Math.Round(DValorFact - dTotalFormasPago, 2);

					if (dSaldoEfectivo > 0 && !bExisteEfectivo)
					{
						this.ultraGrid1.DisplayLayout.Bands[0].AddNew();
						this.ultraGrid1.ActiveRow.Cells["idDetFormaPago"].Value = 0;
						this.ultraGrid1.ActiveRow.Cells["idCompra"].Value = IdCompraFact;
						this.ultraGrid1.ActiveRow.Cells["idFormaPago"].Value = 1;
						this.ultraGrid1.ActiveRow.Cells["Valor"].Value = dSaldoEfectivo;
						this.ultraGrid1.ActiveRow.Cells["Origen"].Value = IdOrigen;
					...
					#endregion Calcula saldo a efectivo si existen formas guardadas
				}
			}
			else
			{
			...
			if(BAbonoCliente)
				this.spnAbonoVisita.Enabled = true;

			if (ICountFP == 1)
			{
				int iFila = 0;

				string sSQL = string.Format("Exec ConsultaDetalleFormaPagoOriginal {0}", IdFacOriginal);
				SqlDataReader drr = Funcion.rEscalarSQL(cdsSeteoF, sSQL, true);
				while(drr.Read())
				{				
					ultraGrid1.Rows[iFila].Cells["idDetFormaPago"].Value = 0;
					ultraGrid1.Rows[iFila].Cells["idCompra"].Value = IdCompraFact;
					ultraGrid1.Rows[iFila].Cells["idBanco"].Value = drr.GetInt32(6);
					ultraGrid1.Rows[iFila].Cells["idTarjeta"].Value = drr.GetInt32(5);
					ultraGrid1.Rows[iFila].Cells["idFormaPago"].Value = drr.GetInt32(2);
					ultraGrid1.Rows[iFila].Cells["Valor"].Value = drr.GetDecimal(3);
					ultraGrid1.Rows[iFila].Cells["ValorUsoTarjeta"].Value = drr.GetDecimal(4);
					ultraGrid1.Rows[iFila].Cells["CuentaCorriente"].Value = drr.GetString(7);
					ultraGrid1.Rows[iFila].Cells["Numero"].Value = drr.GetString(8);
					ultraGrid1.Rows[iFila].Cells["FechaCaducidad"].Value = drr.GetDateTime(9);
					ultraGrid1.Rows[iFila].Cells["NumVoucher"].Value = drr.GetString(10);
					ultraGrid1.Rows[iFila].Cells["Autorizacion"].Value = drr.GetString(11);
					ultraGrid1.Rows[iFila].Cells["Origen"].Value = drr.GetInt32(12);
					ultraGrid1.Rows[iFila].Cells["idCuenta"].Value = drr.GetInt32(13);					
					ultraGrid1.Rows[iFila].Cells["Lote"].Value = drr.GetString(14);
					ultraGrid1.Rows[iFila].Cells["Referencia"].Value = drr.GetString(15);
					ultraGrid1.Rows[iFila].Cells["idPlan"].Value = drr.GetInt32(16);
					ultraGrid1.Rows[iFila].Cells["idPlazo"].Value = drr.GetInt32(17);
					ultraGrid1.Rows[iFila].Cells["idDocumento"].Value = drr.GetInt32(18);
					ultraGrid1.Rows[iFila].Cells["DescripcionPrenda"].Value = drr.GetString(19);
		...
		//
		//				if (band.Columns.Exists("I"))
		//				{
		//					band.Columns["I"].Style = Infragistics.Win.UltraWinGrid.ColumnStyle.Button;
		//					band.Columns["I"].ButtonDisplayStyle = Infragistics.Win.UltraWinGrid.ButtonDisplayStyle.Always;
		//					band.Columns["I"].CellActivation = Infragistics.Win.UltraWinGrid.Activation.AllowEdit;
		//				}
		//				bool existe;
		//
		//				if (IdFormaDePago == 29 || IdFormaDePago == 30)
		//				{
		//					existe = false;
		//
		//					foreach (UltraGridRow r in ultraGrid1.Rows)
		//					{
		//						if (r.Cells["idFormaPago"].Value != DBNull.Value &&
		//							(int)r.Cells["idFormaPago"].Value == IdFormaDePago)
		//						{
		//							existe = true;
		//							break;
		//						}
		...
		//
		//						row.Cells["idDetFormaPago"].Value = 0;
		//						row.Cells["idCompra"].Value = IdCompraFact;
		//						row.Cells["idFormaPago"].Value = IdFormaDePago;
		//						row.Cells["Valor"].Value = DValorFact;
		//						row.Cells["Origen"].Value = IdOrigen;
		//
		//						row.Update();
		//					}
		//
		...
		//						{
		//							if (r.Cells["idFormaPago"].Value != DBNull.Value &&
		//								(int)r.Cells["idFormaPago"].Value == 8)
		//							{
		//								existe = true;
		//								break;
		//							}
		...
		//						if (!existe)
		//						{
		//							decimal valor = (DValorAnticipo > DValorFact) ? DValorFact : DValorAnticipo;
		//
		//							UltraGridRow row = ultraGrid1.DisplayLayout.Bands[0].AddNew();
		//
		//							row.Cells["idDetFormaPago"].Value = 0;
		//							row.Cells["idCompra"].Value = IdCompraFact;
		//							row.Cells["idFormaPago"].Value = 8;
		...
		//						{
		//							if (r.Cells["idFormaPago"].Value != DBNull.Value &&
		//								(int)r.Cells["idFormaPago"].Value == 10)
		//							{
		//								existe = true;
		//								break;
		//							}
		...
		//							UltraGridRow row = ultraGrid1.DisplayLayout.Bands[0].AddNew();
		//
		//							row.Cells["idFormaPago"].Value = 10;
		//							row.Cells["Valor"].Value = DValorRetencion;
		//							row.Cells["Origen"].Value = IdOrigen;
		//
		//							row.Update();
		//						}
		...
		//						{
		//							if (r.Cells["idFormaPago"].Value != DBNull.Value &&
		//								(int)r.Cells["idFormaPago"].Value == 4)
		//							{
		//								existe = true;
		//								break;
		//							}
		...
		//							UltraGridRow row = ultraGrid1.DisplayLayout.Bands[0].AddNew();
		//
		//							row.Cells["idFormaPago"].Value = 4;
		//							row.Cells["Valor"].Value = DValorNotaDeCredito;
		//							row.Cells["Origen"].Value = IdOrigen;
		//
		//							row.Update();
		//						}
		...
		//						{
		//							if (r.Cells["idFormaPago"].Value != DBNull.Value &&
		//								(int)r.Cells["idFormaPago"].Value == 22)
		//							{
		//								existe = true;
		//								break;
		//							}
		...
		//						if (!existe)
		//						{
		//							decimal valor = (DGiftCard > DValorFact) ? DValorFact : DGiftCard;
		//
		//							UltraGridRow row = ultraGrid1.DisplayLayout.Bands[0].AddNew();
		//
		//							row.Cells["idFormaPago"].Value = 22;
		//							row.Cells["Valor"].Value = valor;
		//							row.Cells["Origen"].Value = IdOrigen;
		//
		//							row.Update();
		...
		//					}
		//
		//					if (IdFormaDePago > 0 && IdFormaDePago != 1 && !(IdFormaDePago == 39 && (BAnticipoFact || IdOrigen != 1)))
		//					{
		//						existe = false;
		//						foreach (UltraGridRow r in ultraGrid1.Rows)
		//						{
		//							if (r.Cells["idFormaPago"].Value != DBNull.Value &&
		//								(int)r.Cells["idFormaPago"].Value == 39)
		//							{
		//								existe = true;
		//								break;
		//							}
		...
		//							row.Cells["idDetFormaPago"].Value = 0;
		//							row.Cells["idCompra"].Value = IdCompraFact;
		//							row.Cells["idFormaPago"].Value = 39;
		//							row.Cells["Valor"].Value = DCobroAnticipado;
		//							row.Cells["Origen"].Value = IdOrigen;
		//
		//							row.Update();
		//						}
		...
		//				foreach (UltraGridRow r in ultraGrid1.Rows)
		//				{
		//					if (r.Cells["Valor"].Value != DBNull.Value)
		//					{
		//						totalExistente += Convert.ToDecimal(r.Cells["Valor"].Value);
		//					}
		//				}
		//
		//				if (IdFormaDePago > 0 && IdFormaDePago != 1)
		//				{
		//					bool existeFP = false;
		//
		//					foreach (UltraGridRow r in ultraGrid1.Rows)
		...
		//					if (!existeFP)
		//					{
		//						decimal restanteFP = Math.Round(DValorFact - totalExistente, 2);
		//
		//						if (restanteFP > 0)
		//						{
		//							UltraGridRow row = ultraGrid1.DisplayLayout.Bands[0].AddNew();
		...
		//							row.Cells["idCompra"].Value = IdCompraFact;
		//							row.Cells["idFormaPago"].Value = IdFormaDePago;
		//							row.Cells["Valor"].Value = restanteFP;
		//							row.Cells["Origen"].Value = IdOrigen;
		//
		//							row.Update();
		//						}
		...
		//				}
		//
		//				decimal restante = Math.Round(DValorFact - totalExistente, 2);
		//
		//				if (restante > 0)
		//				{
		//					existe = false;
		...
		//					{
		//						if (r.Cells["idFormaPago"].Value != DBNull.Value &&
		//							(int)r.Cells["idFormaPago"].Value == 1)
		//						{
		//							existe = true;
		//							break;
		//						}
		...
		//						row.Cells["idDetFormaPago"].Value = 0;
		//						row.Cells["idCompra"].Value = IdCompraFact;
		//						row.Cells["idFormaPago"].Value = 1;
		//						row.Cells["Valor"].Value = restante;
		//						row.Cells["Origen"].Value = IdOrigen;
		//
		//						row.Update();
		//					}
		...
		private void ultraGrid1_AfterCellUpdate(object sender, Infragistics.Win.UltraWinGrid.CellEventArgs e)
		{
			...
			#region Editor de información de Tarjetas de crédito - Transferencias - Cheques - Notas de crédito - Anticipos - Abono Cliente
			...
			{				
				...
				if (iFormaPago == 8)
				{
					// this.ultraGrid1.DisplayLayout.Bands[0].Columns["Valor"].CellActivation = Activation.NoEdit;
					// this.ultraGrid1.DisplayLayout.Bands[0].Columns["idFormaPago"].CellActivation = Activation.NoEdit;

					if (e.Cell.Row.Cells["Valor"].Value != System.DBNull.Value)
					{
						if ((decimal)e.Cell.Row.Cells["Valor"].Value != DObtValorAnticipo)
						{
					...
					if (iCoutAnticipo)
					{
						MessageBox.Show("Ya existe un Anticipo Ingresado", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop);
						e.Cell.Row.Cells["Valor"].Value = 0;
						return;
					}
				}			
				...
				if(IdFormaDePago == 1)
				{
					this.ultraGrid1.DisplayLayout.Bands[0].Columns["Valor"].CellActivation = Infragistics.Win.UltraWinGrid.Activation.AllowEdit;
				}

				if (iFormaPago == 2 || iFormaPago == 3 || iFormaPago == 7 || iFormaPago == 11 || iFormaPago == 13 || iFormaPago == 16 || iFormaPago == 45) // && e.Cell.Row.Cells["idFormaPago"].Value != DBNull.Value) //(decimal ) e.Cell.Row.Cells["Valor"].Value > 0 && 
				{
					this.ultraGrid1.DisplayLayout.Bands[0].Columns["Valor"].CellActivation = Infragistics.Win.UltraWinGrid.Activation.AllowEdit;
					...
					if (iFormaPago == 3)
					{
						if (e.Cell.Row.Cells["idTarjeta"].Value != DBNull.Value)
						{
					...
					using(ChequeTCLot miCheque = new ChequeTCLot(iFormaPago, IdBanco, IdTarjeta, IdCuenta, SNumero, DTFecha, SCuentaCorriente, SVoucher, SAutorizacion, SLote, SReferencia, IdPlan, IdPlazo))
					{
						if (DialogResult.OK == miCheque.ShowDialog())
						{
							...
							{
								e.Cell.Row.Cells["idTarjeta"].Value = (int) miCheque.optTarjeta.Value;
								...
								e.Cell.Row.Cells["idPlan"].Value = (int)miCheque.optPlan.Value;
								//if (miCheque.cmbPlazo.Text.ToString().Length > 0) e.Cell.Row.Cells["idPlazo"].Value = 0; //(int) miCheque.cmbPlazo.Value;
								...
								//e.Cell.Row.Cells["DescripcionPrenda"].Value = (string)miCheque.txtDesPrenda.Text;
							}
							...
							{
								e.Cell.Row.Cells["DescripcionPrenda"].Value = miCheque.txtDesPrenda.Value.ToString();
							}
								#endregion Prenda
							#region DEUNA
							else if (iFormaPago == 45)
							{
								e.Cell.Row.Cells["NumVoucher"].Value = (string) miCheque.txtnumeroTRX.Text;
							#endregion DEUNA
							}
						}
					}
				...
				//				if(iFormaPago == 37)
				//				{
				//					this.ultraGrid1.DisplayLayout.Bands[0].Columns["Valor"].CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit;
				//					Suma();
				//
				//					e.Cell.Row.Cells["Valor"].Value = Convert.ToDecimal(this.spnSaldo.Value);
				//					return;
				//				}
				#endregion region Abono Cliente
			...
			#endregion Editor de información de Tarjetas de crédito - Transferencias - Cheques - Notas de crédito - Anticipos - Abono Cliente
		...
		private void VentaFPagoLot_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
				...
				case (int) Keys.F3:
					if (ultraGrid1.ActiveCell.Column.Key.ToString().ToUpper() == "IDFORMAPAGO" || ultraGrid1.ActiveCell.Column.Key.ToString().ToUpper() == "VALOR")
					{
						if (ultraGrid1.ActiveRow.Cells["idFormaPago"].Value != DBNull.Value)
						{
							...
							if (iFormaPago == 2 || iFormaPago == 3 || iFormaPago == 7 || iFormaPago == 11 || iFormaPago == 45)
							{
								#region Variables
								int IdBanco = 0;
								int IdTarjeta = 0;
								...
								using(ChequeTCLot miCheque = new ChequeTCLot(iFormaPago, IdBanco, IdTarjeta, IdCuenta, SNumero, DTFecha, SCuentaCorriente, SVoucher, SAutorizacion, SLote, SReferencia, IdPlan, IdPlazo))
								{
									if (DialogResult.OK == miCheque.ShowDialog())
									{
										...
										{
											ultraGrid1.ActiveRow.Cells["NumVoucher"].Value = (string) miCheque.txtnumeroTRX.Text;
										}
									}
								}
							}
		...
		private void ultraGrid1_BeforeRowsDeleted(object sender, Infragistics.Win.UltraWinGrid.BeforeRowsDeletedEventArgs e)
		{
			...
			for (int i = 0; i < e.Rows.Length; i++)
			{
				...
				if (e.Rows[i].Cells["idFormaPago"].Value != DBNull.Value && e.Rows[i].Cells["idFormaPago"].Value != null)
				{
					idFormaPago = Convert.ToInt32(e.Rows[i].Cells["idFormaPago"].Value);
				}

				if (e.Rows[i].Cells["idDetFormaPago"].Value != DBNull.Value && e.Rows[i].Cells["idDetFormaPago"].Value != null)
				{
					idDetFormaPago = Convert.ToInt32(e.Rows[i].Cells["idDetFormaPago"].Value);
				}

				if (idFormaPago == 39 && BCobroAnticipado && idDetFormaPago == 0)
				{
					MessageBox.Show("No puede eliminar el Cobro Anticipado", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop);
					e.Cancel = true;
					e.DisplayPromptMsg = false;
					return;
				}

				if (idFormaPago == 6 || idFormaPago == 9 || idFormaPago == 10)
				{
					e.Cancel = true;
					return;
				}
				else if (idFormaPago == 8 || idFormaPago == 37)
				{
					MessageBox.Show("No puede eliminar esta forma de pago", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop);
					e.Cancel = true;
					return;
				}
				else if (idDetFormaPago > 0)
				{
					if (miAcceso.BEliminaFormaDePago)
					{
						...
						{
							Funcion.EjecutaSQL(cdsSeteoF, string.Format("Delete From DetalleFormaPago Where idDetFormaPago = {0}", idDetFormaPago));
							e.DisplayPromptMsg = false;
						}
						else
						{
		...
		private void VentaFPagoLot_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
				...
				if (iFormaPago == 2 || iFormaPago == 3 || iFormaPago == 7 || iFormaPago == 11 || iFormaPago == 13 || iFormaPago == 16 || iFormaPago == 45) // && e.Cell.Row.Cells["idFormaPago"].Value != DBNull.Value) //(decimal ) e.Cell.Row.Cells["Valor"].Value > 0 && 
				{
					...
					using(ChequeTCLot miCheque = new ChequeTCLot(iFormaPago, IdBanco, IdTarjeta, IdCuenta, SNumero, DTFecha, SCuentaCorriente, SVoucher, SAutorizacion, SLote, SReferencia, IdPlan, IdPlazo))
					{
						if (DialogResult.OK == miCheque.ShowDialog())
						{
							if (iFormaPago == 3 || iFormaPago == 11)
							{
								ultraGrid1.ActiveRow.Cells["idTarjeta"].Value = (int) miCheque.optTarjeta.Value;
								ultraGrid1.ActiveRow.Cells["idBanco"].Value = 0;//(int) miCheque.cmbBanco.Value;
								ultraGrid1.ActiveRow.Cells["Numero"].Value = "";//(string) miCheque.txtNumero.Text;
								...
								ultraGrid1.ActiveRow.Cells["NumVoucher"].Value = (string) miCheque.txtNumVoucher.Text;
								ultraGrid1.ActiveRow.Cells["Autorizacion"].Value = "";//(string) miCheque.txtAutorizacion.Text; 
								ultraGrid1.ActiveRow.Cells["idPlan"].Value = (int) miCheque.optPlan.Value;
								ultraGrid1.ActiveRow.Cells["idPlazo"].Value = 0;
								ultraGrid1.ActiveRow.Cells["Lote"].Value = "";
								ultraGrid1.ActiveRow.Cells["Referencia"].Value = "";
							}
							else if (iFormaPago == 2)
							{
								ultraGrid1.ActiveRow.Cells["idBanco"].Value = (int) miCheque.cmbBanco.Value;
		...
		private void ultraGrid1_BeforeCellUpdate(object sender, Infragistics.Win.UltraWinGrid.BeforeCellUpdateEventArgs e)
		{
			...
			if (e.Cell.Row.Cells["idFormaPago"].Value != DBNull.Value && e.Cell.Row.Cells["idFormaPago"].Value != null && Convert.ToInt32(e.Cell.Row.Cells["idFormaPago"].Value) == 39)
			{
				MessageBox.Show("No se puede modificar el Cobro Anticipado.", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop);

				e.Cancel = true;
				return;
			}

			if (e.Cell.Column.Key == "Valor")
			{
				if (e.Cell.Row.Cells["idFormaPago"].Value != DBNull.Value)
				{
					int idFormaPagoActual = Convert.ToInt32(e.Cell.Row.Cells["idFormaPago"].Value);

					if (idFormaPagoActual == 6 ||
						idFormaPagoActual == 8 ||
						idFormaPagoActual == 10 ||
						idFormaPagoActual == 12 ||
						idFormaPagoActual == 37 ||
						idFormaPagoActual == 39)
					{
						e.Cancel = true;
						return;
					}
			...
			if (e.Cell.Column.Key == "idFormaPago")
			{
				int nuevoValor = Convert.ToInt32(e.NewValue);
				...
				if (nuevoValor == 39)
				{
					...
					{
						if (row != e.Cell.Row &&
							row.Cells["idFormaPago"].Value != DBNull.Value &&
							Convert.ToInt32(row.Cells["idFormaPago"].Value) == 39)
						{
							MessageBox.Show("Solo se permite un Cobro Anticipado por factura.",
								"Point Technology",
		...
		private void btGrabar_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				foreach(Infragistics.Win.UltraWinGrid.UltraGridRow dr in ultraGrid1.Rows.All)
				{
					...
					if (iFP == 8) FormaPago = "l Anticipo";
					if (iFP == 14) FormaPago = " Cupon ";
					if (iFP == 16) FormaPago = " Prenda ";
					if (iFP == 22) FormaPago = " Gift Card ";
					if (iFP == 29) FormaPago = " Autoconsumo";
					if (iFP == 30) FormaPago = " Descuento Empleado ";
					...
					if (iFP == 3 || iFP == 2 || iFP == 11)
					{
						...
						if (dr.Cells["idTarjeta"].Value == DBNull.Value)
						{
					...
					if (iFP == 16)
					{
						if (dr.Cells["DescripcionPrenda"].Value == DBNull.Value)
						{
							MessageBox.Show("Ingrese los datos de" + FormaPago + ".", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Error);
							this.ultraGrid1.ActiveRow = dr;
							return;
					...
					if (BAbonoCliente)
					{
						if(ITipoCliente == 1)
						{
							MessageBox.Show("Ingresar datos del cliente.", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Error);
							this.ultraGrid1.ActiveRow = dr;
							return;
						}
						if (iTarjeta > 0)
						{
							MessageBox.Show("Valido solo en efectivo.", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Error);
							this.ultraGrid1.ActiveRow = dr;
							return;
						}
						if (Math.Round(Convert.ToDecimal(spnAbonoVisita.Value), 2) == 0.00m)
						{
							MessageBox.Show("El Valor Abono Proxima Visita no puede ser igual a CERO.", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Error);
							return;
						}
					}
				}
				...
				if (true)
				{
					if (!BPagoCredito)
					{
						...
						if (Math.Round(Convert.ToDecimal(spnSaldo.Value), 2) > 0.00m)
						{
							...
							MessageBox.Show("VALOR COBRADO MENOR A TOTAL DE FACTURA.?", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Error);
							return;
						}
						...
						if (Math.Round(Convert.ToDecimal(spnSaldo.Value), 2) < 0.00m) 
						{
							...
							MessageBox.Show("VALOR COBRADO MAYOR A TOTAL DE FACTURA.?", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Error);
							return;
						}
					}
					else
				...
				foreach(Infragistics.Win.UltraWinGrid.UltraGridRow dr in ultraGrid1.Rows.All)
				{
					...
					if (idFormaPago == 14) Mensaje = Mensaje + "\t Cupon \t" + dValor.ToString("#,##0.00") + "\n";
					if (idFormaPago == 16) Mensaje = Mensaje + "\t Prenda \t" + dValor.ToString("#,##0.00") + "\n";
					if (idFormaPago == 22) Mensaje = Mensaje + "\t Gift Card   \t" + dValor.ToString("#,##0.00") + "\n";
					if (idFormaPago == 29) Mensaje = Mensaje + "\t Autoconsumo   \t" + dValor.ToString("#,##0.00") + "\n";
					if (idFormaPago == 30) Mensaje = Mensaje + "\t Descuento Empleado   \t" + dValor.ToString("#,##0.00") + "\n";
					if (idFormaPago == 39) Mensaje = Mensaje + "\t Cobro Anticipado   \t" + dValor.ToString("#,##0.00") + "\n";
					if (idFormaPago == 45) Mensaje = Mensaje + "\t De Una   \t" + dValor.ToString("#,##0.00") + "\n";
				}
				...
				#region Ordernar Grid
				UltraGridBand band = this.ultraGrid1.DisplayLayout.Bands[0];				
				band.Columns["idFormaPago"].SortIndicator = SortIndicator.Ascending;
				// band.Columns["Valor"].SortIndicator = SortIndicator.Descending;
				#endregion Ordernar Grid
		...
		{
			e.Row.Cells["idDetFormaPago"].Value = 0;
		}
	}
}
