...
namespace Latinium
{
	...
	/// </summary>
	public class RolNivel : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridBand ultraGridBand1 = new Infragistics.Win.UltraWinGrid.UltraGridBand("PersNivel", -1);
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idNivel");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn2 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Nivel");
			...
			this.ultraGrid1.DataMember = "PersNivel";
			...
			this.Name = "RolNivel";
			this.Text = "Niveles de Roles";
			this.Closing += new System.ComponentModel.CancelEventHandler(this.RolNivel_Closing);
		...
		private void RolNivel_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			string stAudita = "Exec AuditaCrear 53, 7, 'Rol Nivel'";
			Funcion.EjecutaSQL(cdsNivel, stAudita, true);
		}

		private void RolNivel_Load(object sender, System.EventArgs e)
		{
			string stAudita = "Exec AuditaCrear 53, 6, 'Rol Nivel'";
			Funcion.EjecutaSQL(cdsNivel, stAudita, true);
		}
