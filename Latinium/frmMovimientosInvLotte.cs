...
namespace Latinium
{
	...
	public class frmMovimientosInvLotte : System.Windows.Forms.Form
	{
		...
		private void frmMovimientosInvLotte_Load(object sender, System.EventArgs e)
		{
			...
			if(niUsuario.Equals("4") || niUsuario.Equals("1") || niUsuario.Equals("2") || niUsuario.Equals("3") || niUsuario.Equals("12") || niUsuario.Equals("9") || niUsuario.Equals("15") || niUsuario.Equals("16") || niUsuario.Equals("21")) 
			{
				this.dtFecha.Enabled = true;
				this.cmbBodega.Enabled = true;
			}

			#region Activo Bodega Cajero
...
//				{
//					string sSQLST = string.Format("Select idBodega, Bodega, Codigo, Nombre From Bodega Where bodega in (1, 2) Order By Nombre");
//					this.cmbBodega.DataSource = Funcion.dvProcedimiento(cdsSeteo, sSQLST);
//				}
//				if (MenuLatinium.stIdDB == 34)
//				{
					string sSQLST = string.Format("Select idBodega, Bodega, Codigo, Nombre From Bodega Where bodega in (4, 5, 6) Order By Nombre");
					this.cmbBodega.DataSource = Funcion.dvProcedimiento(cdsSeteo, sSQLST);
//				}
			}
			#endregion Activo Bodega Cajero
		}
