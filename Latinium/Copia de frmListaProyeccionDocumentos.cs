	...
	public class frmListaProyeccionDocumentos : System.Windows.Forms.Form
	{
		...
		private void btnGuardar_Click(object sender, System.EventArgs e)
		{
			...
			string sSQL = string.Format("Exec GuardaProyeccionDocumentos {0}, '{1}', '{2}', '{3}', {4}, {5}",
				idProyeccionDocumentos, Convert.ToDateTime(this.dtFecha.Value).ToString("yyyyMMdd"), this.txtNumero.Text.ToString(), this.txtNotas.Text.ToString(), Convert.ToDecimal(this.txtValor.Value), iOrigen);
