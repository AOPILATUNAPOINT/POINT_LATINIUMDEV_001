...
{
	/// <summary>
	/// Descripción breve de frmArtLumenes.
	/// </summary>
	public class frmArtLumenes : System.Windows.Forms.Form
	{
		...
		int idArtLumenes = 0;
		public frmArtLumenes(int IdArtLumenes)
		{
			idArtLumenes = IdArtLumenes;
			//
			// Necesario para admitir el Diseñador de Windows Forms
			//
			InitializeComponent();
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idArtLumenes");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn2 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Lumenes");
			Infragistics.Win.Appearance appearance2 = new Infragistics.Win.Appearance();
			Infragistics.Win.Appearance appearance3 = new Infragistics.Win.Appearance();
			Infragistics.Win.Appearance appearance4 = new Infragistics.Win.Appearance();
			Infragistics.Win.Appearance appearance5 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn1 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idArtLumenes");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn2 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Lumenes");
			...
			this.Name = "frmArtLumenes";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Lumenes";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmArtLumenes_KeyDown);
			this.Load += new System.EventHandler(this.frmArtLumenes_Load);
		...
		private void frmArtLumenes_Load(object sender, System.EventArgs e)
		{
			this.ultraGrid1.DataSource = Funcion.dvProcedimiento(cdsSeteoF, string.Format("Select idArtLumenes, Lumenes From ArtLumenes Order By Lumenes"));
		}
		...
		private void btAceptar_Click(object sender, System.EventArgs e)
		{
			...
			{
				if ((int)drr.Cells["idArtLumenes"].Value == 0 || (int)drr.Cells["idArtLumenes"].Value > 0)
				{
					string sSQLDetalle = string.Format("Exec InsertaAtributosArticulos {0}, '{1}', {2}", 
						drr.Cells["idArtLumenes"].Value,
						drr.Cells["Lumenes"].Value.ToString(), 9);     
		...
		{
			e.Row.Cells["idArtLumenes"].Value = 0;
		}

		private void frmArtLumenes_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
