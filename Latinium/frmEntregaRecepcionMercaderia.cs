	...
	public class frmEntregaRecepcionMercaderia : System.Windows.Forms.Form
	{
		...
		private void ConfigurarBotonPorFacturar()
		{
			...
			if (iTipoFactura == 2 &&
				...
				this.cmbEstados.Text == "RECEPCIÓN BODEGA"))
			{
...
*/
		...
		private void btnRecepcionBodega_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				{
					MessageBox.Show(
						"Solo las ï¿½rdenes de compra pueden enviarse a RECEPCIï¿½N BODEGA.",
						"Sistema",
						MessageBoxButtons.OK,
						MessageBoxIcon.Warning);
          ...
          WHERE idCompra = @idCompra",
				...
				{
					MessageBox.Show(
						"La orden de compra debe estar en estado APROBADO o RECEPCIÓN BODEGA.\n\n" +
				...
				DialogResult result =
					MessageBox.Show(
					"¿Desea enviar la orden a RECEPCION BODEGA?",
					"Confirmacion",
