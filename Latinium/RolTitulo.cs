...
namespace Latinium
{
	...
	/// </summary>
	public class RolTitulo : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridBand ultraGridBand1 = new Infragistics.Win.UltraWinGrid.UltraGridBand("PersTitulo", -1);
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idPersTitulo");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn2 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Titulo");
			...
			this.ultraGrid1.DataMember = "PersTitulo";
			...
			this.Name = "RolTitulo";
			this.Text = "Titulos Profesionales";
			this.Closing += new System.ComponentModel.CancelEventHandler(this.RolTitulo_Closing);
			this.Load += new System.EventHandler(this.RolTitulo_Load);
		...
		private void RolTitulo_Load(object sender, System.EventArgs e)
		{
			string stAudita = "Exec AuditaCrear 53, 6, 'Rol Titulo'";
			Funcion.EjecutaSQL(cdsNivel, stAudita, true);
		}

		private void RolTitulo_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			string stAudita = "Exec AuditaCrear 53, 7, 'Rol Titulo'";
			Funcion.EjecutaSQL(cdsNivel, stAudita, true);
		}
