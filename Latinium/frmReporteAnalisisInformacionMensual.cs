...
namespace Latinium
{
	...
	public class frmReporteAnalisisInformacionMensual : DevExpress.XtraEditors.XtraForm
	{
		...
		private System.Windows.Forms.MenuItem mnuVerVenta;
		private System.Windows.Forms.MenuItem mnuVerUtilidad;
		private System.Windows.Forms.MenuItem mnuVerMargenUtilidad;
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.mnuVerVenta = new System.Windows.Forms.MenuItem();
			this.mnuVerUtilidad = new System.Windows.Forms.MenuItem();
			this.mnuVerMargenUtilidad = new System.Windows.Forms.MenuItem();
			...
			this.uGridDatos.Size = new System.Drawing.Size(1346, 152);
			...
			this.uGridDatosUtilidad.Size = new System.Drawing.Size(1346, 152);
			...
			this.uGridDatosMargenUtilidad.Size = new System.Drawing.Size(1106, 152);
			...
			// btnAbrirGastos
			// 
			this.btnAbrirGastos.Location = new System.Drawing.Point(448, 40);
			this.btnAbrirGastos.Name = "btnAbrirGastos";
			this.btnAbrirGastos.Size = new System.Drawing.Size(80, 23);
			...
			// btnExcel
			// 
			this.btnExcel.Location = new System.Drawing.Point(1280, 7);
			...
			this.mnuVer.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {
																																					 this.mnuVerVenta,
																																					 this.mnuVerUtilidad,
																																					 this.mnuVerMargenUtilidad});
			// 
			// mnuVerVenta
			// 
			this.mnuVerVenta.Index = 0;
			this.mnuVerVenta.Text = "Venta Total";
			this.mnuVerVenta.Click += new System.EventHandler(this.mnuVerVenta_Click);
			// 
			// mnuVerUtilidad
			// 
			this.mnuVerUtilidad.Index = 1;
			this.mnuVerUtilidad.Text = "Utilidad";
			this.mnuVerUtilidad.Click += new System.EventHandler(this.mnuVerICheque_Click);
			// 
			// mnuVerMargenUtilidad
			// 
			this.mnuVerMargenUtilidad.Index = 2;
			this.mnuVerMargenUtilidad.Text = "Margen Utilidad";
			this.mnuVerMargenUtilidad.Click += new System.EventHandler(this.mnuVerMargenUtilidad_Click);
			// 
		...
		{
			if (this.uGridDatosUtilidad.Rows.Count == 0)
			{
				MessageBox.Show("No hay Filas para Exportar", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop);
				return;
			}

			FuncionesProcedimientos.ExportaExcel(this.uGridDatosUtilidad);
		}

		private void btnExcel_Click(object sender, System.EventArgs e)
		{
			this.mnuVer.Show(this.btnExcel, new Point(1, 21));
		}

		private void mnuVerVenta_Click(object sender, System.EventArgs e)
		{
		...
		private void mnuVerMargenUtilidad_Click(object sender, System.EventArgs e)
		{
			if (this.uGridDatosMargenUtilidad.Rows.Count == 0)
			{
				MessageBox.Show("No hay Filas para Exportar", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop);
				return;
			}

			FuncionesProcedimientos.ExportaExcel(this.uGridDatosMargenUtilidad);
		}
	}
}
