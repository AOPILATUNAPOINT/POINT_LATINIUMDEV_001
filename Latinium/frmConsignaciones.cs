...
namespace Latinium
{
	...
	/// </summary>
	public class frmConsignaciones : DevExpress.XtraEditors.XtraForm
	{
		...
		public frmConsignaciones(int idCompra)
		{
			//
			// Required for Windows Form Designer support
			//
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmConsignaciones));
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn31 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idDreccion");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn32 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Direccion");
			...
			this.lblVendedor.Location = new System.Drawing.Point(496, 10);
			...
			this.lblCliente.Location = new System.Drawing.Point(496, 42);
			...
			this.lblUsuario.Location = new System.Drawing.Point(864, 432);
			...
			this.lblEstado.Location = new System.Drawing.Point(672, 430);
			...
			this.cmbVendedor.Size = new System.Drawing.Size(272, 21);
			...
			this.txtRuc.Location = new System.Drawing.Point(344, 39);
			this.txtRuc.MaxLength = 44;
			...
			this.txtNombre.Location = new System.Drawing.Point(560, 39);
			...
			this.dtFecha.Location = new System.Drawing.Point(88, 8);
			...
			ultraGridColumn18.Header.Caption = "I.V.A.";
			...
			ultraGridColumn19.Header.Caption = "Descuento";
			...
			this.ultraGrid1.Size = new System.Drawing.Size(1008, 192);
			...
			this.txtContadoCredito.Location = new System.Drawing.Point(1000, 424);
			...
			this.txtBodegaPredef.Location = new System.Drawing.Point(984, 424);
			...
			this.txtEstado.Location = new System.Drawing.Point(952, 424);
			...
			this.txtIdCliente.Location = new System.Drawing.Point(968, 424);
			...
			this.txtIdCompra.Location = new System.Drawing.Point(936, 424);
			...
			this.label3.Location = new System.Drawing.Point(768, 374);
			...
			this.lblSubTotal.Location = new System.Drawing.Point(768, 299);
			...
			this.lblIva.Location = new System.Drawing.Point(768, 347);
			...
			this.lblDescuento.Location = new System.Drawing.Point(768, 323);
			...
			this.lblIvaSubt.Location = new System.Drawing.Point(992, 272);
			...
			this.lblIva0.Location = new System.Drawing.Point(896, 272);
			...
			this.txtTotal.Appearance = appearance20;
			...
			this.txtTotal.Location = new System.Drawing.Point(848, 368);
			...
			this.txtIvaTotal.Appearance = appearance21;
			...
			this.txtIvaTotal.Location = new System.Drawing.Point(936, 344);
			...
			this.txtDescIva0Total.Appearance = appearance22;
			...
			this.txtDescIva0Total.Location = new System.Drawing.Point(848, 320);
			...
			this.txtDescIvaTotal.Location = new System.Drawing.Point(936, 320);
			...
			this.txtIva.Location = new System.Drawing.Point(936, 296);
			...
			this.txtIva0.Appearance = appearance25;
			...
			this.txtIva0.Location = new System.Drawing.Point(848, 296);
			...
			this.txtNotas.Appearance = appearance26;
			...
			this.groupBox1.Location = new System.Drawing.Point(320, 280);
			...
			this.btnClaveDescuento.Location = new System.Drawing.Point(632, 424);
			...
			this.ultraNumericEditor1.Location = new System.Drawing.Point(920, 424);
			...
			this.txtIdFormaPago.Location = new System.Drawing.Point(904, 424);
			...
			this.txtIdFormaPago.TabIndex = 406;
		...
		{			
			try
			{
				...
				if (dr.HasRows)
				{
					...
					this.txtIdFormaPago.Value = dr.GetInt32(1);
		...
		private void btnEditar_Click(object sender, System.EventArgs e)
		{
			...
			if (!Facturacion.ValidaEdicionAnulacion((int)this.txtIdCompra.Value, this.ultraGrid1, miAcceso.Editar, (int)this.txtEstado.Value, 44, (int)this.cmbBodega.Value, 
		...
		private void btnConsultar_Click(object sender, System.EventArgs e)
		{
			...
			using (frmBuscaFacturas Busqueda = new frmBuscaFacturas(44, (int)this.txtBodegaPredef.Value, miAcceso.BLimiteBusquedaFechas))
			{
		...
		{						
			...
			Facturacion.Impresion((int)this.txtIdCompra.Value, bAnulado, (int)this.txtEstado.Value, miAcceso.Imprimir, miAcceso.ReImprimir, true, false, 44, 0.00m, 0, 0, "", DateTime.Today, 0, "", cdsSeteoF);
		}
		...
		private void btnGuardar_Click(object sender, System.EventArgs e)
		{
			...
			if (!Validacion.vbClienteExiste(this.txtRuc, false, 44, (int)this.txtIdFormaPago.Value, cdsSeteoF)) return;
			...
			if (!Validacion.vbGrids(this.ultraGrid1, "Codigo", 44)) return;

			if (!Validacion.ValidaTotales((decimal)this.txtTotal.Value)) return;
			
			if (!Validacion.bValidaExistencias(this.ultraGrid1, (DateTime)this.dtFecha.Value, (int)this.txtIdCompra.Value, (int)this.cmbBodega.Value, 44, 0, cdsSeteoF)) return;
			...
			if (DialogResult.Yes == MessageBox.Show("Antes de Guardar. \n\n VERIQUE QUE LOS DATOS REGISTRADOS SON LOS CORRECTOS \n\n INFORMACIÓN DEL CLIENTE \n PRODUCTOS \n PRECIOS CANTIDADES DESCUENTOS \n\n\n ¿Esta seguro de Guardar?", "Point Technology", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2)) 
			{
				...
				this.txtIdCompra.Value = 
					Facturacion.GrabaFacturacion((int)this.txtIdCompra.Value, 0, 0, 44, 15, (int)this.txtEstado.Value, false, (int)this.txtContadoCredito.Value, (int)this.txtIdFormaPago.Value, 
						(int)this.cmbBodega.Value, 0, (int)this.cmbVendedor.Value, this.txtNumero.Text.ToString(), "", 
						...
						false, false, bFechaEntrega, bHoraEntrega, false, true, 0, 0, "", 0.00m, 0.00m, 0.00m, 0.00m, 0.00m, false, 0.00m, 0, 0, 0, 0, 0, "", false, 1, "", "", 0, "", 0.00m, 0, "", 0.00m, bNuevo, true, idBloqueaTransacciones, this.ultraGrid1,
		...
		private void btnAnular_Click(object sender, System.EventArgs e)
		{
			...
			if (!Facturacion.ValidaEdicionAnulacion((int)this.txtIdCompra.Value, this.ultraGrid1, miAcceso.Anular, (int)this.txtEstado.Value, 44, (int)this.cmbBodega.Value, 
			...
			if (Facturacion.AnulacionCompraVenta((int)this.txtIdCompra.Value, 44, cdsSeteoF))
				this.Consulta((int)this.txtIdCompra.Value);
		}
		...
		private void txtRuc_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
			...
			{
				string sIdentificacion = FuncionesProcedimientos.AbreListaClientesProveedores(false, 44);
		...
		private void txtRuc_Validating(object sender, System.ComponentModel.CancelEventArgs e)
		{
			if (bEdicion)			
			{
				...
				if (!Validacion.vbClienteExiste(this.txtRuc, false, 44, (int)this.txtIdFormaPago.Value, cdsSeteoF)) 
				{
					e.Cancel = true;
					return;
				}
		...
		private void cmbTipoRuc_ValueChanged(object sender, System.EventArgs e)
		{
			if (this.cmbTipoRuc.ActiveRow != null)
				if ((int)this.cmbTipoRuc.Value == 4) this.txtRuc.MaxLength = 44; else if ((int)this.cmbTipoRuc.Value == 5) this.txtRuc.MaxLength = 10;			
		}
		...
		private void ultraGrid1_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
			if (e.KeyCode == Keys.F3)
			{
				if (this.ultraGrid1.ActiveCell.Column.Key.ToString().ToUpper() == "CODIGO" && bEdicion)
				{
					...
					FuncionesInventario.AbreBusquedaArticulos(this.ultraGrid1, (int)this.cmbBodega.Value, 44, (int)this.txtIdFormaPago.Value, Convert.ToDateTime(this.dtFecha.Value), false);
				}				
			}
		...
		{
			if (bEdicion)
				Facturacion.IniciaValoresColumnas(sender, e, this.ultraGrid1, 44, (int)this.cmbBodega.Value);
		}
		...
		private void ultraGrid1_AfterCellUpdate(object sender, Infragistics.Win.UltraWinGrid.CellEventArgs e)
		{
			if (bEdicion)
			{
				if (bActualiza)
				{
					...
					{
						bActualiza = false;
						FuncionesInventario.FacturacionCargaArticulos(sender, e, this.ultraGrid1, (int)this.txtIdFormaPago.Value, idTipoPrecio, (int)this.cmbBodega.Value, 0, 0, 0, 0, 0, Convert.ToDateTime(this.dtFecha.Value), 44, true, false, false, false, 0, 0, (int)this.txtIdCliente.Value, 0, 0, false, false, 0, cdsSeteoF, false,0, false);
						bActualiza = true;
						this.cmdTotal();						
					} 
					#endregion Codigo
					...
					if (e.Cell.Column.ToString() == "Precio")
					{
						...
						if (!Facturacion.bValidaModificacionPrecios(e, miAcceso.CambiarPrecio, 44, idTipoPrecio, (int)this.txtIdCliente.Value, cdsSeteoF)) 
						{							
							cmdTotal();
							bActualiza = true;
							return;
					...
					if (e.Cell.Column.ToString() == "DescuentoPorc")
					{
						...
						bActualiza = false;
						if (!Facturacion.bValidaDescuentos(e, this.ultraGrid1, (int)this.cmbBodega.Value, bDescuentoActivo, dClavePorcDscto, 44, miAcceso.CambiarDescuento, idTipoPrecio, 0, 0, 0, 0, 0.00m, 0.00m, false, 0, false, cdsSeteoF))
						{							
							cmdTotal();
							bActualiza = true;
							return;
		...
		private void cmbBodega_ValueChanged(object sender, System.EventArgs e)
		{
			if (this.cmbBodega.ActiveRow != null)
			{
				...
				if ((int)this.cmbBodega.Value == 69) idTipoPrecio = 1; else idTipoPrecio = 3;
			}
		}
		...
		private void dtFecha_ValueChanged(object sender, System.EventArgs e)
		{
			if (this.dtFecha.Value != System.DBNull.Value)
				this.cmbBodega.DataSource = Funcion.dvProcedimiento(cdsSeteoF, string.Format("Exec FacturacionListaBodegas {0}, 44, '{1}'", MenuLatinium.IdUsuario, Convert.ToDateTime(this.dtFecha.Value).ToString("yyyyMMdd")));
		}
