...
{
	/// <summary>
	/// Descripción breve de frmIncentivosVentaQuincenal.
	/// </summary>
	public class frmIncentivosVentaQuincenal : System.Windows.Forms.Form
	{
		...
		public frmIncentivosVentaQuincenal()
		{
			//
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idIncentivosVentaQuincenal");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn1 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idIncentivosVentaQuincenal");
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmIncentivosVentaQuincenal));
			...
			this.uGridInformacion.Size = new System.Drawing.Size(464, 160);
			this.uGridInformacion.TabIndex = 1001;
			...
			this.btnSalir.Location = new System.Drawing.Point(96, 176);
			...
			this.Name = "frmIncentivosVentaQuincenal";
			this.Text = "Freelance Venta Quincenal";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmIncentivosVentaQuincenal_KeyDown);
			this.Load += new System.EventHandler(this.frmIncentivosVentaQuincenal_Load);
		...
		private void btnGuardar_Click(object sender, System.EventArgs e)
		{
			...
			using (SqlConnection oConexion = new SqlConnection("Password=Bl45o6$9;Persist Security Info=True;User ID= " + MenuLatinium.stUsuario + ";Initial Catalog=" + MenuLatinium.stDirFacturacion + ";Data Source=" + MenuLatinium.stDirServidor + "; max pool size=1024"))
			{
				...
				try
				{
					...
					foreach(Infragistics.Win.UltraWinGrid.UltraGridRow dr in this.uGridInformacion.Rows.All)
					{
						string  sSQLDet = string.Format("Exec GuardarIncentivosVentaQuincenal {0}, '{1}', '{2}', {3}, {4}, {5}" ,

							Convert.ToInt32 ( dr.Cells["idIncentivosVentaQuincenal"].Value), 
					...
					string sSQLPa = string.Format(" Exec ConsultarIncentivosVentaQuincenal   ");
		...
		{
			e.Row.Cells["idIncentivosVentaQuincenal"].Value = 0;
		...
		private void frmIncentivosVentaQuincenal_Load(object sender, System.EventArgs e)
		{
			miAcceso = new Acceso(cdsSeteoF, "280102");

			if (!Funcion.Permiso("2101", cdsSeteoF))
			{				
		...
		private void frmIncentivosVentaQuincenal_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
