...
{
	/// <summary>
	/// Descripción breve de frmArtPeso.
	/// </summary>
	public class frmArtPeso : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idArtPeso");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn2 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Peso");
			...
			this.txtIdUnidadMedida.Location = new System.Drawing.Point(408, 344);
			...
			this.btCancelar.Location = new System.Drawing.Point(96, 344);
			...
			this.Name = "frmArtPeso";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Peso";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmArtPeso_KeyDown);
			this.Load += new System.EventHandler(this.frmArtPeso_Load);
		...
		private void frmArtPeso_Load(object sender, System.EventArgs e)
		{
			this.ultraGrid1.DataSource = Funcion.dvProcedimiento(cdsSeteoF, string.Format("Select idArtPeso, Peso From ArtPeso Order By Peso"));
		}

		private void ultraGrid1_AfterRowInsert(object sender, Infragistics.Win.UltraWinGrid.RowEventArgs e)
		{
			e.Row.Cells["idArtPeso"].Value = 0;
		}
		...
		private void btAceptar_Click(object sender, System.EventArgs e)
		{
			...
			{
				if ((int)drr.Cells["idArtPeso"].Value == 0 || (int)drr.Cells["idArtPeso"].Value > 0)
				{
					string sSQLDetalle = string.Format("Exec InsertaAtributosArticulos {0}, '{1}', {2}", 
						drr.Cells["idArtPeso"].Value,
						drr.Cells["Peso"].Value.ToString(), 22);     
		...
		private void frmArtPeso_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
