...
{
	/// <summary>
	/// Descripción breve de frmConsultaNomina.
	/// </summary>
	public class frmConsultaNomina : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn3 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Apellidos");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn3 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Apellidos");
			...
			this.uGrid.Size = new System.Drawing.Size(611, 154);
			...
			this.Text = "Consultar";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmConsultaNomina_KeyDown);
		...
		private void Aceptar()
		{
			...
			else if (this.uGrid.ActiveRow.Cells["idNomina"].Value == System.DBNull.Value)
			{
				MessageBox.Show("Seleccione un registro", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Information);				
			}
		...
		private void frmConsultaNomina_Load(object sender, System.EventArgs e)
		{
		
		}

		private void frmConsultaNomina_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
		...
		{
			string sSQL = string.Format("Exec ConsultaNominaGeneral '{0}'", this.txtBuscar.Text.ToString());
