...
namespace Latinium
{
	...
	public class frmReporteMargenUtilidadVentas : DevExpress.XtraEditors.XtraForm
	{
		...
		private Infragistics.Win.UltraWinEditors.UltraOptionSet optDocumentos;
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.optDocumentos = new Infragistics.Win.UltraWinEditors.UltraOptionSet();
			...
			((System.ComponentModel.ISupportInitialize)(this.optDocumentos)).BeginInit();
			this.SuspendLayout();
			// 
			// label7
			// 
			...
			this.optDocumentos.Appearance = appearance33;
			this.optDocumentos.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid;
			this.optDocumentos.CheckedIndex = 0;
			this.optDocumentos.ItemAppearance = appearance34;
			this.optDocumentos.ItemOrigin = new System.Drawing.Point(10, 0);
			valueListItem1.DataValue = 0;
			valueListItem1.DisplayText = "Todos";
			valueListItem2.DataValue = 1;
			valueListItem2.DisplayText = "Facturas";
			valueListItem3.DataValue = 5;
			valueListItem3.DisplayText = "Notas De Crédito";
			this.optDocumentos.Items.Add(valueListItem1);
			this.optDocumentos.Items.Add(valueListItem2);
			this.optDocumentos.Items.Add(valueListItem3);
			this.optDocumentos.ItemSpacingVertical = 10;
			this.optDocumentos.Location = new System.Drawing.Point(448, 16);
			this.optDocumentos.Name = "optDocumentos";
			this.optDocumentos.Size = new System.Drawing.Size(288, 26);
			this.optDocumentos.TabIndex = 1063;
			this.optDocumentos.Text = "Todos";
			// 
			// frmReporteMargenUtilidadVentas
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 14);
			this.ClientSize = new System.Drawing.Size(1148, 464);
			this.Controls.Add(this.optDocumentos);
			...
			((System.ComponentModel.ISupportInitialize)(this.optDocumentos)).EndInit();
		...
		private void frmReporteMargenUtilidadVentas_Load(object sender, System.EventArgs e)
		{
			...
			this.cmbFormaPago.DataSource = Funcion.dvProcedimiento(cdsSeteoF, "Select idFormaPago, FormaPago From CompraFormaPago Where idFormaPago In (1, 3, 9, 11) Order By idFormaPago");
		...
		private void btnVer_Click(object sender, System.EventArgs e)
		{
			...
			string sSQL = string.Format("Exec ReporteMargenUtilidadVentas '{0}', '{1}', {2}, {3}, {4}, '{5}', '{6}', {7}", 
				dtDesde.ToString("yyyyMMdd"), dtHasta.ToString("yyyyMMdd"), bFechas, idFormaPago, idVendedor, this.txtBusqueda.Text.ToString(), sLocales, (int)this.optDocumentos.Value);
