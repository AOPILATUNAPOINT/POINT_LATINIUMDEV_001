...
{
	/// <summary>
	/// Descripción breve de frmDetalleCXPPrpveedor.
	/// </summary>
	public class frmDetalleCXPPrpveedor : System.Windows.Forms.Form
	{
		...
		int iTodos = 0;
		public frmDetalleCXPPrpveedor(DateTime DHasta, string SProveedor ,int IDesde, int IHasta, bool BExportar, int ITodos )
		{
			//
			// Necesario para admitir el Diseñador de Windows Forms
			//
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn4 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("DiasMora");
			...
			Infragistics.Win.UltraWinGrid.SummarySettings summarySettings1 = new Infragistics.Win.UltraWinGrid.SummarySettings("", Infragistics.Win.UltraWinGrid.SummaryType.Sum, null, "Saldo", 4, true, "Band 0", 0, Infragistics.Win.UltraWinGrid.SummaryPosition.UseSummaryPositionColumn, "Saldo", 4, true);
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn4 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("DiasMora");
			...
			ultraGridColumn3.Header.Caption = "Fact No.";
			ultraGridColumn3.Header.VisiblePosition = 2;
			ultraGridColumn3.Width = 100;
			ultraGridColumn4.CellActivation = Infragistics.Win.UltraWinGrid.Activation.ActivateOnly;
			appearance2.TextHAlign = Infragistics.Win.HAlign.Center;
			ultraGridColumn4.CellAppearance = appearance2;
			ultraGridColumn4.Header.Caption = "No. Dias Mora";
			...
			this.ugrValores.DisplayLayout.Override.CardAreaAppearance = appearance5;
			appearance6.ForeColor = System.Drawing.Color.Black;
			appearance6.ForeColorDisabled = System.Drawing.Color.Black;
			this.ugrValores.DisplayLayout.Override.CellAppearance = appearance6;
			...
			this.ugrValores.DisplayLayout.Override.HeaderAppearance = appearance7;
			...
			this.ugrValores.DisplayLayout.Override.RowSelectorAppearance = appearance8;
			appearance9.BackColor = System.Drawing.Color.FromArgb(((System.Byte)(251)), ((System.Byte)(230)), ((System.Byte)(148)));
			appearance9.BackColor2 = System.Drawing.Color.FromArgb(((System.Byte)(238)), ((System.Byte)(149)), ((System.Byte)(21)));
			appearance9.BackGradientStyle = Infragistics.Win.GradientStyle.Vertical;
			this.ugrValores.DisplayLayout.Override.SelectedRowAppearance = appearance9;
			...
			this.ugrValores.Location = new System.Drawing.Point(8, 8);
			this.ugrValores.Name = "ugrValores";
			this.ugrValores.Size = new System.Drawing.Size(552, 296);
			this.ugrValores.TabIndex = 757;
			// 
			// ultraDataSource1
			// 
			...
			this.btnCancelar.Location = new System.Drawing.Point(104, 312);
			this.btnCancelar.Name = "btnCancelar";
			this.btnCancelar.Size = new System.Drawing.Size(88, 23);
			this.btnCancelar.TabIndex = 759;
			...
			this.Name = "frmDetalleCXPPrpveedor";
			this.Text = "frmDetalleCXPPrpveedor";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmDetalleCXPPrpveedor_KeyDown);
			this.Load += new System.EventHandler(this.frmDetalleCXPPrpveedor_Load);
		...
		private void frmDetalleCXPPrpveedor_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
		...
		private void frmDetalleCXPPrpveedor_Load(object sender, System.EventArgs e)
		{
			this.Text = "Proveedor:" + sProveedor + " - Dias:" + iDesde + " - " + iHasta;
			if (bExportar) this.btnAceptar.Visible = true;

			string sSQL = string.Format("Exec [CuentasPorPagarDetallado] '{0}', 4, '{1}', {2}, {3}, {4} ", Convert.ToDateTime(dHasta).ToString("yyyyMMdd"), sProveedor, iDesde, iHasta,  iTodos);
			FuncionesProcedimientos.dsGeneralModulo(sSQL, this.ugrValores);
		}
	}
}
