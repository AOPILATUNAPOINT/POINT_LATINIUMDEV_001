...
{
	/// <summary>
	/// Descripción breve de ProyectoBusca.
	/// </summary>
	public class ProyectoBusca : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.ultraGrid1.DataMember = "Proyecto";
			this.ultraGrid1.DataSource = this.cdsProyecto;
			...
			this.ultraGrid1.Size = new System.Drawing.Size(464, 240);
			...
			this.btAceptar.Location = new System.Drawing.Point(88, 288);
			...
			this.btCancelar.Location = new System.Drawing.Point(344, 288);
			...
			// idBusca
			// 
			this.idBusca.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.cdsProyecto, "Proyecto.idProyecto"));
			this.idBusca.Location = new System.Drawing.Point(232, 280);
			...
			this.Name = "ProyectoBusca";
			this.Text = "Búsqueda de Proyectos";
			this.Load += new System.EventHandler(this.ProyectoBusca_Load);
		...
		private void ProyectoBusca_Load(object sender, System.EventArgs e)
		{
			idBusca.Width = 0;
		}
	}
