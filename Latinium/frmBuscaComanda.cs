...
{
	/// <summary>
	/// Descripción breve de frmBuscaComanda.
	/// </summary>
	public class frmBuscaComanda : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmBuscaComanda));
			...
			this.txtArticulo.Location = new System.Drawing.Point(96, 10);
			this.txtArticulo.Name = "txtArticulo";
			this.txtArticulo.Size = new System.Drawing.Size(272, 21);
			...
			this.btAceptar.Location = new System.Drawing.Point(8, 240);
			this.btAceptar.Name = "btAceptar";
			this.btAceptar.Size = new System.Drawing.Size(72, 23);
			this.btAceptar.TabIndex = 363;
			...
			this.btCancelar.Location = new System.Drawing.Point(88, 240);
			this.btCancelar.Name = "btCancelar";
			this.btCancelar.Size = new System.Drawing.Size(78, 23);
			this.btCancelar.TabIndex = 362;
			...
			this.label14.Text = "Busca Comanda:";
			...
			this.ultraGrid1.Size = new System.Drawing.Size(504, 176);
			this.ultraGrid1.TabIndex = 365;
			// 
			// ultraDataSource1
			// 
			...
			this.lblContador.Location = new System.Drawing.Point(184, 242);
			this.lblContador.Name = "lblContador";
			this.lblContador.Size = new System.Drawing.Size(0, 18);
			this.lblContador.TabIndex = 366;
			...
			this.Name = "frmBuscaComanda";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Busca Comanda";
			this.Load += new System.EventHandler(this.frmBuscaComanda_Load);
		...
		public decimal dPrecio = 0.000000m;		
		public decimal dImpuesto = 0.00m;
		public decimal dDescuentoArt = 0.00m;
		public decimal dDescuentoPorc = 0.00m;
		public decimal dSubtotal = 0.00m;
		...
		{
			string sSQL = string.Format(string.Format("Exec BuscaComanda '{0}'", this.txtArticulo.Text.ToString()));
			FuncionesProcedimientos.dsGeneral(sSQL, this.ultraGrid1);

			this.lblContador.Text = this.ultraGrid1.Rows.Count.ToString() + " ARTICULOS ENCONTRADOS";
		}

		private void frmBuscaComanda_Load(object sender, System.EventArgs e)
		{
		...
		private void Aceptar()
		{
			...
			else
			{
				...
				iCantidad = (int)ultraGrid1.ActiveRow.Cells["Cantidad"].Value;
				dPrecio = (decimal)ultraGrid1.ActiveRow.Cells["Precio"].Value;
				dImpuesto = (decimal)ultraGrid1.ActiveRow.Cells["Impuesto"].Value;
				dDescuentoArt = (decimal)ultraGrid1.ActiveRow.Cells["DescuentoArt"].Value;
				dDescuentoPorc = (decimal)ultraGrid1.ActiveRow.Cells["DescuentoPorc"].Value; 
				dSubtotal = (decimal)ultraGrid1.ActiveRow.Cells["Subtotal"].Value; 
