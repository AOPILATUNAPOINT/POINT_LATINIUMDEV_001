...
{
	/// <summary>
	/// Descripción breve de frmArtMemoriaRAM.
	/// </summary>
	public class frmArtMemoriaRAM : System.Windows.Forms.Form
	{
		...
		public frmArtMemoriaRAM(int IdArtMemoriaRAM)
		{
			idArtMemoriaRAM = IdArtMemoriaRAM;
			//
			// Necesario para admitir el Diseñador de Windows Forms
			//
			InitializeComponent();
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idArtMemoriaRAM");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn2 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("MemoriaRam");
			Infragistics.Win.Appearance appearance2 = new Infragistics.Win.Appearance();
			Infragistics.Win.Appearance appearance3 = new Infragistics.Win.Appearance();
			Infragistics.Win.Appearance appearance4 = new Infragistics.Win.Appearance();
			Infragistics.Win.Appearance appearance5 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn1 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idArtMemoriaRAM");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn2 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("MemoriaRam");
			...
			ultraGridColumn2.Header.Caption = "Memoria RAM";
			...
			this.Name = "frmArtMemoriaRAM";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Memoria RAM";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmArtMemoriaRAM_KeyDown);
			this.Load += new System.EventHandler(this.frmArtMemoriaRAM_Load);
		...
		private void frmArtMemoriaRAM_Load(object sender, System.EventArgs e)
		{
			this.ultraGrid1.DataSource = Funcion.dvProcedimiento(cdsSeteoF, string.Format("Select idArtMemoriaRAM, MemoriaRam From ArtMemoriaRAM Order By MemoriaRam"));
		}
		...
		private void btAceptar_Click(object sender, System.EventArgs e)
		{
			...
			{
				if ((int)drr.Cells["idArtMemoriaRAM"].Value == 0 || (int)drr.Cells["idArtMemoriaRAM"].Value > 0)
				{
					string sSQLDetalle = string.Format("Exec InsertaAtributosArticulos {0}, '{1}', {2}", 
						drr.Cells["idArtMemoriaRAM"].Value,
						drr.Cells["MemoriaRam"].Value.ToString(), 5);     
		...
		{
			e.Row.Cells["idArtMemoriaRAM"].Value = 0;
		}
		...
		private void btCancelar_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
	
		}

		private void frmArtMemoriaRAM_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
