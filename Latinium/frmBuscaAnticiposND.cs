...
{
	/// <summary>
	/// Summary description for frmBuscaAnticiposND.
	/// </summary>
	public class frmBuscaAnticiposND : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.ultraGrid1.Size = new System.Drawing.Size(692, 160);
			...
			// btBuscar
			// 
			this.btBuscar.Location = new System.Drawing.Point(328, 8);
			...
			this.btCancelar.Location = new System.Drawing.Point(112, 208);
			...
			this.btAceptar.Location = new System.Drawing.Point(8, 208);
			...
			this.Name = "frmBuscaAnticiposND";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Buscar";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmBuscaAnticiposND_KeyDown);
		...
		private void frmBuscaAnticiposND_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
		...
		private void Aceptar ()
		{
			...
			if (ultraGrid1.ActiveRow.Cells["idAnticipo"].Value == System.DBNull.Value)
			{
				MessageBox.Show("Seleccione una fila", "Información", MessageBoxButtons.OK, MessageBoxIcon.Information);				
				return;
			}
		...
		{
			string sSQL = string.Format("Exec BuscaAnticiposDevolucion '{0}'", this.txtBusqueda.Text.ToString());
