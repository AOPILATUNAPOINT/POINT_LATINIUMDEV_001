...
{
	/// <summary>
	/// Descripción breve de frmArtGaming.
	/// </summary>
	public class frmArtGaming : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idArtGaming");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn2 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Gaming");
			Infragistics.Win.Appearance appearance2 = new Infragistics.Win.Appearance();
			Infragistics.Win.Appearance appearance3 = new Infragistics.Win.Appearance();
			Infragistics.Win.Appearance appearance4 = new Infragistics.Win.Appearance();
			Infragistics.Win.Appearance appearance5 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn1 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idArtGaming");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn2 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Gaming");
			...
			this.Name = "frmArtGaming";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Gaming";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmArtGaming_KeyDown);
			this.Load += new System.EventHandler(this.frmArtGaming_Load);
		...
		private void frmArtGaming_Load(object sender, System.EventArgs e)
		{
			this.ultraGrid1.DataSource = Funcion.dvProcedimiento(cdsSeteoF, string.Format("Select idArtGaming, Gaming From ArtGaming Order By Gaming"));
		}
		...
		private void btAceptar_Click(object sender, System.EventArgs e)
		{
			...
			{
				if ((int)drr.Cells["idArtGaming"].Value == 0 || (int)drr.Cells["idArtGaming"].Value > 0)
				{
					string sSQLDetalle = string.Format("Exec InsertaAtributosArticulos {0}, '{1}', {2}", 
						drr.Cells["idArtGaming"].Value,
						drr.Cells["Gaming"].Value.ToString(), 8);     
		...
		{
			e.Row.Cells["idArtGaming"].Value = 0;
		}
		...
		private void frmArtGaming_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
