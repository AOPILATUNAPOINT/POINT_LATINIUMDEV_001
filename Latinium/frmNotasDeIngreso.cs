...
namespace Latinium
{
	...
	public class frmNotasDeIngreso : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.chkConsignacion.CheckState = System.Windows.Forms.CheckState.Checked;
		...
		private void ultraGrid1_AfterCellUpdate(object sender, Infragistics.Win.UltraWinGrid.CellEventArgs e)
		{
			if (bEdicion)
			{
				if (bActualiza)
				{
					...
					{
						bActualiza = false;						
						FuncionesInventario.FacturacionCargaArticulos(sender, e, this.ultraGrid1, 0, 0, (int)this.cmbBodega.Value, 0, 0, 0, 0, 0, Convert.ToDateTime(this.dtFecha.Value), 36, false, false, false, false, 0, 0, 0, 0, 0, false, this.chkConsignacion.Checked, 0, cdsSeteoF, false,0, false);
						bActualiza = true;
						this.cmdTotal();
					} 
