...
{
	/// <summary>
	/// Descripción breve de frmConsultaChofer.
	/// </summary>
	public class frmConsultaChofer : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idChoferes");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn4 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Placa");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn5 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("bActivo");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn1 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idChoferes");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn4 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Placa");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn5 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("bActivo");
			...
			this.lblContador.Location = new System.Drawing.Point(368, 24);
			this.lblContador.Name = "lblContador";
			this.lblContador.Size = new System.Drawing.Size(0, 19);
			this.lblContador.TabIndex = 983;
			...
			this.ultraLabel1.Location = new System.Drawing.Point(8, 26);
			...
			this.txtBusqueda.Location = new System.Drawing.Point(64, 23);
			...
			this.uGridCreditos.Size = new System.Drawing.Size(664, 192);
			this.uGridCreditos.TabIndex = 984;
			// 
			// btnAceptar
			// 
			...
			this.Name = "frmConsultaChofer";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Buscar";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmConsultaChofer_KeyDown);
		...
		private void frmConsultaChofer_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
		...
		private void btnBuscar_Click(object sender, System.EventArgs e)
		{
			...
			string sSQL = string.Format("Exec [ConsultaGeneralChoferes] '{0}'",  this.txtBusqueda.Text.ToString ());
		...
		private void Aceptar()
		{
			...
			else if (this.uGridCreditos.ActiveRow.Cells["idChoferes"].Value == System.DBNull.Value)
			{
				MessageBox.Show("Seleccione un documento.", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Information);				
			}
			else 
