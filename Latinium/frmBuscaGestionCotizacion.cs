...
{
	/// <summary>
	/// Summary description for frmBuscaGestionCotizacion.
	/// </summary>
	public class frmBuscaGestionCotizacion : DevExpress.XtraEditors.XtraForm
	{
		...
		public frmBuscaGestionCotizacion()
		{
			//
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idSeguimiento");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn5 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("NumGestion");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn6 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Contacto");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn5 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("NumGestion");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn6 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Contacto");
			...
			ultraGridColumn2.Header.Caption = "N. Cotización";
			...
			ultraGridColumn4.Header.Caption = "Fecha de Contacto";
			...
			this.Name = "frmBuscaGestionCotizacion";
			this.ShowInTaskbar = false;
			this.Text = "Buscar";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmBuscaGestionCotizacion_KeyDown);
			this.Load += new System.EventHandler(this.frmBuscaGestionCotizacion_Load);
		...
		private void frmBuscaGestionCotizacion_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
		...
		{
			string sSQL = string.Format("Exec BuscaGestionCotizacion '{0}'", this.txtBusqueda.Text.ToString());
		...
		private void frmBuscaGestionCotizacion_Load(object sender, System.EventArgs e)
		{
		...
		public void Aceptar()
		{
			...
			if (this.grdPedido.ActiveRow.Cells["idSeguimiento"].Value == System.DBNull.Value) return;
