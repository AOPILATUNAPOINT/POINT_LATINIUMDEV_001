...
{
	/// <summary>
	/// Summary description for frmBuscaDA.
	/// </summary>
	public class frmBuscaDA : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idDevolucionAnticipos");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn12 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idMotivo");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn15 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Concepto");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn1 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idDevolucionAnticipos");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn12 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idMotivo");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn15 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Concepto");
			...
			ultraGridColumn7.Header.Caption = "Local";
			...
			this.ultraGrid1.Size = new System.Drawing.Size(861, 186);
			...
			// btBuscar
			// 
			this.btBuscar.Location = new System.Drawing.Point(336, 8);
			...
			this.btCancelar.Location = new System.Drawing.Point(112, 234);
			...
			this.ClientSize = new System.Drawing.Size(877, 264);
			...
			this.Name = "frmBuscaDA";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Buscar";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmBuscaDA_KeyDown);
		...
		private void frmBuscaDA_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
		...
		private void Aceptar ()
		{
			...
			if (ultraGrid1.ActiveRow.Cells["idDevolucionAnticipos"].Value == System.DBNull.Value)
			{
				MessageBox.Show("Seleccione una fila", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Information);				
				return;
			}
		...
		{			
			string sSQL = string.Format("Exec ConsultaDevolucionAnticipos '{0}'", this.txtBusqueda.Text.ToString());
