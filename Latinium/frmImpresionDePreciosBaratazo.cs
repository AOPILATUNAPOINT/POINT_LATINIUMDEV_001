...
namespace Latinium
{
	...
	public class frmImpresionDePreciosBaratazo : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.rdgPreciador.Size = new System.Drawing.Size(80, 72);
			...
			this.rdgPrecios.Size = new System.Drawing.Size(120, 80);
		...
		private void btnImprimir_Click(object sender, System.EventArgs e)
		{
			...
			foreach(Infragistics.Win.UltraWinGrid.UltraGridRow dr in this.ultraGrid1.Rows.All)
			{
				...
				try
				{
					PrecioPromocion = Convert.ToDecimal(dr.Cells["PrecioPromocion"].Value);
				}
				catch(Exception ex)
				{
					string sms = ex.Message;
		...
		{
			this.ultraGrid1.DisplayLayout.Bands[0].Columns["Sel"].CellActivation = Activation.Disabled;

			if ((int)this.rdgPreciador.EditValue > 0 && (int)this.rdgPrecios.EditValue > 0) this.ultraGrid1.DisplayLayout.Bands[0].Columns["Sel"].CellActivation = Activation.AllowEdit;
