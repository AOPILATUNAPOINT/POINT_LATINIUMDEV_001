...
{
	/// <summary>
	/// Descripción breve de frmObservacionesFlujo.
	/// </summary>
	public class frmObservacionesFlujo : System.Windows.Forms.Form
	{
		...
		public frmObservacionesFlujo(int INumero, string SObservaciones, bool BEdicion)
		{
			//
			// Necesario para admitir el Diseñador de Windows Forms
			//
		...
		private void InitializeComponent()
		{
			...
			this.Name = "frmObservacionesFlujo";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Observaciones Conciliación";
			this.Load += new System.EventHandler(this.frmObservacionesFlujo_Load);
		...
		private void frmObservacionesFlujo_Load(object sender, System.EventArgs e)
		{
			if (iNumero == 1) this.Text = this.Text + " Saldo Cuentas";
			if (iNumero == 2) this.Text = this.Text + " Deposito";
			if (iNumero == 3) this.Text = this.Text + " Notas Credito";
			if (iNumero == 4) this.Text = this.Text + " Notas Debito";
