...
namespace Latinium
{
	...
	/// </summary>
	public class GuiaRemisionFactC : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn11 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Chofer");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn14 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idGuiaRemisionPunto");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn16 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idGuiaRemisionG");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn17 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("fInicioTraslado");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn18 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("fTermTraslado");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn19 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("fEmision");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn20 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("NroGuia");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn21 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("venta");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn22 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("compra");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn23 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("transformacion");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn24 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("consignacion");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn25 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("traslado");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn26 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("devolucion");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn27 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("importacion");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn28 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("exportacion");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn29 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("otros");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn30 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("fEmision2");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn31 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idPuntoPartida", -1, "cmbPartida");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn32 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("rucCliente");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn33 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idPuntoLlegada", -1, "cmbPunto");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn34 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("nombreTrasnp", -1, "cmbPunto", 0, Infragistics.Win.UltraWinGrid.SortIndicator.Ascending, false);
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn35 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("rucTransp");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn36 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("observaciones");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn37 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("diesel");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn38 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("adelanto");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn39 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("contratado");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn40 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idTransportista");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn41 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idCiudadEmision");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn42 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Borrar");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn43 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idCarro1");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn44 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idCarro2");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn45 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idCarro3");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn47 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("NombreCliente");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn48 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("TonelajePedido");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn49 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("CombAutorizado");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn50 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("CombConsumido");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn51 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Celular");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn52 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Placa");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn53 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Facturado");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn54 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Cobrado");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn55 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idCompra");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn56 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idVenta");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn57 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idGuiaRemisionPadre");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn58 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("TextoTonelaje");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn59 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Observacion2");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn60 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idGuiaRemisionPadreC");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn61 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("NombreClienteD");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn62 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("RucClienteD");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn63 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idGuiaRemisionPunto");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn66 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idCliente");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn67 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Nombre");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn68 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Proveedor");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn69 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Ruc");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn70 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Ambos");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn71 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("DesconProv");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn72 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("DesconCliente");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn73 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idCuentaAnticipo");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn74 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idCuentaFondo");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn75 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Chofer");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn76 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idGuiaRemisionPunto");
			...
			this.chkGuia.Size = new System.Drawing.Size(88, 18);
			...
			this.chkFecha.Size = new System.Drawing.Size(88, 18);
			...
			this.chkCliente.Size = new System.Drawing.Size(96, 18);
			...
			this.chkRuta.Size = new System.Drawing.Size(112, 18);
			...
			ultraGridColumn20.Header.Caption = "Guia";
			...
			ultraGridColumn31.Header.Caption = "Partida";
			...
			ultraGridColumn45.Width = 9;
			ultraGridColumn46.Header.VisiblePosition = 33;
			ultraGridColumn46.Hidden = true;
			ultraGridColumn46.Width = 9;
			...
			this.ultraGrid1.Location = new System.Drawing.Point(12, 205);
			this.ultraGrid1.Name = "ultraGrid1";
			this.ultraGrid1.Size = new System.Drawing.Size(702, 163);
			...
			this.cmbPunto.Location = new System.Drawing.Point(376, 276);
			...
			this.cdvGuiaRemisionPadre.TableViewName = "GuiaRemisionPadreC";
			// 
			// barraDato1
			// 
			...
			this.barraDato1.DataNombreId = "idGuiaRemisionPadreC";
			this.barraDato1.DataOrden = "";
			this.barraDato1.DataSource = this.cdsGuiaRemisionPadre;
			this.barraDato1.DataTabla = "GuiaRemisionPadreC";
			...
			this.txtidGuiaRemisionPadre.DataBindings.Add(new System.Windows.Forms.Binding("Value", this.cdsGuiaRemisionPadre, "GuiaRemisionPadreC.idGuiaRemisionPadreC"));
			...
			this.txtidGuiaRemisionPadre.Location = new System.Drawing.Point(47, 153);
			this.txtidGuiaRemisionPadre.Name = "txtidGuiaRemisionPadre";
			this.txtidGuiaRemisionPadre.PromptChar = ' ';
			this.txtidGuiaRemisionPadre.Size = new System.Drawing.Size(56, 22);
			...
			this.txtNumero.Location = new System.Drawing.Point(199, 145);
			...
			this.cmbCliente1.DataBindings.Add(new System.Windows.Forms.Binding("Value", this.cdsGuiaRemisionPadre, "_GuiaRemisionPadreC.idCliente"));
			this.cmbCliente1.DataSource = this.cdvCliente;
			ultraGridColumn65.Header.VisiblePosition = 1;
			ultraGridColumn65.Width = 137;
			ultraGridColumn66.Header.VisiblePosition = 3;
			ultraGridColumn66.Hidden = true;
			ultraGridColumn67.Header.VisiblePosition = 0;
			ultraGridColumn67.Width = 322;
			...
			this.cmbCliente1.Size = new System.Drawing.Size(399, 21);
			...
			this.label18.Location = new System.Drawing.Point(144, 146);
			...
			this.label1.Location = new System.Drawing.Point(393, 144);
			...
			this.dtFecha.Location = new System.Drawing.Point(447, 141);
			this.dtFecha.Name = "dtFecha";
			this.dtFecha.NonAutoSizeHeight = 23;
			this.dtFecha.Size = new System.Drawing.Size(96, 21);
			this.dtFecha.TabIndex = 139;
			this.dtFecha.Value = new System.DateTime(2012, 11, 14, 0, 0, 0, 0);
			// 
			// errorProvider
			// 
			...
			this.cmbPartida.Location = new System.Drawing.Point(233, 257);
			this.cmbPartida.Name = "cmbPartida";
			this.cmbPartida.Size = new System.Drawing.Size(136, 78);
...
//		  this.barraDato1.stFiltroExt  = " And tipo = 2";
		...
		private void btFiltro_Click(object sender, System.EventArgs e)
		{
			...
			//aqui cobrado
			string  stFiltro = " cobrado=0 and borrar=0 and contratado=1 and idGuiaRemisionPadreC is null ";
			...
			C1.Data.FilterCondition fcPadre = new 
				C1.Data.FilterCondition(cdsGuiaRemisionPadre, "GuiaRemisionPadreC", "idGuiaRemisionPadreC = 0");
			C1.Data.FilterConditions fcTotal = new C1.Data.FilterConditions();
			fcTotal.Add(fcPadre);

			C1.Data.FilterCondition fcHija = new 
				C1.Data.FilterCondition(cdsGuiaRemisionPadre , "GuiaRemisionG", stFiltro );
			fcTotal.Add(fcHija);
		...
		{
			using (BuscaGuiaGruas miBusqueda = new BuscaGuiaGruas())
			{
...
//				this.barraDato1.GrabaRegistro(); 
				...
				string stSelect= "Insert into GuiaRemisionPadreC (Tipo,Numero,Fecha,IdCliente) values(2,"
				...
				stSelect="Update GuiaRemisionG set IdGuiaRemisionPadreC = " 
					+ txtidGuiaRemisionPadre.Value.ToString() + " Where Cobrado=1 and IdGuiaRemisionPadreC is null";
				Funcion.EjecutaSQL(cdsGuiaPunto, stSelect, true);	
		...
		private void btnAsiento_Click(object sender, System.EventArgs e)
		{
			...
			string	stExec = "Exec CreaFactura '" + cmbCliente1.Text.Trim().ToString()  + "',''"
				+ ",'" + txtNumero.Value.ToString() +"','" + dtFechaIni.ToString("yyyyMMdd") + "',0,0,0,0,0,4,"
				+ "@CONTADOCREDITO=2,@CREAR = 0 , @Nota='" + minota.ToString() + "'";
	...
	//	this.cmbChofer.Enabled =  !this.chkChofer.Checked;  
		...
		private void barraDato1_Imprimir(object sender, System.EventArgs e)
		{
			...
			Reporte miReporte = new Reporte("GuiaRemisionTotalC.rpt");
