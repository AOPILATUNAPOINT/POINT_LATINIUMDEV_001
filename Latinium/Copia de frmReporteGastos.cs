...
namespace Latinium
{
	...
	public class frmReporteGastos : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn65 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("MAYO");
      ...
      int iPeriodo = Convert.ToInt32( ( Convert.ToDateTime(this.dtDesde2.Value).ToString("yyyy")));
		...
		private void ugridPorcentaje_ClickCellButton_1(object sender, Infragistics.Win.UltraWinGrid.CellEventArgs e)
		{
			...
			frmReporteComparacionGastos prg = new frmReporteComparacionGastos(dtDesde, dtHasta, (int)e.Cell.Row.Cells["idCuentaAgrupa"].Value , dtDesde2, dtHasta2, e.Cell.Row.Cells["Grupo"].Value.ToString(), sPeriodo, true);
			prg.ShowDialog();
