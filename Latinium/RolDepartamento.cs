...
{
	/// <summary>
	/// Descripción breve de RolDepartamento.
	/// </summary>
	public class RolDepartamento : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.ultraGrid1.DataMember = "RolDepartamento";
			this.ultraGrid1.DataSource = this.cdsDepartamento;
			...
			this.ultraGrid1.Size = new System.Drawing.Size(396, 421);
			...
			this.btAceptar.Location = new System.Drawing.Point(8, 429);
			...
			this.btCancelar.Location = new System.Drawing.Point(96, 429);
			...
			this.Name = "RolDepartamento";
			this.Text = "Departamento";
			this.Closing += new System.ComponentModel.CancelEventHandler(this.RolDepartamento_Closing);
			this.Load += new System.EventHandler(this.RolDepartamento_Load);
		...
		private void RolDepartamento_Load(object sender, System.EventArgs e)
		{
			if (!Funcion.Permiso("81",cdsDepartamento))
			{
				MessageBox.Show("No puede ingresar a departamentos", "Informacion");
				BeginInvoke(new MethodInvoker(UnloadMe));
				return;
			}

			string stAudita = "Exec AuditaCrear 53, 6, 'Rol Depart.'";
		...
		private void cdsDepartamento_BeforeFill(object sender, C1.Data.FillEventArgs e)
		{
			...
			this.cdsDepartamento.Schema.Connections[0].ConnectionString = 
				miFuncion.AccesoBase(MenuLatinium.stDirRoles);
		}

		private void RolDepartamento_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			string stAudita = "Exec AuditaCrear 53, 7, 'Rol Depart.'";
			Funcion.EjecutaSQL(cdsDepartamento, stAudita, true);
		}
