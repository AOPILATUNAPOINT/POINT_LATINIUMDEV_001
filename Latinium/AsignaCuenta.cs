...
{
	/// <summary>
	/// Descripción breve de AsignaCuenta.
	/// </summary>
	public class AsignaCuenta : System.Windows.Forms.Form
	{
		private C1.Data.C1DataSet cdsAsignaCuenta;
		private C1.Data.C1DataView cdvAsignaCuenta;
		...
		private Infragistics.Win.UltraWinGrid.UltraDropDown cmbDesc;
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridBand ultraGridBand1 = new Infragistics.Win.UltraWinGrid.UltraGridBand("AsignaCuenta", -1);
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idAsignacion");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn2 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Asignacion");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn3 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idCuenta", -1, "cmbDesc");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn5 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idCuentaCod", 0, "cmbCodigo");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn7 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("CodRapido");
			...
			this.cdvAsignaCuenta = new C1.Data.C1DataView();
			...
			this.cmbDesc = new Infragistics.Win.UltraWinGrid.UltraDropDown();
			...
			((System.ComponentModel.ISupportInitialize)(this.cdvAsignaCuenta)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.cmbDesc)).BeginInit();
			...
			// cdvAsignaCuenta
			// 
			this.cdvAsignaCuenta.BindingContextCtrl = this;
			this.cdvAsignaCuenta.DataSet = this.cdsAsignaCuenta;
			this.cdvAsignaCuenta.TableName = "";
			this.cdvAsignaCuenta.TableViewName = "AsignaCuenta";
			// 
			// cdsCuenta
			// 
			...
			this.btAceptar.Location = new System.Drawing.Point(80, 264);
			...
			this.btCancelar.Location = new System.Drawing.Point(328, 264);
			...
			this.ultraGrid1.DataMember = "AsignaCuenta";
			this.ultraGrid1.DataSource = this.cdsAsignaCuenta;
			...
			this.ultraGrid1.Size = new System.Drawing.Size(496, 240);
			...
			// cmbDesc
			// 
			this.cmbDesc.Cursor = System.Windows.Forms.Cursors.Default;
			this.cmbDesc.DataSource = this.cdvCuentaCod;
			...
			ultraGridBand2.Columns.AddRange(new object[] {
																										 ...
																										 ultraGridColumn9,
																										 ultraGridColumn10});
			this.cmbDesc.DisplayLayout.BandsSerializer.Add(ultraGridBand2);
			this.cmbDesc.DisplayMember = "Descripcion";
			this.cmbDesc.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.cmbDesc.Location = new System.Drawing.Point(32, 80);
			this.cmbDesc.Name = "cmbDesc";
			this.cmbDesc.Size = new System.Drawing.Size(416, 80);
			this.cmbDesc.TabIndex = 6;
			this.cmbDesc.ValueMember = "idCuenta";
			this.cmbDesc.Visible = false;
			this.cmbDesc.MouseDown += new System.Windows.Forms.MouseEventHandler(this.cmbDesc_MouseDown);
			// 
			// cmbCodigo
			// 
			this.cmbCodigo.Cursor = System.Windows.Forms.Cursors.Default;
			this.cmbCodigo.DataSource = this.cdvCuenta;
			...
			this.cmbCodigo.Location = new System.Drawing.Point(120, 168);
			this.cmbCodigo.Name = "cmbCodigo";
			this.cmbCodigo.Size = new System.Drawing.Size(384, 80);
			this.cmbCodigo.TabIndex = 7;
			this.cmbCodigo.ValueMember = "idCuenta";
			...
			this.btNoAsignar.Location = new System.Drawing.Point(176, 264);
			...
			this.Name = "AsignaCuenta";
			this.Text = "Asignación de Cuentas";
			this.Closing += new System.ComponentModel.CancelEventHandler(this.AsignaCuenta_Closing);
			this.Load += new System.EventHandler(this.AsignaCuenta_Load);
			((System.ComponentModel.ISupportInitialize)(this.cdsAsignaCuenta)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.cdvAsignaCuenta)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.cmbDesc)).EndInit();
		...
		private void cmbDesc_MouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
		{
			this.cmbDesc.Text = "";
		}
		...
		private void AsignaCuenta_Load(object sender, System.EventArgs e)
		{
			Cursor = Cursors.Default;
			string stAudita = "Exec AuditaCrear 53, 6, 'Asigna Cuenta'";
			Funcion.EjecutaSQL(cdsAsignaCuenta, stAudita, true);
		}

		private void AsignaCuenta_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			string stAudita = "Exec AuditaCrear 53, 7, 'Asigna Cuenta'";
			Funcion.EjecutaSQL(cdsAsignaCuenta, stAudita, true);
		}
