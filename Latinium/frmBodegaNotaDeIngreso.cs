...
namespace Latinium
{
	...
	/// </summary>
	public class frmBodegaNotaDeIngreso : DevExpress.XtraEditors.XtraForm
	{
		...
		public frmBodegaNotaDeIngreso(int IdCompraV)
		{
			//
			// Required for Windows Form Designer support
			//
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmBodegaNotaDeIngreso));
			...
			this.Name = "frmBodegaNotaDeIngreso";
			this.Text = "Nota De Ingreso Consignación";
		...
		private void btnGuardar_Click(object sender, System.EventArgs e)
		{
			...
			if (!Validacion.bValidaExistencias(this.ultraGrid1, (DateTime)this.dtFecha.Value, (int)this.txtIdCompra.Value, (int)this.cmbBodega.Value, 36, 0, cdsSeteoF)) return;
		...
		private void ultraGrid1_AfterCellUpdate(object sender, Infragistics.Win.UltraWinGrid.CellEventArgs e)
		{
			...
			{				
				...
				{
					bActualiza = false;
					FuncionesInventario.FacturacionCargaArticulos(sender, e, this.ultraGrid1, 0, 0, (int)this.cmbBodega.Value, 0, 0, 0, 0, 0, Convert.ToDateTime(this.dtFecha.Value), 8, false, false, false, false, 0, 0, 0, 0, 0, false, false, 0, cdsSeteoF, false,0, false);
					bActualiza = true;
					this.cmdTotal();
				}				
				#endregion Codigo
