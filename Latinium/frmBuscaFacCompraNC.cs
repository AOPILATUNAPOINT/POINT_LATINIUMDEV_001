...
{
	/// <summary>
	/// Summary description for frmBuscaFacCompraNC.
	/// </summary>
	public class frmBuscaFacCompraNC : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn3 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("ContadoCredito");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn11 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Descuento0");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn12 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("SubtotalIva");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn16 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idProyectoZoom");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn3 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("ContadoCredito");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn11 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Descuento0");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn12 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("SubtotalIva");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn13 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Descuento");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn16 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idProyectoZoom");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn17 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Proyecto");
			...
			this.btnAceptar.Location = new System.Drawing.Point(7, 322);
			...
			this.btnCancelar.Location = new System.Drawing.Point(87, 322);
			...
			this.btnBuscar.Location = new System.Drawing.Point(391, 8);
			...
			this.txtBusqueda.Location = new System.Drawing.Point(63, 8);
			this.txtBusqueda.Name = "txtBusqueda";
			this.txtBusqueda.Size = new System.Drawing.Size(312, 22);
			this.txtBusqueda.TabIndex = 264;
			...
			this.grdFacturas.Location = new System.Drawing.Point(7, 48);
			this.grdFacturas.Name = "grdFacturas";
			this.grdFacturas.Size = new System.Drawing.Size(721, 258);
			this.grdFacturas.TabIndex = 263;
			...
			this.Name = "frmBuscaFacCompraNC";
			this.ShowInTaskbar = false;
			this.Text = "Buscar Facturas";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmBuscaFacCompraNC_KeyDown);
			this.Load += new System.EventHandler(this.frmBuscaFacCompraNC_Load);
		...
		private void frmBuscaFacCompraNC_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
			if (e.KeyCode == Keys.Escape) this.DialogResult = DialogResult.No;
		}

		private void frmBuscaFacCompraNC_Load(object sender, System.EventArgs e)
		{
		...
		{
			string sSQL = string.Format("Exec ConsultaFacturaCompraNC '{0}'", this.txtBusqueda.Text.ToString());
			this.grdFacturas.DataSource = Funcion.dvProcedimiento(cdsSeteoF, sSQL);

			if (this.grdFacturas.Rows.Count > 0) this.grdFacturas.Select();
		}
