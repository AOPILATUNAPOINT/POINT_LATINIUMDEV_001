	...
	public class ChequeTCLot : DevExpress.XtraEditors.XtraForm
	{
		...
		private void ChequeTCLot_Load(object sender, System.EventArgs e)
		{
			...
			else if (IFormaDePago == 45)
			{
				...
				// Muestra y habilita el número de transacción
				this.txtnumeroTRX.Visible = true;
				this.txtnumeroTRX.Enabled = true;

				// Si ya viene un número guardado, lo carga
		...
		{	
			...
			if (IFormaDePago == 45)
			{
				...
				{
					MessageBox.Show("Ingrese el ´Número de TRX", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop);
					this.txtLote.Focus();
					return;
				}
			}
