...
{
	/// <summary>
	/// Descripción breve de frmReporteCobrosPorestados.
	/// </summary>
	public class frmReporteCobrosPorestados : System.Windows.Forms.Form
	{
		...
		public frmReporteCobrosPorestados()
		{
			//
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmReporteCobrosPorestados));
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn6 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Secuencial");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn7 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Fecha_Abono");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn8 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Fecha_Cruce");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn9 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Fecha_Vence");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn11 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Tipo");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn6 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Secuencial");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn7 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Fecha_Abono");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn8 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Fecha_Cruce");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn9 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Fecha_Vence");
			...
			this.label53.Location = new System.Drawing.Point(176, 10);
			...
			this.btnExcel.Location = new System.Drawing.Point(1096, 8);
			...
			this.btnVer.Location = new System.Drawing.Point(352, 40);
			this.btnVer.Name = "btnVer";
			this.btnVer.Size = new System.Drawing.Size(75, 24);
			this.btnVer.TabIndex = 375;
			...
			ultraGridColumn7.Header.Caption = "Fecha Abono";
			ultraGridColumn7.Header.VisiblePosition = 6;
			ultraGridColumn8.CellActivation = Infragistics.Win.UltraWinGrid.Activation.ActivateOnly;
			ultraGridColumn8.Header.Caption = "Fecha Cruce";
			ultraGridColumn8.Header.VisiblePosition = 7;
			ultraGridColumn9.CellActivation = Infragistics.Win.UltraWinGrid.Activation.ActivateOnly;
			ultraGridColumn9.Header.Caption = "Fecha Vence";
			ultraGridColumn9.Header.VisiblePosition = 8;
			ultraGridColumn10.CellActivation = Infragistics.Win.UltraWinGrid.Activation.ActivateOnly;
			appearance4.TextHAlign = Infragistics.Win.HAlign.Right;
			ultraGridColumn10.CellAppearance = appearance4;
			ultraGridColumn10.Format = "#,##0.00";
			ultraGridColumn10.Header.Caption = "Abono";
			...
			this.uGridInformacion.Size = new System.Drawing.Size(1160, 280);
			this.uGridInformacion.TabIndex = 379;
			// 
			// optReporte
			// 
			appearance10.ForeColorDisabled = System.Drawing.Color.Black;
			this.optReporte.Appearance = appearance10;
			this.optReporte.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid;
			this.optReporte.CheckedIndex = 0;
			this.optReporte.ItemAppearance = appearance11;
			this.optReporte.ItemOrigin = new System.Drawing.Point(12, 0);
			valueListItem1.DataValue = 0;
			valueListItem1.DisplayText = "Todos";
			valueListItem2.DataValue = 1;
			valueListItem2.DisplayText = "Al Día";
			valueListItem3.DataValue = 2;
			valueListItem3.DisplayText = "Atrasado";
			valueListItem4.DataValue = 3;
			valueListItem4.DisplayText = "Adelantado";
			...
			this.optReporte.Location = new System.Drawing.Point(32, 40);
			this.optReporte.Name = "optReporte";
			this.optReporte.Size = new System.Drawing.Size(304, 24);
			this.optReporte.TabIndex = 397;
			...
			this.lblContador.Location = new System.Drawing.Point(448, 44);
			this.lblContador.Name = "lblContador";
			this.lblContador.Size = new System.Drawing.Size(0, 17);
			this.lblContador.TabIndex = 398;
			...
			this.groupBox1.Size = new System.Drawing.Size(1655, 8);
			...
			this.Name = "frmReporteCobrosPorestados";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Tipos De Cobros";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmReporteCobrosPorestados_KeyDown);
			this.Load += new System.EventHandler(this.frmReporteCobrosPorestados_Load);
		...
		private void frmReporteCobrosPorestados_Load(object sender, System.EventArgs e)
		{
			miAcceso = new Acceso(cdsSeteoF, "200614");

			if (!Funcion.Permiso("1488", cdsSeteoF))
			{				
				MessageBox.Show("No puede ingresar a Estado de Cobros", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop);
		...
		private void btnVer_Click(object sender, System.EventArgs e)
		{
			...
			if (Convert.ToDateTime(this.dtDesde.Value) > Convert.ToDateTime(this.dtHasta.Value))
			{
				...
				string sSQL = string.Format("Exec [ReporteCobrosPorestados] '{0}', '{1}', {2}", 
					Convert.ToDateTime(this.dtDesde.Value).ToString("yyyyMMdd"), Convert.ToDateTime(this.dtHasta.Value).ToString("yyyyMMdd"),  (int) this.optReporte.Value);
				FuncionesProcedimientos.dsGeneralModulo(sSQL, this.uGridInformacion);

						this.lblContador.Text = this.uGridInformacion.Rows.Count + " Registros encontrados";
		}

		private void frmReporteCobrosPorestados_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
