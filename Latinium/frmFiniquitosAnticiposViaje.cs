...
namespace Latinium
{
	...
	public class frmFiniquitosAnticiposViaje : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.ultraGrid1.Size = new System.Drawing.Size(842, 304);
			...
			this.cmbFechaEntrega.Location = new System.Drawing.Point(136, 104);
			...
			this.txtValor.Location = new System.Drawing.Point(376, 104);
			...
			this.cmbNombre.Location = new System.Drawing.Point(137, 41);
			...
			this.cmbTipo.Size = new System.Drawing.Size(263, 21);
			...
			this.btnNuevo.Location = new System.Drawing.Point(8, 546);
			...
			this.btnConsultar.Location = new System.Drawing.Point(84, 546);
			...
			this.btnEditar.Location = new System.Drawing.Point(166, 546);
			...
			this.btnGuardar.Location = new System.Drawing.Point(246, 546);
			...
			this.btnAnular.Location = new System.Drawing.Point(326, 546);
			...
			this.btnCancelar.Location = new System.Drawing.Point(482, 546);
			...
			this.btnSalir.Location = new System.Drawing.Point(558, 546);
			...
			this.txtIdAsiento.Location = new System.Drawing.Point(816, 546);
			...
			this.txtIdRolPrestamo.Location = new System.Drawing.Point(800, 546);
			...
			this.txtEstado.Location = new System.Drawing.Point(832, 546);
			...
			this.btnConsignacion.Location = new System.Drawing.Point(406, 546);
			...
			this.txtCedula.Location = new System.Drawing.Point(712, 40);
			this.txtCedula.Name = "txtCedula";
			this.txtCedula.Size = new System.Drawing.Size(96, 22);
			this.txtCedula.TabIndex = 269;
			this.txtCedula.ValueChanged += new System.EventHandler(this.ultraTextEditor1_ValueChanged);
			// 
			// lblBodega
			// 
			this.lblBodega.AutoSize = true;
			this.lblBodega.BackColor = System.Drawing.Color.Transparent;
			this.lblBodega.Location = new System.Drawing.Point(48, 72);
			this.lblBodega.Name = "lblBodega";
			this.lblBodega.Size = new System.Drawing.Size(89, 16);
			this.lblBodega.TabIndex = 1070;
			...
			this.cmbBodega.Location = new System.Drawing.Point(136, 72);
			this.cmbBodega.MaxDropDownItems = 30;
			this.cmbBodega.Name = "cmbBodega";
			this.cmbBodega.Size = new System.Drawing.Size(336, 21);
			this.cmbBodega.TabIndex = 1071;
...
//			this.cmbFechaEntrega.CalendarInfo.MinDate = DateTime.Today.AddDays(-45);
		...
		private void CargarConexionEmpresas()
		{
			...
			// Recrear el servicio con la nueva conexión
		...
		private void CargarCentroCosto()
		{
			try
			{
				if (cmbNombre.ActiveRow == null)
				{
					cmbBodega.Value = null;
					cmbBodega.Text = "";
				...
				int idPersonal = Convert.ToInt32(cmbNombre.Value);

				//  Llenar bodegas del empleado
				CargarBodegasDelEmpleado(idPersonal);
			}
			catch
			{
				cmbBodega.Visible = false;
		...
		private void cmbNombre_ValueChanged(object sender, System.EventArgs e)
		{
			...
			// Cambiar conexión según empresa
			CargarConexionEmpresas();

			// Solo consultar cédula si bCedula es true
			ConsultarCedula(idPersonal);

			// Cargar combo de bodegas siempre
			CargarBodegasDelEmpleado(idPersonal);
		}

		private void ConsultarCedula(int idPersonal)
		{
			if (!bCedula)
				return;

			string sSQL = "SELECT TOP 1 nIdentificacion FROM Nomina WHERE idPersonal = " + idPersonal;
			string cedula = Funcion.sEscalarSQL(cdsSeteoF, sSQL);
			txtCedula.Text = (cedula != null) ? cedula : "";
		}

		private void CargarBodegasDelEmpleado(int idPersonal)
		{
			try
			{
				if (_requerimientoService == null)
				{
					cmbBodega.Visible = false;
					lblBodega.Visible = false;
					cmbBodega.DataSource = null;
				...
				// Llenar combo con centros de costo activos
				System.Collections.ArrayList data = _requerimientoService.ObtenerCentrosCostoTodos();
				...
				// Obtener proyecto directo desde Nomina
				int idProyecto = _requerimientoService.ObtenerProyectoNominaPorPersonal(idPersonal);

				cmbBodega.Value = (idProyecto > 0) ? idProyecto : (object)null;
		...
		private void Consulta (int idRolPrestamo)
		{
			try
			{
				...
				if (drFiniquitos.HasRows)
				{
					...
					this.txtCedula.Text = drFiniquitos.GetValue(14).ToString();
				}
				drFiniquitos.Close();
				...
				if (this.cmbNombre.Value == null || this.cmbNombre.Value == DBNull.Value)
				{
					MessageBox.Show("No se encontró información para el empleado seleccionado. Intente con otro empleado.",
						"Advertencia",
				...
				{
					idEmpleado = Convert.ToInt32(this.cmbNombre.Value);
				}

				this.cmbNombre.DataSource = Funcion.dvProcedimiento(
					cdsSeteoF,
					string.Format("Exec ListaEmpleadosAnticiposPrestamos '20301231', 9, 0, {0}", idEmpleado)
					);
		...
		private void btnGuardar_Click(object sender, System.EventArgs e)
		{
			...
			if (!Validacion.vbCampoDecimalVacio(this.txtValor, "Ingrese el valor", 1.00m, 100000.00m)) return;	
