...
namespace Latinium
{
	...
	public class frmReposicionCarteraSolidario : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn15 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("NumOperacion");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn15 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("NumOperacion");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn16 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idFormaPago");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn17 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("FormaPago");
			...
			this.txtBuscador.ValueChanged += new System.EventHandler(this.txtBuscador_ValueChanged);
			// 
			// ultraGrid1
			// 
			...
			ultraGridColumn15.Header.Caption = "N° Operación";
		...
		private void frmReposicionCarteraSolidario_Load(object sender, System.EventArgs e)
		{
			...
			else
			{
				...
				this.cmbFormaPago.DataSource = Funcion.dvProcedimiento(cdsSeteoF, "Select idFormaPago, FormaPago From CompraFormaPago Where idFormaPago In (2, 7)");	
			...
			try
			{
				...
				if ((int)this.txtEstado.Value != 3)
				{
					...
					if (miAcceso.Editar)
					{
						...
						if ((int)this.cmbFormaPago.Value == 7) this.btnEditar.Enabled = true;
					}
		...
		private void Guardar ()
		{
			...
			string sSQL = string.Format("Exec GuardaRolPrestamo {0}, 8, '{1}', {2}, {3}, '{4}', {5}, {6}, {7}, '{8}', {9}", 
				(int)this.txtIdRolPrestamo.Value, this.txtNumero.Text.ToString(), (int)this.cmbFormaPago.Value, 192719, dtFecha.ToString("yyyyMMdd"), 
		...
		private void btnGuardar_Click(object sender, System.EventArgs e)
		{
			...
			if (DialogResult.Yes == MessageBox.Show(string.Format("¿Esta seguro de Crear esta Reposición de {1} clientes,\n\nCon la suma de {0}\n\nCon Forma de Pago '{2}'?", Convert.ToDecimal(this.txtTotal.Value), iCont, this.cmbFormaPago.Text.ToString()), "Point Technology", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2))
			{
				...
				string sSQLAP = string.Format("Exec CreaAutorizacionesDePago 8, {0}, '{1}', '{2}', {3}, {4}, '1 DE 1', 'CRUCE ANTICIPOS', 0", 
					(int)this.txtIdRolPrestamo.Value, DateTime.Today.ToString("yyyyMMdd"), DateTime.Today.ToString("yyyyMMdd"), Convert.ToDecimal(this.txtTotal.Value), (int)this.cmbFormaPago.Value);
		...
		private void ultraGrid1_CellChange(object sender, Infragistics.Win.UltraWinGrid.CellEventArgs e)
		{
			...
			if (e.Cell.Column.ToString() == "Sel")
			{
				...
				if (e.Cell.Row.Cells["NumOperacion"].Value.ToString().Length == 0)
				{
					bActualiza = true;											
					e.Cell.Row.Cells["Sel"].Value = (bool)e.Cell.OriginalValue;	
					
					MessageBox.Show("Ingrese el N° de Operación", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop);
				...
				string sSQLCruce = string.Format("Exec GCruceAnticipos {0}, {1}, {2}, {3}, {4}, {5}, '{6}'", 
					...
					(bool)e.Cell.Row.Cells["AnticipoNC"].Value, Convert.ToString(e.Cell.Row.Cells["NumOperacion"].Value));
		...
		{
			if (ultraGrid1.ActiveCell.Column.Key.ToString().ToUpper() == "NUMOPERACION" )
			{
				Funcion.CamposNumericos(sender, e);
			}
		}

		private void txtBuscador_ValueChanged(object sender, System.EventArgs e)
		{
