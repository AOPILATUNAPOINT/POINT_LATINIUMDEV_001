...
namespace Latinium
{
	...
	public class frmLiquidaDepositosPendientes : System.Windows.Forms.Form
	{
		...
		public frmLiquidaDepositosPendientes( string SCedula ,  int ITipo)
		{
			//
			// Necesario para admitir el Diseñador de Windows Forms
			//
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn9 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idEntidadFinanciera");
		...
		private void txtRuc_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
			...
			FuncionesProcedimientos.dsGeneralModulo(sSQL, this.GridFacturas);
		...
		private void frmLiquidaDepositosPendientes_Load(object sender, System.EventArgs e)
		{
			if(iTipo ==1 )
				...
				if (sCedula.Length > 0)
				{						
					this.txtRuc.Text = sCedula;
					CargaCliente();		
					string sSQL = string.Format("Exec ConsultaCruzADepositosPorLiquidar '{0}'", sCedula);
