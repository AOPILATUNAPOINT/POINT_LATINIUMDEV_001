...
{
	/// <summary>
	/// Summary description for frmColoresProductos.
	/// </summary>
	public class frmColoresProductos : DevExpress.XtraEditors.XtraForm
	{
		...
		public frmColoresProductos(int idArticulo, int bodega)
		{
			//
		...
		private void InitializeComponent()
		{
			...
			this.btnAceptar.Location = new System.Drawing.Point(8, 202);
			this.btnAceptar.Name = "btnAceptar";
			this.btnAceptar.Size = new System.Drawing.Size(76, 23);
			this.btnAceptar.TabIndex = 310;
			...
			this.btnCancelar.Location = new System.Drawing.Point(88, 202);
			...
			this.ultraGrid1.Size = new System.Drawing.Size(591, 200);
			this.ultraGrid1.TabIndex = 309;
			...
			this.Name = "frmColoresProductos";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Seleccione un Producto";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmColoresProductos_KeyDown);
			this.Load += new System.EventHandler(this.frmColoresProductos_Load);
		...
		private void frmColoresProductos_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
		...
		private void Aceptar()
		{
			...
			if (this.ultraGrid1.ActiveRow.Cells["idArticulo"].Value == null) return;
		...
		private void frmColoresProductos_Load(object sender, System.EventArgs e)
		{
			string sSQL = string.Format("Exec ListaArticulosPromocionPorColor {0}, {1}", IdArticulo, Bodega);
