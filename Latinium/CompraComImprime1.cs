...
namespace Latinium
{
	...
	/// </summary>
	public class CompraComImprime : System.Windows.Forms.Form
	{
...
private int idC=0;
		...
		private void InitializeComponent()
		{
			...
			// btAceptar
			// 
			this.btAceptar.Location = new System.Drawing.Point(48, 176);
			...
			// btCancelar
			// 
			this.btCancelar.Location = new System.Drawing.Point(160, 176);
		...
		private void btAceptar_Click(object sender, System.EventArgs e)
		{
			...
			if (Funcion.bEjecutaSQL(cdsPersonal, "Exec SeteoGExiste 'FVCLEXIM'")) 				
			{
				...
				//MessageBox.Show("Datos Modificados", "Informacion");
