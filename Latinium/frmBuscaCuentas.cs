...
{
	/// <summary>
	/// Summary description for frmBuscaCuentas.
	/// </summary>
	public class frmBuscaCuentas : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn2 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("CodRapido");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn2 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("CodRapido");
			...
			this.ultraGrid1.Size = new System.Drawing.Size(544, 220);
			...
			// btBuscar
			// 
			this.btBuscar.Location = new System.Drawing.Point(456, 8);
			...
			this.txtArticulo.Location = new System.Drawing.Point(56, 8);
			...
			this.Name = "frmBuscaCuentas";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Plan de cuentas";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmBuscaCuentas_KeyDown);
			this.Load += new System.EventHandler(this.frmBuscaCuentas_Load);
		...
		{
			string sSQL = string.Format("Exec BuscaPlanDeCuentas '{0}'", this.txtArticulo.Text.ToString().Trim());
		...
		private void frmBuscaCuentas_Load(object sender, System.EventArgs e)
		{
		...
		private void btAceptar_Click(object sender, System.EventArgs e)
		{
			...
			Cuenta = this.ultraGrid1.ActiveRow.Cells["CodRapido"].Value.ToString();
			idCuenta = (int)this.ultraGrid1.ActiveRow.Cells["idCuenta"].Value;
		...
		private void ultraGrid1_KeyPress(object sender, System.Windows.Forms.KeyPressEventArgs e)
		{
			if (e.KeyChar == 13)
			{
				...
				Cuenta = ultraGrid1.ActiveRow.Cells["CodRapido"].Value.ToString();
				idCuenta = (int)this.ultraGrid1.ActiveRow.Cells["idCuenta"].Value;
		...
		private void frmBuscaCuentas_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
