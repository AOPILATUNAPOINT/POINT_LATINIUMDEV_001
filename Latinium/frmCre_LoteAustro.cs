...
{
	/// <summary>
	/// Descripción breve de frmCre_LoteAustro.
	/// </summary>
	public class frmCre_LoteAustro : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmCre_LoteAustro));
			...
			this.txtLote.Size = new System.Drawing.Size(72, 22);
			...
			this.dtpFecha.Appearance = appearance7;
			...
			this.uGridOperaciones.DisplayLayout.Appearance = appearance8;
			...
			this.Name = "frmCre_LoteAustro";
			this.Text = "Generación";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmCre_LoteAustro_KeyDown);
			this.Load += new System.EventHandler(this.frmCre_LoteAustro_Load);
		...
		private void frmCre_LoteAustro_Load(object sender, System.EventArgs e)
		{
			...
			this.txtUltimoLote.Value = Funcion.iEscalarSQL(cdsSeteoF, "Exec Cre_RetornaUltimoLote 15");		
		...
		{
			string sSQL = string.Format("Exec Cre_LotesAustro '{0}', {1}, '{2}', {3}, {4}", 
		...
		private void uGridOperaciones_CellChange(object sender, Infragistics.Win.UltraWinGrid.CellEventArgs e)
		{
			if (e.Cell.Column.ToString() == "CapturaLote")
			{
				...
				string sSQL = string.Format("Exec Cre_LoteBancoPichincha {0}, {1}, {2}, {3}, {4}, 15, ''", 
		...
		private void frmCre_LoteAustro_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
