...
namespace Latinium
{
	...
	public class frmGeneraCruceCxCCrediPoint : DevExpress.XtraEditors.XtraForm
	{
		...
		public Infragistics.Win.UltraWinEditors.UltraNumericEditor txtSOLCA;
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn12 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("ContribucionSolca");
			Infragistics.Win.Appearance appearance6 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn13 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("ACreditado");
			...
			Infragistics.Win.UltraWinGrid.SummarySettings summarySettings4 = new Infragistics.Win.UltraWinGrid.SummarySettings("", Infragistics.Win.UltraWinGrid.SummaryType.Sum, null, "ContribucionSolca", 11, true, "Band 0", 0, Infragistics.Win.UltraWinGrid.SummaryPosition.UseSummaryPositionColumn, "ContribucionSolca", 11, true);
			Infragistics.Win.Appearance appearance11 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinGrid.SummarySettings summarySettings5 = new Infragistics.Win.UltraWinGrid.SummarySettings("", Infragistics.Win.UltraWinGrid.SummaryType.Sum, null, "ACreditado", 12, true, "Band 0", 0, Infragistics.Win.UltraWinGrid.SummaryPosition.UseSummaryPositionColumn, "ACreditado", 12, true);
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn12 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("ContribucionSolca");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn13 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("ACreditado");
			...
			this.txtSOLCA = new Infragistics.Win.UltraWinEditors.UltraNumericEditor();
			...
			((System.ComponentModel.ISupportInitialize)(this.txtSOLCA)).BeginInit();
			this.SuspendLayout();
			// 
			// txtLote
			// 
			...
			ultraGridColumn12.Header.Caption = "Contr. SOLCA";
			...
			this.uGridLotes.DisplayLayout.Override.AllowAddNew = Infragistics.Win.UltraWinGrid.AllowAddNew.No;
			this.uGridLotes.DisplayLayout.Override.AllowDelete = Infragistics.Win.DefaultableBoolean.False;
			this.uGridLotes.DisplayLayout.Override.AllowUpdate = Infragistics.Win.DefaultableBoolean.False;
			...
			this.uGridLotes.Size = new System.Drawing.Size(1117, 440);
			...
			this.btnContabilizar.Location = new System.Drawing.Point(1027, 50);
			...
			this.groupBox1.Size = new System.Drawing.Size(1133, 8);
			...
			this.btnParametros.Location = new System.Drawing.Point(1027, 8);
			...
			this.txtLiquidado.Appearance = appearance21;
			...
			this.txtLiquidado.Location = new System.Drawing.Point(709, 504);
			...
			this.txtComision.Appearance = appearance22;
			...
			this.txtComision.Location = new System.Drawing.Point(813, 504);
			...
			this.txtAcreditado.Appearance = appearance23;
			...
			this.txtAcreditado.Location = new System.Drawing.Point(1021, 504);
			...
			appearance24.ForeColorDisabled = System.Drawing.Color.Blue;
			this.txtFondoGarantia.Appearance = appearance24;
			...
			this.txtFondoGarantia.Location = new System.Drawing.Point(917, 504);
			...
			this.btExcel.Location = new System.Drawing.Point(939, 8);
			...
			this.txtidAsiento.Appearance = appearance25;
			...
			this.btnImprimir.Location = new System.Drawing.Point(731, 8);
			...
			this.btnAsiento.Location = new System.Drawing.Point(835, 8);
			...
			this.lblEstado.Location = new System.Drawing.Point(515, 48);
			...
			// txtSOLCA
			// 
			this.txtSOLCA.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
			appearance26.ForeColor = System.Drawing.Color.Blue;
			appearance26.ForeColorDisabled = System.Drawing.Color.Blue;
			this.txtSOLCA.Appearance = appearance26;
			this.txtSOLCA.DisplayStyle = Infragistics.Win.EmbeddableElementDisplayStyle.Office2003;
			this.txtSOLCA.Enabled = false;
			this.txtSOLCA.FormatString = "#,##0.00";
			this.txtSOLCA.Location = new System.Drawing.Point(516, 256);
			this.txtSOLCA.Name = "txtSOLCA";
			this.txtSOLCA.NumericType = Infragistics.Win.UltraWinEditors.NumericType.Double;
			this.txtSOLCA.PromptChar = ' ';
			this.txtSOLCA.Size = new System.Drawing.Size(100, 22);
			this.txtSOLCA.TabIndex = 634;
			this.txtSOLCA.Visible = false;
			// 
			...
			this.Controls.Add(this.txtSOLCA);
			...
			((System.ComponentModel.ISupportInitialize)(this.txtSOLCA)).EndInit();
		...
		private void btnContabilizar_Click(object sender, System.EventArgs e)
		{
			...
			{
				MessageBox.Show("El lote ya esta liquidado", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop);				
				return;
			}
			...
			int iUltimoLoteLiq = Funcion.iEscalarSQL(cdsSeteoF, "Select MAX(ISNULL(NumeroLote, 0)) + 1 From Compra Where idTipoFactura = 1 And Borrar = 0 And Estado In (10, 11) And idFormaPago = 9 And idEntidadFinanciera = 2 And CapturaLote = 1 And ISNULL(idAsientoLoteSolidario, 0) > 0");
			...
			DateTime dtUltLiq = Funcion.dtEscalarSQL(cdsSeteoF, "Select MAX(ISNULL(FechaVenta, 0)) From Compra Where idTipoFactura = 1 And Borrar = 0 And Estado In (10, 11) And idFormaPago = 9 And idEntidadFinanciera = 2 And CapturaLote = 1");
			...
			using (SqlConnection oConexion = new SqlConnection("Password=Bl45o6$9;Persist Security Info=True;User ID= " + MenuLatinium.stUsuario + ";Initial Catalog=" + MenuLatinium.stDirFacturacion + ";Data Source=" + MenuLatinium.stDirServidor))
			{
				...
				{							
					...
					string sSQL = string.Format("Exec AsientoLoteCrediPoint {0}, {1}, '{2}', {3}, {4}, {5}, {6}", 
						(int)this.txtidAsiento.Value, (int)this.txtLote.Value, Convert.ToDateTime(this.txtFecha.Value).ToString("yyyyMMdd"), 
						Convert.ToDecimal(this.txtComision.Value), Convert.ToDecimal(this.txtFondoGarantia.Value), Convert.ToDecimal(this.txtAcreditado.Value), Convert.ToDecimal(this.txtSOLCA.Value));					
					...
					string sSQLCO = string.Format("Exec AsientoCuentasDeOrdenLiquidacionCartera {0}, {1}, '{2}', 2", 0, (int)this.txtLote.Value, Convert.ToDateTime(this.txtFecha.Value).ToString("yyyyMMdd"));
					oCmdActualiza.CommandText = sSQLCO;
					oCmdActualiza.ExecuteNonQuery();							
		...
		private void Sumatorias()
		{
			...
			foreach(Infragistics.Win.UltraWinGrid.UltraGridRow dr in this.uGridLotes.Rows.All)
			{
				...
				{	
					...
					this.txtSOLCA.Value = Convert.ToDecimal(this.txtSOLCA.Value) + Convert.ToDecimal(dr.Cells["ContribucionSolca"].Value);
				}
			}
		}
