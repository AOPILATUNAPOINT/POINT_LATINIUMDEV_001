...
{
	/// <summary>
	/// Descripción breve de frmAnulaCheques.
	/// </summary>
	public class frmAnulaCheques : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmAnulaCheques));
			...
			this.label3.Text = "Numero De Cheque";
			...
			this.cmbCuentas.KeyDown += new System.Windows.Forms.KeyEventHandler(this.cmbCuentas_KeyDown);
			// 
			// ultraDataSource1
			// 
			...
			this.txtCheque.Size = new System.Drawing.Size(136, 22);
			...
			this.Name = "frmAnulaCheques";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Anulación De Cheques";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmAnulaCheques_KeyDown);
			this.Load += new System.EventHandler(this.frmAnulaCheques_Load);
		...
		private void frmAnulaCheques_Load(object sender, System.EventArgs e)
		{
			FuncionesProcedimientos.RetornaFechaServidor(this.dtFecha, cdsSeteoF, false);

			this.cmbCuentas.DataSource = Funcion.dvProcedimiento(cdsSeteoF, "Select c.idCuenta, Descripcion From Cuenta c Inner Join CuentaCorriente cc On cc.idCuenta = c.idCuenta Where Corriente = 1 Order By Descripcion");
		}
		...
		private void cmbCuentas_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
			if (e.KeyCode == Keys.Enter) this.txtNotas.Focus();
		}

		private void txtCheque_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
			if (e.KeyCode == Keys.Enter) this.cmbCuentas.Focus();
		}
		...
		private void frmAnulaCheques_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
		...
		private void btnAnular_Click(object sender, System.EventArgs e)
		{
			...
			if (!Validacion.vbComboVacio(this.cmbCuentas, "Seleccione una cuenta corriente")) return;

			if (Funcion.iEscalarSQL(cdsSeteoF, string.Format("Select COUNT(*) From AsientoDetalle ad Inner Join Asiento a On a.idAsiento = ad.idAsiento Where a.Cheque = '{0}' And ad.idCuenta In ({1}) And a.idTipoAsiento = 3", this.txtCheque.Text.ToString(), (int)this.cmbCuentas.Value)) > 0)
			{
		...
		{
			if (e.KeyCode == Keys.Enter) this.btnAnular.Focus();
		}
	}
}
