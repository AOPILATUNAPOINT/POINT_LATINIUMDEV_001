...
{
	/// <summary>
	/// Descripción breve de frmArtPixelesPosterior.
	/// </summary>
	public class frmArtPixelesPosterior : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idArtPixelesPosterior");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn2 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Pixeles");
			Infragistics.Win.Appearance appearance2 = new Infragistics.Win.Appearance();
			Infragistics.Win.Appearance appearance3 = new Infragistics.Win.Appearance();
			Infragistics.Win.Appearance appearance4 = new Infragistics.Win.Appearance();
			Infragistics.Win.Appearance appearance5 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn1 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idArtPixelesPosterior");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn2 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Pixeles");
			...
			this.txtIdUnidadMedida.TabIndex = 305;
			...
			this.Name = "frmArtPixelesPosterior";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Pixeles Camara";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmArtPixelesPosterior_KeyDown);
			this.Load += new System.EventHandler(this.frmArtPixelesPosterior_Load);
		...
		private void frmArtPixelesPosterior_Load(object sender, System.EventArgs e)
		{
			this.ultraGrid1.DataSource = Funcion.dvProcedimiento(cdsSeteoF, string.Format("Select idArtPixelesPosterior, Pixeles From ArtPixelesPosterior Order By Pixeles"));
		}

		private void ultraGrid1_AfterRowInsert(object sender, Infragistics.Win.UltraWinGrid.RowEventArgs e)
		{
			e.Row.Cells["idArtPixelesPosterior"].Value = 0;
		}
		...
		private void btAceptar_Click(object sender, System.EventArgs e)
		{
			...
			{
				if ((int)drr.Cells["idArtPixelesPosterior"].Value == 0 || (int)drr.Cells["idArtPixelesPosterior"].Value > 0)
				{
					string sSQLDetalle = string.Format("Exec InsertaAtributosArticulos {0}, '{1}', {2}", 
						drr.Cells["idArtPixelesPosterior"].Value,
						drr.Cells["Pixeles"].Value.ToString(), 13);     
		...
		private void frmArtPixelesPosterior_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
