...
namespace Latinium
{
	...
	public class frmPlanificacionActividadesPersonal : System.Windows.Forms.Form
	{
		...
		private void frmPlanificacionActividadesPersonal_Load(object sender, System.EventArgs e)
		{
			...
			{				
				MessageBox.Show("No puede ingresar a PLANIFICACIÓN ACTIVIDADES PERSONAL", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop);
...
//			}
		...
		private void cmbResponsable_ValueChanged(object sender, System.EventArgs e)
		{
			...
			{
//				this.cmbNomina.DataSource = Funcion.dvProcedimiento (cdsSeteoF, string.Format("Exec APRetornaIdRealiza {0},{1}", MenuLatinium.IdUsuario,(int)this.cmbResponsable.Value ));
