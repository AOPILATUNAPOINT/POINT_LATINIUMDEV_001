...
namespace Latinium
{
	...
	/// </summary>
	public class DBEmpresaBD : DevExpress.XtraEditors.XtraForm
	{
		...
		private DevExpress.XtraEditors.SimpleButton btBorrar;
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.btBorrar = new DevExpress.XtraEditors.SimpleButton();
			...
			// btBorrar
			// 
			this.btBorrar.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			this.btBorrar.Location = new System.Drawing.Point(256, 328);
			...
			this.Name = "DBEmpresaBD";
			this.Text = "DBEmpresa";
			this.Load += new System.EventHandler(this.DBEmpresaBD_Load);
		...
		private void DBEmpresaBD_Load(object sender, System.EventArgs e)
		{
		...
		{
			if (DialogResult.No == MessageBox.Show("Desea Eliminar Empresa ",
				"Confirmación", MessageBoxButtons.YesNo,
				MessageBoxIcon.Question)) return;

			int iFila = grdEmpresa.FocusedRowHandle;
			if (iFila < 0)
			{
				MessageBox.Show("Seleccione Fila de la grilla con la empresa a quitar", "Información",
					MessageBoxButtons.OK, MessageBoxIcon.Information);
				return;
			}
			EmpresaBorrar(iFila);			
		...
		{
			int idEmpresa = (int) grdEmpresa.GetRowCellValue(iFila, colidEmpresa);
