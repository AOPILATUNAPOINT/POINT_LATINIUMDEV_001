...
namespace Latinium
{
	...
	/// </summary>
	public class Empresa : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.ultraGrid1.Size = new System.Drawing.Size(1032, 240);
			...
			this.ultraDropDown1.Location = new System.Drawing.Point(832, 128);
			...
			this.ultraDropDown1.Text = "cmbTipo";
			this.ultraDropDown1.ValueMember = "idTipoBaseDatos";
			...
			this.ClientSize = new System.Drawing.Size(1048, 286);
			...
			this.Name = "Empresa";
			this.Text = "Empresa";
			this.Closing += new System.ComponentModel.CancelEventHandler(this.Empresa_Closing);
		...
		private void Empresa_Load(object sender, System.EventArgs e)
		{
			Cursor = Cursors.Default;
			string stAudita = "Exec AuditaCrear 53, 6, 'Empresa'";
			Funcion.EjecutaSQL(cdsSeteo, stAudita, true);
		}

		private void Empresa_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			string stAudita = "Exec AuditaCrear 53, 7, 'Empresa'";
			Funcion.EjecutaSQL(cdsSeteo, stAudita, true);
		}
