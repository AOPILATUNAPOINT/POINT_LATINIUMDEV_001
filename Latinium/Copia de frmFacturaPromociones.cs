...
namespace Latinium
{
	...
	public class frmFacturaPromociones : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnGuardar.Location = new System.Drawing.Point(274, 560);
		...
		private void btnGuardar_Click(object sender, System.EventArgs e)
		{
			...
			foreach(Infragistics.Win.UltraWinGrid.UltraGridRow drr in this.uGridInformacion.Rows.All)
			{	
				string sSQLDetalle = string.Format("Exec GuardaDetalleFacturaDetallePromociones  {0}, {1}, {2}, {3}, '{4}', {5}", 
			...
			{
				string sSQL = string.Format("Exec ActualizaPorcentajesCuotaBarataza '{0}', {1}, {2}", System.Convert.ToDateTime(this.dtDesde.Value).ToString("yyyyMMdd"), 1, (int)this.txtidFacturacionPromociones.Value);
				Funcion.EjecutaSQL(cdsSeteoF, sSQL, true);       
			}
			else if ((int)this.optEstado.Value == 2)
			{
				string sSQL = string.Format("Exec ActualizaPorcentajesCuotaBarataza '{0}', {1}, {2}", System.Convert.ToDateTime(this.dtHasta.Value).ToString("yyyyMMdd"), 2, (int)this.txtidFacturacionPromociones.Value);
				Funcion.EjecutaSQL(cdsSeteoF, sSQL, true);
			}
		...
		private void btnAgregar_Click(object sender, System.EventArgs e)
		{
			...
			this.uGridInformacion.ActiveRow.Cells["Modelo"].Value =  this.cmbModelo.Value;	
