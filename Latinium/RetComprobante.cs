...
{
	/// <summary>
	/// Descripción breve de RetComprobante.
	/// </summary>
	public class RetComprobante : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn4 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idCompraNumero");
			...
			this.cdsComprobante.Locale = new System.Globalization.CultureInfo("ro-RO");
			...
			this.btAceptar.Location = new System.Drawing.Point(64, 272);
			...
			this.btCancelar.Location = new System.Drawing.Point(424, 272);
			...
			this.Name = "RetComprobante";
			this.Text = "Tipos de Comprobante";
			this.Closing += new System.ComponentModel.CancelEventHandler(this.RetComprobante_Closing);
			this.Load += new System.EventHandler(this.RetComprobante_Load);
		...
		private void RetComprobante_Load(object sender, System.EventArgs e)
		{
			Cursor = Cursors.Default;
		}

		private void RetComprobante_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			string stAudita = "Exec AuditaCrear 53, 7, 'RetComprobante'";
