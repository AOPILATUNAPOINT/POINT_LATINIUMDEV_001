...
{
	/// <summary>
	/// Summary description for frmCombosPromociones.
	/// </summary>
	public class frmCombosPromociones : DevExpress.XtraEditors.XtraForm
	{
		...
		public frmCombosPromociones(int idPromocion, int idTipoPrecio, int idFormaPago)
		{
			//
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn7 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("ValDescuento");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn7 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("ValDescuento");
			...
			this.ultraGrid1.Size = new System.Drawing.Size(584, 256);
			this.ultraGrid1.TabIndex = 306;
			...
			this.Name = "frmCombosPromociones";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Productos en Promoción";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmCombosPromociones_KeyDown);
			this.Load += new System.EventHandler(this.frmCombosPromociones_Load);
		...
		private void frmCombosPromociones_Load(object sender, System.EventArgs e)
		{			
			string sSQLProm = string.Format("Exec CargaArticulosPromocion {0}, {1}, {2}", IdPromocion, IdTipoPrecio, IdFormaPago);
			this.ultraGrid1.DataSource = Funcion.dvProcedimiento(cdsSeteoF, sSQLProm);
		}
		...
		private void frmCombosPromociones_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
		...
		{
			using (frmColoresProductos Colores = new frmColoresProductos((int)ultraGrid1.ActiveRow.Cells["idArticulo"].Value, 1))
			{				
