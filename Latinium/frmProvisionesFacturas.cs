...
namespace Latinium
{
	...
	public class frmProvisionesFacturas : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.uGridProvisiones.Size = new System.Drawing.Size(1318, 272);
			...
			this.uGridSaldosBancarios.Location = new System.Drawing.Point(822, 8);
			...
			this.optFiltro.Location = new System.Drawing.Point(418, 8);
			...
			this.btnAutorizar.Location = new System.Drawing.Point(726, 7);
			...
			this.btnImprimir.Location = new System.Drawing.Point(726, 55);
			...
			this.btnIrA.Location = new System.Drawing.Point(726, 31);
			...
			this.btnActualizar.Location = new System.Drawing.Point(726, 103);
			...
			this.optFiltro1.Location = new System.Drawing.Point(418, 40);
			...
			this.optFiltro2.Location = new System.Drawing.Point(418, 72);
			...
			this.btnCerrar.Location = new System.Drawing.Point(726, 127);
			...
			if (DialogResult.Yes ==	MessageBox.Show(string.Format("¿Esta seguro de autorizar {0} pagos seleccionados?", iCont), "Point Technology", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2))
			{
				foreach(Infragistics.Win.UltraWinGrid.UltraGridRow dr in this.uGridProvisiones.Rows.All)
				{
					...
					{	
						...
						#region Envio Correo Pagos
						string sSQLenvio = string.Format("Exec PagosAutorizadosEnvioCorreo {0}, '{1}', '{2}', '{3}', '{4}'", 
							(int)dr.Cells["idAutorizacionPago"].Value, 
							dr.Cells["Grupo"].Value.ToString(),
							dr.Cells["Identificacion"].Value.ToString(),
							dr.Cells["Proveedor"].Value.ToString(),
							dr.Cells["Numero"].Value.ToString());
						Funcion.EjecutaSQL(cdsSeteoF, sSQLenvio, true);
						#endregion Envio Correo Pagos
