...
{
	/// <summary>
	/// Descripción breve de frmReporteSolicitudWeb.
	/// </summary>
	public class frmReporteSolicitudWeb : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmReporteSolicitudWeb));
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn4 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Numero Solicitud");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn10 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Tipo Cliente");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn11 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Estado");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn12 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Tipo de Consulta");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn13 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Resultado");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn14 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Entrada");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn15 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Analista");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn1 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Numero Solicitud");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn7 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Tipo Cliente");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn9 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Tipo de Consulta");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn11 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Entrada");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn12 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Analista");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn13 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Operadora");
			...
			this.btnSalir.Location = new System.Drawing.Point(776, 48);
			this.btnSalir.Name = "btnSalir";
			this.btnSalir.TabIndex = 1105;
			...
			this.lblContador.Location = new System.Drawing.Point(456, 40);
			this.lblContador.Name = "lblContador";
			this.lblContador.Size = new System.Drawing.Size(0, 17);
			this.lblContador.TabIndex = 1101;
			// 
			// btnVer
			// 
			...
			this.uGridInformacion.Size = new System.Drawing.Size(896, 248);
			this.uGridInformacion.TabIndex = 1106;
			// 
			// ultraDataSource2
			// 
			...
			this.ultraDataSource2.Band.Columns.AddRange(new object[] {
																																 ...
																																 ultraDataColumn13});
			// 
			// frmReporteSolicitudWeb
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(912, 334);
			...
			this.Name = "frmReporteSolicitudWeb";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "frmReporteSolicitudWeb";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmReporteSolicitudWeb_KeyDown);
			this.Load += new System.EventHandler(this.frmReporteSolicitudWeb_Load);
		...
		private void frmReporteSolicitudWeb_Load(object sender, System.EventArgs e)
		{
		...
		private void btnVer_Click(object sender, System.EventArgs e)
		{
			...
			string sSQL = string.Format("Exec [ReporteSolicitudWeb] '{0}', '{1}', {2} ",
		...
		private void frmReporteSolicitudWeb_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
