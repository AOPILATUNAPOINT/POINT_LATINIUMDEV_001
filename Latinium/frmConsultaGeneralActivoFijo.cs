...
{
	/// <summary>
	/// Descripción breve de frmConsultaGeneralActivoFijo.
	/// </summary>
	public class frmConsultaGeneralActivoFijo : System.Windows.Forms.Form
	{
		...
		public frmConsultaGeneralActivoFijo()
		{
			//
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmConsultaGeneralActivoFijo));
			Infragistics.Win.Appearance appearance2 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinSchedule.CalendarCombo.DateButton dateButton2 = new Infragistics.Win.UltraWinSchedule.CalendarCombo.DateButton();
			Infragistics.Win.Appearance appearance3 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinGrid.UltraGridBand ultraGridBand1 = new Infragistics.Win.UltraWinGrid.UltraGridBand("Band 0", -1);
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idActivosFijos");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn5 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("ValorCompra");
			Infragistics.Win.Appearance appearance4 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn6 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("ValorContable");
			Infragistics.Win.Appearance appearance5 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn7 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Personal");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn8 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Centro_Costo");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn1 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idActivosFijos");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn5 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("ValorCompra");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn6 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("ValorContable");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn8 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Centro_Costo");
			...
			this.uGridCreditos.DataSource = this.ultraDataSource2;
			...
			ultraGridColumn5.Header.Caption = "Valor Compra";
			...
			ultraGridColumn6.Header.Caption = "Valor Contable";
			...
			this.uGridCreditos.DisplayLayout.Override.ActiveRowAppearance = appearance6;
			...
			this.uGridCreditos.DisplayLayout.Override.CardAreaAppearance = appearance7;
			appearance8.ForeColor = System.Drawing.Color.Black;
			appearance8.ForeColorDisabled = System.Drawing.Color.Black;
			this.uGridCreditos.DisplayLayout.Override.CellAppearance = appearance8;
			...
			this.uGridCreditos.Location = new System.Drawing.Point(8, 72);
			this.uGridCreditos.Name = "uGridCreditos";
			this.uGridCreditos.Size = new System.Drawing.Size(800, 176);
			this.uGridCreditos.TabIndex = 974;
			// 
			// ultraDataSource2
			// 
			...
			this.btnCancelar.Location = new System.Drawing.Point(96, 264);
			...
			this.ultraLabel1.TabIndex = 979;
			this.ultraLabel1.Text = "Serie/Numero/Personal";
			// 
			// btnBuscar
			// 
			...
			this.txtBusqueda.Location = new System.Drawing.Point(144, 39);
			this.txtBusqueda.Name = "txtBusqueda";
			this.txtBusqueda.Size = new System.Drawing.Size(264, 21);
			this.txtBusqueda.TabIndex = 977;
			// 
			// lblContador
			// 
			...
			this.lblContador.Location = new System.Drawing.Point(512, 40);
			...
			this.Name = "frmConsultaGeneralActivoFijo";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Consulta Activo Fijo";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmConsultaGeneralActivoFijo_KeyDown);
			this.Load += new System.EventHandler(this.frmConsultaGeneralActivoFijo_Load);
		...
		private void frmConsultaGeneralActivoFijo_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
			if (e.KeyCode == Keys.Escape) this.DialogResult = DialogResult.No;
		}

		private void frmConsultaGeneralActivoFijo_Load(object sender, System.EventArgs e)
		{
		...
		private void btnBuscar_Click(object sender, System.EventArgs e)
		{
			...
			this.uGridCreditos.DataSource = ultraDataSource2;

			string sSQL = string.Format("Exec [ConsultaGeneralActivosFijos] '{0}', '{1}', '{2}'", 
		...
		private void Aceptar()
		{
			...
			else if (this.uGridCreditos.ActiveRow.Cells["idActivosFijos"].Value == System.DBNull.Value)
			{
				MessageBox.Show("Seleccione un documento.", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Information);				
			}
			else 
