...
{
	/// <summary>
	/// Descripción breve de frmGestionPorCedula.
	/// </summary>
	public class frmGestionPorCedula : System.Windows.Forms.Form
	{
		...
		string sCedula ="";
		public frmGestionPorCedula(string SCedula)
		{
			sCedula = SCedula;
			//
			// Necesario para admitir el Diseñador de Windows Forms
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn2 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idCbo_GestionesDeCobranzas");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn3 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Fecha");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn4 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Operador_Cobrador");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn5 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Estado");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn6 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Resultado");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn9 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("ESTADO_PAGO");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn13 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Cliente", -1, null, 0, Infragistics.Win.UltraWinGrid.SortIndicator.Ascending, false);
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn16 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("DireccionUrlWSP");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn17 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Tipo");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn18 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Ir", 0);
			Infragistics.Win.Appearance appearance3 = new Infragistics.Win.Appearance();
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmGestionPorCedula));
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn2 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idCbo_GestionesDeCobranzas");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn3 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Fecha");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn4 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Operador_Cobrador");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn6 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Resultado");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn9 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("ESTADO_PAGO");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn13 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Cliente");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn16 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("DireccionUrlWSP");
			...
			ultraGridColumn4.Header.Caption = "Operador/Cobrador/Vendedor";
			...
			ultraGridColumn6.Header.Caption = "Gestión Estado";
			ultraGridColumn6.Header.VisiblePosition = 7;
			ultraGridColumn6.Width = 100;
			ultraGridColumn7.CellActivation = Infragistics.Win.UltraWinGrid.Activation.ActivateOnly;
			ultraGridColumn7.Header.Caption = "Fecha Pago";
			ultraGridColumn7.Header.VisiblePosition = 8;
			ultraGridColumn7.Width = 90;
			ultraGridColumn8.CellActivation = Infragistics.Win.UltraWinGrid.Activation.ActivateOnly;
			appearance2.TextHAlign = Infragistics.Win.HAlign.Right;
			ultraGridColumn8.CellAppearance = appearance2;
			ultraGridColumn8.Formula = "#,##0.00";
			ultraGridColumn8.Header.VisiblePosition = 9;
			ultraGridColumn8.Width = 80;
			ultraGridColumn9.CellActivation = Infragistics.Win.UltraWinGrid.Activation.ActivateOnly;
			ultraGridColumn9.Header.Caption = "Estado Compromiso";
			ultraGridColumn9.Header.VisiblePosition = 10;
			ultraGridColumn9.Width = 120;
			ultraGridColumn10.CellActivation = Infragistics.Win.UltraWinGrid.Activation.ActivateOnly;
			ultraGridColumn10.Header.Caption = "Parentesco";
			...
			this.uGridDocumentos.Location = new System.Drawing.Point(8, 48);
			this.uGridDocumentos.Name = "uGridDocumentos";
			this.uGridDocumentos.Size = new System.Drawing.Size(1184, 248);
			...
			this.btnSalir.Location = new System.Drawing.Point(1120, 8);
			this.btnSalir.Name = "btnSalir";
			this.btnSalir.Size = new System.Drawing.Size(72, 23);
			this.btnSalir.TabIndex = 958;
			...
			this.btnVer.Location = new System.Drawing.Point(296, 12);
			this.btnVer.Name = "btnVer";
			this.btnVer.Size = new System.Drawing.Size(75, 24);
			this.btnVer.TabIndex = 959;
			...
			this.lblContador.Location = new System.Drawing.Point(384, 13);
			...
			this.ClientSize = new System.Drawing.Size(1208, 302);
			...
			this.Name = "frmGestionPorCedula";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Gestiones por Cedula";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmGestionPorCedula_KeyDown);
			this.Load += new System.EventHandler(this.frmGestionPorCedula_Load);
		...
		private void frmGestionPorCedula_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
			if( sCedula.Length > 0 )
			{
		...
		{
			string sSQLg = string.Format("Exec [ConsultaGestionesPorCedula] '{0}'", (string) this.txtBuscar.Text);
			FuncionesProcedimientos.dsGeneralModulo(sSQLg, this.uGridDocumentos);
		...
		private void frmGestionPorCedula_Load(object sender, System.EventArgs e)
		{
			if( sCedula.Length == 0)
			{
				miAcceso = new Acceso(cdsSeteoF, "081220");

				if (!Funcion.Permiso("2053", cdsSeteoF))
				{				
					MessageBox.Show("No puede ingresar a Gestiones por Cedula", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop);
