...
namespace Latinium
{
	...
	public class frmMovimientosBancarios : System.Windows.Forms.Form
	{
		...
		private void btnBuscar_Click(object sender, System.EventArgs e)
		{
			...
			string sSQLMov = string.Format("Exec ListaDeMovimientosBancarios {0}, {1}, '{2}', '{3}', {4}, '{5}', '{6}'", idCuenta, idTipo, this.txtBusqueda.Text.ToString(), (int)this.optFiltro.Value, bFechas, dtDesde.ToString("yyyyMMdd"), dtHasta.ToString("yyyyMMdd"));
			this.uGridDocumentos.DataSource = Funcion.dvProcedimiento(cdsSeteoF, sSQLMov);
		}
