...
namespace Latinium
{
	...
	public class frmCuentasPorCobrar : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn15 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Ent_Financiera");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn15 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Ent_Financiera");
			...
			Infragistics.Win.UltraWinGrid.SummarySettings summarySettings7 = new Infragistics.Win.UltraWinGrid.SummarySettings("", Infragistics.Win.UltraWinGrid.SummaryType.Sum, null, "Valor", 11, true, "Band 0", 0, Infragistics.Win.UltraWinGrid.SummaryPosition.UseSummaryPositionColumn, "Valor", 11, true);
			Infragistics.Win.Appearance appearance30 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinGrid.SummarySettings summarySettings8 = new Infragistics.Win.UltraWinGrid.SummarySettings("", Infragistics.Win.UltraWinGrid.SummaryType.Sum, null, "Capital", 12, true, "Band 0", 0, Infragistics.Win.UltraWinGrid.SummaryPosition.UseSummaryPositionColumn, "Capital", 12, true);
			Infragistics.Win.Appearance appearance31 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinGrid.SummarySettings summarySettings9 = new Infragistics.Win.UltraWinGrid.SummarySettings("", Infragistics.Win.UltraWinGrid.SummaryType.Sum, null, "Interes", 13, true, "Band 0", 0, Infragistics.Win.UltraWinGrid.SummaryPosition.UseSummaryPositionColumn, "Interes", 13, true);
			Infragistics.Win.Appearance appearance32 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinGrid.SummarySettings summarySettings10 = new Infragistics.Win.UltraWinGrid.SummarySettings("", Infragistics.Win.UltraWinGrid.SummaryType.Sum, null, "Mora", 14, true, "Band 0", 0, Infragistics.Win.UltraWinGrid.SummaryPosition.UseSummaryPositionColumn, "Mora", 14, true);
			Infragistics.Win.Appearance appearance33 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinGrid.SummarySettings summarySettings11 = new Infragistics.Win.UltraWinGrid.SummarySettings("", Infragistics.Win.UltraWinGrid.SummaryType.Sum, null, "Gastos", 15, true, "Band 0", 0, Infragistics.Win.UltraWinGrid.SummaryPosition.UseSummaryPositionColumn, "Gastos", 15, true);
			...
			ultraGridColumn15.Header.Caption = "Ent. Financiera";
			...
			this.txtBuscar.Appearance = appearance22;
			...
			this.uGridDetalle.DisplayLayout.Appearance = appearance24;
			...
			this.uGridDetalle.DisplayLayout.Override.ActiveRowAppearance = appearance35;
			...
			this.uGridDetalle.DisplayLayout.Override.CardAreaAppearance = appearance36;
			appearance37.ForeColor = System.Drawing.Color.Black;
			appearance37.ForeColorDisabled = System.Drawing.Color.Black;
			this.uGridDetalle.DisplayLayout.Override.CellAppearance = appearance37;
			...
			this.uGridDetalle.DisplayLayout.Override.HeaderAppearance = appearance38;
			...
			this.uGridDetalle.DisplayLayout.Override.RowAlternateAppearance = appearance39;
			...
			this.uGridDetalle.DisplayLayout.Override.RowSelectorAppearance = appearance40;
			...
			this.uGridDetalle.DisplayLayout.Override.SelectedRowAppearance = appearance41;
			...
			this.uGridDetalle.Size = new System.Drawing.Size(1182, 168);
			...
			this.uGridDetalle.Click += new System.EventHandler(this.uGridDetalle_Click);
			// 
			// ultraDataSource3
			// 
			...
			this.uGridPlanDePagos.DisplayLayout.Appearance = appearance42;
			...
			ultraGridColumn54.CellAppearance = appearance43;
			...
			this.uGridPlanDePagos.DisplayLayout.Override.CardAreaAppearance = appearance44;
			...
			this.uGridPlanDePagos.DisplayLayout.Override.HeaderAppearance = appearance45;
			...
			this.uGridPlanDePagos.DisplayLayout.Override.RowAlternateAppearance = appearance46;
			...
			this.uGridPlanDePagos.DisplayLayout.Override.RowSelectorAppearance = appearance47;
			...
			this.uGridPlanDePagos.DisplayLayout.Override.SelectedRowAppearance = appearance48;
			...
			this.lblFacturas.Location = new System.Drawing.Point(664, 8);
			...
			this.lblDescuento.Location = new System.Drawing.Point(912, 42);
			...
			this.txtValor.Appearance = appearance49;
			this.txtValor.DisplayStyle = Infragistics.Win.EmbeddableElementDisplayStyle.Office2003;
			this.txtValor.Enabled = false;
			this.txtValor.Font = new System.Drawing.Font("Tahoma", 9F);
			this.txtValor.FormatString = "#,##0.00";
			this.txtValor.Location = new System.Drawing.Point(992, 39);
			...
			this.lblBodega.Location = new System.Drawing.Point(664, 42);
			...
			this.cmbBodega.Location = new System.Drawing.Point(704, 40);
			...
			this.txtNumIdCliente.Location = new System.Drawing.Point(96, 8);
			...
			this.txtBuscarDocumento.Appearance = appearance50;
			...
			this.txtBuscarDocumento.Location = new System.Drawing.Point(368, 8);
			...
			this.btnExcel.Location = new System.Drawing.Point(1104, 8);
			...
			// btnBuscar
			// 
			this.btnBuscar.Location = new System.Drawing.Point(480, 8);
			...
			this.btnCobro.Location = new System.Drawing.Point(1104, 39);
      ...
      this.lblFacturas.Text = "0 Documentos Seleccionados";						
		...
		{						
			...
			string sSQL = string.Format("Exec CuentasPorCobrar {0}, {1}, '{2}'", (int)this.txtNumIdCliente.Value, (int)this.rdgEstado.EditValue, this.txtBuscarDocumento.Text.ToString());
		...
		private void frmCuentasPorCobrar_Load(object sender, System.EventArgs e)
		{
			...
			else
			{
				...
				this.cmbBodega.DataSource = Funcion.dvProcedimiento(cdsSeteoF, "Select Bodega, Nombre, Codigo From Bodega Where Bodega In (1, 51)");
		...
		private void DetalleCuentas()
		{
			if (uGridDocumentos.ActiveRow != null)
			{
				...
				{					
					...
					if (this.uGridDocumentos.ActiveRow.Cells["Estado"].Value.ToString() == "PENDIENTE" && (int)this.uGridDocumentos.ActiveRow.Cells["idFormaPago"].Value == 6) this.mnuAcciones.MenuItems[0].Enabled = true;
			...
			else
			{
				...
				else
				{
					...
					if (!bValido)
					{
						...
						using (VentaFormaDePago miCobro = new VentaFormaDePago (2, Convert.ToDecimal(this.txtValor.Value), 4, true, DateTime.Today, 1)) //Convert.ToDecimal(this.uGridDocumentos.ActiveRow.Cells["Saldo"].Value
						{
							if (DialogResult.OK == miCobro.ShowDialog())
							{
								...
								foreach(Infragistics.Win.UltraWinGrid.UltraGridRow dr in miCobro.ultraGrid1.Rows.All)
								{
									...
									if ((int)dr.Cells["idFormaPago"].Value == 3 || (int)dr.Cells["idFormaPago"].Value == 11) dtFecCaducidad = (DateTime)dr.Cells["FechaCaducidad"].Value;
		...
		private void mnuAccionesRetencion_Click(object sender, System.EventArgs e)
		{
			...
			if (this.uGridDocumentos.ActiveRow.Cells["Fecha"].Value != System.DBNull.Value) dtFecha = (DateTime)this.uGridDocumentos.ActiveRow.Cells["Fecha"].Value;
		...
		private void uGridDetalle_Click(object sender, System.EventArgs e)
		{
		...
		private void mnuAccionesNotaDeCredito_Click(object sender, System.EventArgs e)
		{
			...
			foreach(Infragistics.Win.UltraWinGrid.UltraGridRow dr in this.uGridDocumentos.Rows.All)
			{
				if ((bool)dr.Cells["Sel"].Value)
				{
					if ((int)dr.Cells["idFormaPago"].Value != 6 && (int)dr.Cells["idFormaPago"].Value != 9)
					{
					...
					{
						if ((int)dr.Cells["idEntidadFinanciera"].Value != 2)
						{
			...
			using (frmBuscaNCCXC miNCPendientes = new frmBuscaNCCXC((int)this.txtNumIdCliente.Value))
			{
										...
										if ((bool) dr.Cells["Sel"].Value)
										{
											if (dSaldo > 0.00m)
											{
												...
												{								
													...
													string sSQLInsPag = string.Format("Insert Into AnticiposCompras (idAnticipo, idCompra, Valor, Fecha, idTipoFactura) Values ({0}, {1}, {2}, '{3}', {4})", 
														(int)drNC.Cells["idAnticipo"].Value, (int)dr.Cells["idCompra"].Value, dValor, dtFechaA.ToString("yyyyMMdd"), (int)dr.Cells["idTipoFactura"].Value);
													Funcion.EjecutaSQL(cdsSeteoF, sSQLInsPag);
