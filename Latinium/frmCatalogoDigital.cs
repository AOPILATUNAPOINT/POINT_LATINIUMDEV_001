...
{
	/// <summary>
	/// Descripción breve de frmCatalogoDigital.
	/// </summary>
	public class frmCatalogoDigital : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmCatalogoDigital));
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn21 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Precio3");
			Infragistics.Win.Appearance appearance16 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn22 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("cuo6");
			Infragistics.Win.Appearance appearance17 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn23 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("cuo9");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn24 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("cuo12");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn25 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("cuo24");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn26 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("cuc3");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn27 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("cuc6");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn28 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("cuc9");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn29 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("cuc12");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn30 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("cuc18");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn31 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("entrada");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn32 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("notaportada");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn33 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("nota1");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn34 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("nota2");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn35 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("valorportada");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn36 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idTipoCatalogo");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn37 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("CuotasE");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn38 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("CuotasC");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn39 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("cuotap", 0);
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn18 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Precio3");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn19 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("cuo6");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn20 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("cuo9");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn21 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("cuo12");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn22 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("cuo24");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn23 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("cuc3");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn24 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("cuc6");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn25 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("cuc9");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn26 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("cuc12");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn27 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("cuc18");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn28 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("entrada");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn29 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("notaportada");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn30 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("nota1");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn31 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("nota2");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn32 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("valorportada");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn33 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idTipoCatalogo");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn34 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("CuotasE");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn35 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("CuotasC");
			...
			this.ultraTabPageControl9.Size = new System.Drawing.Size(1886, 335);
			// 
			// ultraGrid1
			// 
			...
			this.pgEntrega.Size = new System.Drawing.Size(1886, 335);
			// 
			// ultraGrid2
			// 
			...
			ultraGridColumn21.CellDisplayStyle = Infragistics.Win.UltraWinGrid.CellDisplayStyle.FullEditorDisplay;
			ultraGridColumn21.Header.Caption = "Precio Oferta";
			ultraGridColumn21.Header.VisiblePosition = 6;
			appearance17.TextHAlign = Infragistics.Win.HAlign.Right;
			ultraGridColumn22.CellAppearance = appearance17;
			ultraGridColumn22.Header.Caption = "6 Cuotas con interes";
			ultraGridColumn22.Header.VisiblePosition = 10;
			ultraGridColumn22.Hidden = true;
			ultraGridColumn23.Header.Caption = "9 Cuotas con interes";
			ultraGridColumn23.Header.VisiblePosition = 11;
			ultraGridColumn23.Hidden = true;
			ultraGridColumn24.Header.Caption = "12 Cuotas con interes";
			ultraGridColumn24.Header.VisiblePosition = 12;
			ultraGridColumn24.Hidden = true;
			ultraGridColumn25.Header.Caption = "24 Cuotas con interes";
			ultraGridColumn25.Header.VisiblePosition = 13;
			ultraGridColumn25.Hidden = true;
			ultraGridColumn26.Header.Caption = "6 Cuotas ";
			ultraGridColumn26.Header.VisiblePosition = 15;
			ultraGridColumn26.Hidden = true;
			ultraGridColumn27.Header.Caption = "6 Cuotas ";
			ultraGridColumn27.Header.VisiblePosition = 16;
			ultraGridColumn27.Hidden = true;
			ultraGridColumn28.Header.Caption = "9 Cuotas ";
			ultraGridColumn28.Header.VisiblePosition = 17;
			ultraGridColumn28.Hidden = true;
			ultraGridColumn29.Header.Caption = "12 Cuotas ";
			ultraGridColumn29.Header.VisiblePosition = 18;
			ultraGridColumn29.Hidden = true;
			ultraGridColumn30.Header.Caption = "18 Cuotas ";
			ultraGridColumn30.Header.VisiblePosition = 19;
			ultraGridColumn30.Hidden = true;
			ultraGridColumn31.Header.Caption = "Entrada";
			ultraGridColumn31.Header.VisiblePosition = 14;
			ultraGridColumn31.Hidden = true;
			ultraGridColumn32.Header.Caption = "Portada";
			ultraGridColumn32.Header.VisiblePosition = 20;
			ultraGridColumn32.Hidden = true;
			ultraGridColumn33.Header.Caption = "Adicionales/ Obsequios";
			ultraGridColumn33.Header.Enabled = false;
			ultraGridColumn33.Header.VisiblePosition = 22;
			ultraGridColumn33.Hidden = true;
			ultraGridColumn34.Header.Caption = "Adicional";
			ultraGridColumn34.Header.VisiblePosition = 23;
			ultraGridColumn34.Hidden = true;
			ultraGridColumn35.Header.Caption = "Valor Portada";
			ultraGridColumn35.Header.VisiblePosition = 21;
			ultraGridColumn35.Hidden = true;
			ultraGridColumn36.Header.VisiblePosition = 28;
			ultraGridColumn36.Hidden = true;
			ultraGridColumn37.Header.Caption = "Valor Cuota";
			ultraGridColumn37.Header.VisiblePosition = 8;
			ultraGridColumn37.Hidden = true;
			ultraGridColumn38.Header.Caption = "Valor Cuota";
			...
			ultraGridColumn39.DataType = typeof(System.Double);
			ultraGridColumn39.Header.Caption = "Cuota Publicada";
			...
			ultraGridBand2.Override.EditCellAppearance = appearance19;
			...
			appearance23.FontData.SizeInPoints = 8.25F;
			...
			this.ultraGrid2.DisplayLayout.Override.RowAlternateAppearance = appearance24;
			...
			this.ultraGrid2.DisplayLayout.Override.RowSelectorAppearance = appearance25;
			...
			this.ultraGrid2.DisplayLayout.Override.SelectedRowAppearance = appearance26;
			...
			this.ultraGrid2.Size = new System.Drawing.Size(1329, 324);
			...
			this.dtHasta.TabIndex = 816;
			this.dtHasta.Value = ((object)(resources.GetObject("dtHasta.Value")));
			// 
			// dtDesde
			// 
			appearance30.ForeColorDisabled = System.Drawing.Color.Black;
			this.dtDesde.Appearance = appearance30;
			...
			valueListItem5.DisplayText = "Inicial";
			...
			this.optEstado.Location = new System.Drawing.Point(648, 8);
			this.optEstado.Name = "optEstado";
			this.optEstado.Size = new System.Drawing.Size(8, 24);
			this.optEstado.TabIndex = 823;
			...
			this.lblContador.Location = new System.Drawing.Point(592, 64);
			this.lblContador.Name = "lblContador";
			this.lblContador.Size = new System.Drawing.Size(0, 20);
			this.lblContador.TabIndex = 824;
			...
			this.btnExcel.Location = new System.Drawing.Point(712, 8);
			...
			this.ultraTabSharedControlsPage1.Size = new System.Drawing.Size(1886, 335);
			// 
			// utcEstadoCajas
			// 
			...
			this.utcEstadoCajas.Appearance = appearance35;
			...
			this.utcEstadoCajas.Size = new System.Drawing.Size(1888, 356);
			this.utcEstadoCajas.Style = Infragistics.Win.UltraWinTabControl.UltraTabControlStyle.Excel;
			this.utcEstadoCajas.TabIndex = 827;
			...
			this.Name = "frmCatalogoDigital";
			this.Text = "frmCatalogoDigital";
		...
		{
			string sSQL = string.Format("Exec CatalogoGeneralDigital '{0}', '{1}', '{2}',{3}", 
		...
		private void ultraGrid1_ClickCellButton(object sender, Infragistics.Win.UltraWinGrid.CellEventArgs e)
		{
			...
			string sSQL  = string.Format("Exec ReporteCatalogoDigital {0}", (int)this.ultraGrid1.ActiveRow.Cells["idCatalogo"].Value);
