...
namespace Latinium
{
	...
	/// </summary>
	public class frmCom_PresupuestoMensualPorLocal : System.Windows.Forms.Form
	{
		...
		public frmCom_PresupuestoMensualPorLocal()
		{
			//
		...
		private void InitializeComponent()
		{
			...
			this.txtAnio.TabIndex = 735;
			// 
			// frmCom_PresupuestoMensualPorLocal
			// 
			...
			this.Name = "frmCom_PresupuestoMensualPorLocal";
			this.Text = "Presupuesto Mensual Por Local";
		...
		private void btnGenerar_Click(object sender, System.EventArgs e)
		{
			...
			{
				MessageBox.Show(string.Format("Ya esta Generado el Presupuesto para el Año {0}", Convert.ToInt32(this.txtAnio.Text)), "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Stop);
				this.btnVer_Click(sender, e);
				this.txtAnio.Focus();
				return;
			}

			if (DialogResult.Yes == MessageBox.Show(string.Format("Esta Seguro de Generar el presupuesto del Año {0}", Convert.ToInt32(this.txtAnio.Text)), "Point Technology", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2))
			{
		...
		private void btnVer_Click(object sender, System.EventArgs e)
		{
			...
			string sSQL = string.Format("Exec Com_ConsultaPresupuestoMensualLocales {0}, {1}", iBodega, Convert.ToInt32(this.txtAnio.Text));
