...
{
	/// <summary>
	/// Descripción breve de frmCuentasContablesEnlazar.
	/// </summary>
	public class frmCuentasContablesEnlazar : System.Windows.Forms.Form
	{
		...
		public frmCuentasContablesEnlazar(int idCuenta,int tipo,string codigo,DateTime desde,DateTime hasta,string DescripcionH,string codigoH, string codigoCuenta, bool cerrado)
		{
			//
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmCuentasContablesEnlazar));
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn4 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Selec2");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn6 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("SeleccionAnterior");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn4 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Selec2");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn6 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("SeleccionAnterior");
			...
			this.btnGuardar.Location = new System.Drawing.Point(280, 80);
			...
			this.optGrupos.Location = new System.Drawing.Point(24, 48);
			this.optGrupos.Name = "optGrupos";
			this.optGrupos.Size = new System.Drawing.Size(424, 24);
			this.optGrupos.TabIndex = 766;
			...
			this.txtCuentas.Location = new System.Drawing.Point(160, 120);
			this.txtCuentas.Name = "txtCuentas";
			this.txtCuentas.Size = new System.Drawing.Size(200, 21);
			this.txtCuentas.TabIndex = 764;
			// 
			// groupBox1
			// 
			...
			this.chkCuentas.Location = new System.Drawing.Point(32, 184);
			this.chkCuentas.Name = "chkCuentas";
			this.chkCuentas.Size = new System.Drawing.Size(13, 13);
			this.chkCuentas.TabIndex = 762;
			...
			ultraGridColumn6.Header.Caption = "Cuenta Actual";
			...
			this.label17.Location = new System.Drawing.Point(216, 16);
			this.label17.Name = "label17";
			this.label17.Size = new System.Drawing.Size(37, 16);
			this.label17.TabIndex = 756;
			...
			ultraGridColumn7.Header.Caption = "N.";
			...
			this.optReportes.Location = new System.Drawing.Point(88, 80);
			this.optReportes.Name = "optReportes";
			this.optReportes.Size = new System.Drawing.Size(176, 24);
			this.optReportes.TabIndex = 759;
			...
			this.btnVer.Location = new System.Drawing.Point(368, 120);
			...
			this.lbl_registros.Location = new System.Drawing.Point(472, 88);
			this.lbl_registros.Name = "lbl_registros";
			this.lbl_registros.Size = new System.Drawing.Size(184, 23);
			this.lbl_registros.TabIndex = 769;
			this.lbl_registros.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
			// 
			// frmCuentasContablesEnlazar
			// 
			...
			this.Name = "frmCuentasContablesEnlazar";
			this.Text = "frmCuentasContablesEnlazar";
			this.Load += new System.EventHandler(this.frmCuentasContablesEnlazar_Load);
		...
		private void frmCuentasContablesEnlazar_Load(object sender, System.EventArgs e)
		{
		...
		private void ListaCuentas()
		{
			if((int)this.optReportes.Value==8)
			{
				this.uGridCuentas.DataSource = 
					FuncionesProcedimientos.dtGeneral(string.Format("Exec CuentasEstadosFinancieros3 {0}, '{1}', '{2}', '{3}', '{4}', {5}", 
					(int)this.optReportes.Value, this.txtCuentas.Text.ToString().Trim(), CodigoCuenta,
		...
		private void btnGuardar_Click(object sender, System.EventArgs e)
		{
			...
			{		
				...
				//
				//				#endregion REPETIDOS
				//iCont=Funcion.iEscalarSQL(cdsSeteoF, string.Format("SELECT COUNT(*) FROM Cuenta where Selec2 = 1"));
				iCont=Funcion.iEscalarSQL(cdsSeteoF, string.Format("Exec CuentasContablesSelecCodigoCuentaEnlazar '{0}'", CodigoCuenta));


				string sSQL = string.Format("Exec CuentasContablesEnlazarEstado '{0}', '{1}', {2},{3},{4}, '{5}'",
					Convert.ToDateTime(this.dtDesde.Value).ToString("yyyyMMdd"),
					Convert.ToDateTime(this.dtHasta.Value).ToString("yyyyMMdd"),
					(int)IDCUENTA,
					codigoh,MenuLatinium.stUsuario,CodigoCuenta);
		...
		private void uGridCuentas_AfterCellUpdate(object sender, Infragistics.Win.UltraWinGrid.CellEventArgs e)
		{
			...
			{
				ActualizaValores((int)e.Cell.Row.Cells["idCuenta"].Value,(bool)e.Cell.Row.Cells["Selec2"].Value);
			}
		}

		private void ActualizaValores(int idCuenta, bool sSel)
		{
			string sSQL = string.Format("Exec CuentasContablesEnlazarActualizar {0}, {1}", idCuenta,sSel);
			Funcion.EjecutaSQL(cdsSeteoF, sSQL);
		}
		...
		{
			foreach(Infragistics.Win.UltraWinGrid.UltraGridRow dr in this.uGridCuentas.Rows.All)
			dr.Cells["Selec2"].Value = this.chkCuentas.Checked;
		}
		...
		private void uGridCuentas_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
		{
			if (Cerrado == true)
			{
				e.Layout.Bands[0].Columns["Selec2"].CellActivation = Infragistics.Win.UltraWinGrid.Activation.Disabled;
			}
		}

//		private void uGridCuentas_InitializeRow(object sender, Infragistics.Win.UltraWinGrid.InitializeRowEventArgs e)
//		{
//			try
//			{
//				if ((string)e.Row.Cells["CodigoCuenta"].Value != "") 
//				{
