...
//			this.uGridLocales2.DataSource = Funcion.dvProcedimiento(cdsSeteoF, "Select Bodega, Nombre, Convert(Bit, 1) As Sel From Bodega Where Activo = 1 And Factura = 1 Order By Nombre");
		...
		private void btnVer_Click(object sender, System.EventArgs e)
		{
			...
			if (this.uGridInformacion.Rows.Count > 0)
			{
				...
				{
					this.txtPorcEfectivo.Value = 0;
						this.txtPorcTarjeta.Value  = 0;
					this.txtPorcCrediPoint.Value = 0;
				}

				if (dSumaTotalUtilidad> 0)
				{
				...
				{
					this.txtPorcUtEfectivo.Value = 0;
					this.txtPorcUtTarjeta.Value = 0;
					this.txtPorcUtCrediPoint.Value = 0;
				}
				...
				{
						this.txtMargenEfectivo.Value = 0;
				}
				if (dSumaTarjeta> 0)
				{
				...
				{
					this.txtMargenCrediPOINT.Value = 0;
				}
				...
				{				
					...
					{
           	dr.Cells["PorcentajeVentasLocal"].Value = 0;
					}
					if (dSumaTotalUtilidad > 0)
					{
					...
					{
           dr.Cells["PorcentajeUtilidadLocal"].Value = 0;
					}

					if (Convert.ToDecimal(dr.Cells["Total"].Value ) > 0)
					{
