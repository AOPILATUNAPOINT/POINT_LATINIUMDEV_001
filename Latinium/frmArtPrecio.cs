...
{
	/// <summary>
	/// Descripción breve de frmArtPrecio.
	/// </summary>
	public class frmArtPrecio : System.Windows.Forms.Form
	{
		...
		int idArtPrecio = 0;
		public frmArtPrecio(int IdArtPrecio)
		{
			idArtPrecio = IdArtPrecio;
			//
			// Necesario para admitir el Diseñador de Windows Forms
			//
			InitializeComponent();
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idArtPrecio");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn1 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idArtPrecio");
			...
			this.Name = "frmArtPrecio";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Precio";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmArtPrecio_KeyDown);
			this.Load += new System.EventHandler(this.frmArtPrecio_Load);
		...
		private void frmArtPrecio_Load(object sender, System.EventArgs e)
		{
			this.ultraGrid1.DataSource = Funcion.dvProcedimiento(cdsSeteoF, string.Format("Select idArtPrecio, Precio From ArtPrecio Order By Precio"));
		}
		...
		private void btAceptar_Click(object sender, System.EventArgs e)
		{
			...
			{
				if ((int)drr.Cells["idArtPrecio"].Value == 0 || (int)drr.Cells["idArtPrecio"].Value > 0)
				{
					string sSQLDetalle = string.Format("Exec InsertaAtributosArticulos {0}, '{1}', {2}", 
						drr.Cells["idArtPrecio"].Value,
						drr.Cells["Precio"].Value.ToString(), 7);     
		...
		{
			e.Row.Cells["idArtPrecio"].Value = 0;
		}

		private void frmArtPrecio_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
