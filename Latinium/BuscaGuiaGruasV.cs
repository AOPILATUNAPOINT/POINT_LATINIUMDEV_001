...
namespace Latinium
{
	...
	/// </summary>
	public class BuscaGuiaGruasV : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridBand ultraGridBand1 = new Infragistics.Win.UltraWinGrid.UltraGridBand("GuiaRemisionPadre", -1);
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idGuiaRemisionPadre");
			...
			this.cdsGuia.DataSetDef = "dsGuiaRemisionPadre";
			...
			// idBusca
			// 
			this.idBusca.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.cdsGuia, "GuiaRemisionPadre.idGuiaRemisionPadre"));
			...
			this.ultraGrid1.DataMember = "GuiaRemisionPadre";
			...
			this.cdvGuia.TableViewName = "GuiaRemisionPadre";
			// 
			// BuscaGuiaGruasV
			// 
...
//		Opciones de comodines
			...
			C1.Data.FilterCondition fcPadre = new 
				C1.Data.FilterCondition(this.cdsGuia, "GuiaRemisionPadre", stFiltro);
