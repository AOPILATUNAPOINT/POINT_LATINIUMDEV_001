...
namespace Latinium
{
	...
	/// </summary>
	public class CheteTCLot : DevExpress.XtraEditors.XtraForm
	{
		...
		int IdPlazo = 0;
		private Infragistics.Win.UltraWinEditors.UltraTextEditor txtDesPrenda;
		string DesPrenda = "";

		public CheteTCLot(int iFormaDePago, int idBanco, int idTarjeta, int idCuenta, string sNumero, DateTime dtFecha, string sCuentaCorriente, string sVoucher, string sAutorizacion, string sLote, string sReferencia, int idPlan, int idPlazo)
		{
			//
		...
		private void InitializeComponent()
		{
			...
			this.lblPlazo.Location = new System.Drawing.Point(78, 256);
			...
			this.txtNumVoucher.Location = new System.Drawing.Point(112, 114);
			...
			this.lblAutorizacion.Location = new System.Drawing.Point(33, 144);
			...
			this.lblVoucher.Location = new System.Drawing.Point(53, 117);
			...
			this.txtAutorizacion.Location = new System.Drawing.Point(112, 141);
			...
			this.cmbTarjeta.Location = new System.Drawing.Point(112, 32);
			...
			this.lblBanco.Location = new System.Drawing.Point(64, 8);
			...
			this.cmbBanco.Location = new System.Drawing.Point(112, 6);
			...
			this.txtCuentaCheque.Location = new System.Drawing.Point(112, 87);
			...
			this.lblCtaCorriente.Location = new System.Drawing.Point(9, 90);
			...
			this.lblNumero.Location = new System.Drawing.Point(54, 61);
			...
			this.txtNumero.Location = new System.Drawing.Point(112, 58);
			...
			this.lblCaducidad.Location = new System.Drawing.Point(8, 90);
			...
			this.dtFecha.Location = new System.Drawing.Point(112, 88);
			...
			this.lblCuenta.Location = new System.Drawing.Point(59, 34);
			...
			this.cmbCuenta.Location = new System.Drawing.Point(112, 32);
			...
			this.lblLote.Location = new System.Drawing.Point(16, 186);
			...
			this.txtLote.Location = new System.Drawing.Point(48, 183);
			...
			this.lblReferencia.Location = new System.Drawing.Point(160, 186);
			...
			this.txtReferencia.Location = new System.Drawing.Point(224, 183);
			...
			this.cmbPlazo.Location = new System.Drawing.Point(112, 256);
			...
			this.lblPlanes.Location = new System.Drawing.Point(72, 240);
			...
			this.cmbPlanes.Location = new System.Drawing.Point(112, 240);
			...
			this.btCancelar.Location = new System.Drawing.Point(180, 368);
			...
			this.btGrabar.Location = new System.Drawing.Point(76, 368);
			...
			this.txtDesPrenda.Location = new System.Drawing.Point(8, 240);
			this.txtDesPrenda.Multiline = true;
			this.txtDesPrenda.Name = "txtDesPrenda";
			this.txtDesPrenda.Size = new System.Drawing.Size(328, 120);
			this.txtDesPrenda.TabIndex = 177;
			// 
			// label1
			// 
			...
			this.Controls.Add(this.txtDesPrenda);
			...
			this.Closing += new System.ComponentModel.CancelEventHandler(this.ChequeTarjeta_Closing);
...
//				}
		...
		private void txtNumVoucher_KeyPress(object sender, System.Windows.Forms.KeyPressEventArgs e)
		{
			...
			if (e.KeyChar == 13)
			{
				if (this.txtNumVoucher.Value != DBNull.Value)
				{
					this.txtAutorizacion.Focus();
				}
				else
				{
					MessageBox.Show("Escriba el número de voucher.", "Point Technology", MessageBoxButtons.OK, MessageBoxIcon.Error);
					this.txtNumVoucher.Focus();
				}
			}
		}
...
//				}
		...
		private void ChequeTarjeta_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
