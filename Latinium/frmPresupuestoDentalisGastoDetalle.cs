...
{
	/// <summary>
	/// Descripción breve de frmPresupuestoDentalisGastoDetalle.
	/// </summary>
	public class frmPresupuestoDentalisGastoDetalle : System.Windows.Forms.Form
	{
		...
		public frmPresupuestoDentalisGastoDetalle()
		{
			//
		...
		int iYear = 0;
		string sGrupo ="";
		public frmPresupuestoDentalisGastoDetalle(int IdCuentaAgrupa,string SMES,int IYear, string SGrupo )
		{
			//
			// Necesario para admitir el Diseñador de Windows Forms
			//
		...
		private void InitializeComponent()
		{
			...
			this.uGridInformacion.Size = new System.Drawing.Size(504, 360);
			...
			// 
			// frmPresupuestoDentalisGastoDetalle
			// 
			...
			this.Name = "frmPresupuestoDentalisGastoDetalle";
			this.Text = " ";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmPresupuestoDentalisGastoDetalle_KeyDown);
			this.Load += new System.EventHandler(this.frmPresupuestoDentalisGastoDetalle_Load);
		...
		private void frmPresupuestoDentalisGastoDetalle_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
			if (e.KeyCode == Keys.Escape) this.DialogResult = DialogResult.No;
		}

		private void frmPresupuestoDentalisGastoDetalle_Load(object sender, System.EventArgs e)
		{
			this.Text= "Periodo : " + sMES + "   -  Grupo : " + sGrupo;
			string sSQL = string.Format("Exec [PresupuestoDentalisGastoDeatlle] {0},'{1}',{2}", idCuentaAgrupa, sMES, iYear );
