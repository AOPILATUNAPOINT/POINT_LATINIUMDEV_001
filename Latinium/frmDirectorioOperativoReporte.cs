...
{
	/// <summary>
	/// Descripción breve de frmDirectorioOperativoReporte.
	/// </summary>
	public class frmDirectorioOperativoReporte : System.Windows.Forms.Form
	{
		...
		public frmDirectorioOperativoReporte()
		{
			//
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn2 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idDepartamento");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn6 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idCargo");
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn9 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("ext");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn1 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idDirectorio");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn8 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("email");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn9 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("ext");
			...
			ultraGridColumn3.Header.Caption = "Área";
			...
			ultraGridColumn8.Header.Caption = "Correo";
			...
			this.uGridPorlocal.Location = new System.Drawing.Point(8, 8);
			this.uGridPorlocal.Name = "uGridPorlocal";
			this.uGridPorlocal.Size = new System.Drawing.Size(1088, 440);
			this.uGridPorlocal.TabIndex = 660;
			// 
			// cdsSeteoF
			// 
			...
			this.ultraDataSource1.Band.Columns.AddRange(new object[] {
																																 ...
																																 ultraDataColumn10});
			// 
			// frmDirectorioOperativoReporte
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(1112, 462);
			this.Controls.Add(this.uGridPorlocal);
			this.KeyPreview = true;
			this.Name = "frmDirectorioOperativoReporte";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Directorio Operativo";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmDirectorioOperativoReporte_KeyDown);
			this.Load += new System.EventHandler(this.frmDirectorioOperativoReporte_Load);
		...
		private void frmDirectorioOperativoReporte_Load(object sender, System.EventArgs e)
		{
			string sSQLPa = string.Format("Exec ConsultaGeneralDirectorio");
			FuncionesProcedimientos.dsGeneralModulo(sSQLPa, this.uGridPorlocal);
			this.uGridPorlocal.DisplayLayout.Bands[0].SortedColumns.Add("Departamento", false, true);
		...
		private void frmDirectorioOperativoReporte_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
