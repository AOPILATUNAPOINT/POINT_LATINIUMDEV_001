...
namespace Latinium
{
	...
	public class frmLiquidacionBancoPichincha : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtFecha.Location = new System.Drawing.Point(816, 64);
			...
			this.Text = "Liquidación Banco Pichincha";
		...
		private void frmLiquidacionBancoPichincha_Load(object sender, System.EventArgs e)
		{
			...
			this.txtLote.MaxValue = Funcion.iEscalarSQL(cdsSeteoF, "Cre_RetornaUltimoLote 4");
			this.txtLote.Value = Funcion.iEscalarSQL(cdsSeteoF, "Select MAX(ISNULL(NumeroLote, 0)) + 1 From Compra Where idTipoFactura = 1 And Borrar = 0 And Estado In (10, 11) And idFormaPago = 9 And idEntidadFinanciera = 4 And CapturaLote = 1 And ISNULL(idAsientoLoteSolidario, 0) > 0");

			this.txtFecha.CalendarInfo.MinDate = Funcion.dtEscalarSQL(cdsSeteoF, "Select MAX(ISNULL(FechaVenta, 0)) From Compra Where idTipoFactura = 1 And Borrar = 0 And Estado In (10, 11) And idFormaPago = 9 And idEntidadFinanciera = 4 And CapturaLote = 1");
