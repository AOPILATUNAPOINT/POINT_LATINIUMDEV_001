		...
		private void ultraGrid1_AfterCellUpdate(object sender, Infragistics.Win.UltraWinGrid.CellEventArgs e)
		{
			if (bEdicion)
			{
				if (bActualiza)
				{
					...
					{
						bActualiza = false;
						FuncionesInventario.FacturacionCargaArticulos(sender, e, this.ultraGrid1, (int)this.cmbFormaPago.Value, idTipoPrecio, (int)this.cmbBodega.Value, 0, 0, 0, 0, 0, Convert.ToDateTime(this.dtFecha.Value), 13, true, false, false, false, 0, 0, (int)this.txtIdCliente.Value, 0, 0, false, false, 0, cdsSeteoF);
						bActualiza = true;
						this.cmdTotal();						
					} 
					#endregion Codigo
