...
{
	/// <summary>
	/// Descripción breve de frmFreelanceCalculoVenta.
	/// </summary>
	public class frmFreelanceCalculoVenta : System.Windows.Forms.Form
	{
		...
		public frmFreelanceCalculoVenta()
		{
			//
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idFreelanceCalculoVenta");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn2 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Desde");
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn3 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Hasta", -1, null, 0, Infragistics.Win.UltraWinGrid.SortIndicator.Ascending, false);
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn4 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Credito");
			Infragistics.Win.Appearance appearance2 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn5 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Contado");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn1 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idFreelanceCalculoVenta");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn4 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Credito");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn5 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Contado");
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmFreelanceCalculoVenta));
			...
			this.uGridInformacion.Size = new System.Drawing.Size(640, 176);
			this.uGridInformacion.TabIndex = 999;
			...
			this.btnGuardar.Location = new System.Drawing.Point(8, 192);
			this.btnGuardar.Name = "btnGuardar";
			this.btnGuardar.Size = new System.Drawing.Size(72, 23);
			this.btnGuardar.TabIndex = 1002;
			...
			this.btnSalir.Location = new System.Drawing.Point(88, 192);
			...
			this.Name = "frmFreelanceCalculoVenta";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Freelance Porcentaje Ventas";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmFreelanceCalculoVenta_KeyDown);
			this.Load += new System.EventHandler(this.frmFreelanceCalculoVenta_Load);
		...
		{
				e.Row.Cells["idFreelanceCalculoVenta"].Value = 0;
			e.Row.Cells["Contado"].Value = 0.00;
			e.Row.Cells["Credito"].Value = 0.00;
			e.Row.Cells["Tarjeta"].Value = 0.00;

		}

		private void frmFreelanceCalculoVenta_Load(object sender, System.EventArgs e)
		{
			miAcceso = new Acceso(cdsSeteoF, "280104");

			if (!Funcion.Permiso("2104", cdsSeteoF))
			{				
			...
			string sSQLPa = string.Format(" Exec ConsultaFreelanceCalculoVenta   ");
		...
		private void btnGuardar_Click(object sender, System.EventArgs e)
		{
			...
			foreach(Infragistics.Win.UltraWinGrid.UltraGridRow dr in this.uGridInformacion.Rows.All){
				...
				if((decimal)dr.Cells["Credito"].Value == 0)
				{
				...
				if((decimal)dr.Cells["Contado"].Value == 0)
				{
				...
				if((decimal)dr.Cells["Tarjeta"].Value == 0)
				{
			...
			using (SqlConnection oConexion = new SqlConnection("Password=Bl45o6$9;Persist Security Info=True;User ID= " + MenuLatinium.stUsuario + ";Initial Catalog=" + MenuLatinium.stDirFacturacion + ";Data Source=" + MenuLatinium.stDirServidor + "; max pool size=1024"))
			{
				...
				try
				{
					...
					foreach(Infragistics.Win.UltraWinGrid.UltraGridRow dr in this.uGridInformacion.Rows.All)
					{
						string  sSQLDet = string.Format("Exec GuardarFreelanceCalculoVenta {0}, '{1}', '{2}', {3}, {4}, {5}" ,

							Convert.ToInt32 ( dr.Cells["idFreelanceCalculoVenta"].Value), 
							...
							Convert.ToDecimal ( dr.Cells["Contado"].Value),
							Convert.ToDecimal ( dr.Cells["Tarjeta"].Value)
							);
		...
		private void frmFreelanceCalculoVenta_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
