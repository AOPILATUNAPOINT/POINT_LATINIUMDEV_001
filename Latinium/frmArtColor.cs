...
{
	/// <summary>
	/// Descripción breve de frmArtColor.
	/// </summary>
	public class frmArtColor : System.Windows.Forms.Form
	{
		...
		public frmArtColor(int IdArtColor)
		{
			idArtColor = IdArtColor;
			//
			// Necesario para admitir el Diseñador de Windows Forms
			//
			InitializeComponent();
		...
		private void InitializeComponent()
		{
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn1 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("idArtColor");
			...
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn1 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("idArtColor");
			Infragistics.Win.UltraWinDataSource.UltraDataColumn ultraDataColumn2 = new Infragistics.Win.UltraWinDataSource.UltraDataColumn("Color");
			...
			this.Name = "frmArtColor";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Color";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmArtColor_KeyDown);
			this.Load += new System.EventHandler(this.frmArtColor_Load);
		...
		private void btAceptar_Click(object sender, System.EventArgs e)
		{
			...
			{
				if ((int)drr.Cells["idArtColor"].Value == 0 || (int)drr.Cells["idArtColor"].Value > 0)
				{
					string sSQLDetalle = string.Format("Exec InsertaAtributosArticulos {0}, '{1}', {2}", 
						drr.Cells["idArtColor"].Value,
						drr.Cells["Color"].Value.ToString(), 2);     
		...
		{
			e.Row.Cells["idArtColor"].Value = 0;
		}
		...
		private void frmArtColor_Load(object sender, System.EventArgs e)
		{
			this.ultraGrid1.DataSource = Funcion.dvProcedimiento(cdsSeteoF, string.Format("Select idArtColor, Color From ArtColor Order By Color"));
		}

		private void frmArtColor_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
