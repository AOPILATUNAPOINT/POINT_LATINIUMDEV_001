...
{
	/// <summary>
	/// Summary description for frmReporteDeRetenciones.
	/// </summary>
	public class frmReporteDeRetenciones : DevExpress.XtraEditors.XtraForm
	{
		...
		public frmReporteDeRetenciones()
		{
			//
		...
		{
			this.ultraGrid1.DataSource = Funcion.dvProcedimiento(cdsSeteoF, "Exec ListaDeRetenciones");
		}
