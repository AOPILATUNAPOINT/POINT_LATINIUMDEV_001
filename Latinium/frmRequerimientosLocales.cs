...
namespace Latinium
{
	...
	public class frmRequerimientosLocales : System.Windows.Forms.Form
	{
		...
		private void frmRequerimientosLocales_Load(object sender, System.EventArgs e)
		{
			...
			this.cmbNEDepartamento.DataSource = Funcion.dvProcedimiento(cdsSeteoF, "Exec Listas 73, 0");
			this.ultraCombo1.DataSource = Funcion.dvProcedimiento(cdsSeteoF, "Exec Listas 73, 0");
