...
namespace Latinium
{
	...
	public class frmMantenimientoTarjetas : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			ultraGridColumn13.Header.Caption = "% Interés";
			...
			this.uGridPlazos.Size = new System.Drawing.Size(496, 376);
		...
		private void uGridTarjetas_CellChange(object sender, Infragistics.Win.UltraWinGrid.CellEventArgs e)
		{
			...
			if (e.Cell.Column.ToString() == "Sel")
			{
				...
				string sSQLAct = string.Format("Exec ActualizaMantenimientoTarjetas {0}, {1}, 0, 0, 0, 0, 0, {2},'20150101','20301231'", 
...
//				this.uGridPlanes.DataSource = Funcion.dvProcedimiento(cdsSeteoF, sSQL);
		...
		{				
			...
			{				
				...
				string sSQLAct = string.Format("Exec ActualizaMantenimientoTarjetas {0}, {1}, {2}, 0, 0, 0, 1, {3}, '20150101','20301231'", 
...
//			this.txtComision.Value = Funcion.dEscalarSQL(cdsSeteoF, sSQL);
		...
		private void uGridBancos_BeforeSelectChange(object sender, Infragistics.Win.UltraWinGrid.BeforeSelectChangeEventArgs e)
		{
			...
			this.uGridPlazos.DataSource = Funcion.dvProcedimiento(cdsSeteoF, "Select idPlazo, Descripcion, 0 As PorcComision, 0 As PorcInteres, 0 As Sel,  Convert (Datetime,'20301231') Desde ,  Convert (Datetime,'20301231') as Hasta  From Plazos Where idPlazo = 0");
		...
		private void uGridTarjetas_BeforeSelectChange(object sender, Infragistics.Win.UltraWinGrid.BeforeSelectChangeEventArgs e)
		{
			...
			this.uGridPlanes.DataSource = Funcion.dvProcedimiento(cdsSeteoF, " Select idPlan, Descripcion From Planes Where idPlan = 0");
			this.uGridPlazos.DataSource = Funcion.dvProcedimiento(cdsSeteoF, "Select idPlazo, Descripcion, 0 As PorcComision, 0 As PorcInteres, 0 As Sel, Convert (Datetime,'20150101') as Desde ,  Convert (Datetime,'20301231') as Hasta  From Plazos Where idPlazo = 0");
