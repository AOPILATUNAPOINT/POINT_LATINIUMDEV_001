...
//				textObject.Color = Color.Blue;
		...
		{		
			...
			oRpt.ExportToDisk(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, @"\\192.168.1.186\Latinium" + sNombre);// @"C:\Latinium\OrcCmp" + sNombre); // @"\\192.168.1.186\Latinium\OrdenesDeCompra" + sNombre); //MenuLatinium.stDirInicio + sNombre);
			oRpt = null;
			crVista.Dispose();
			crVista = null;
		}
