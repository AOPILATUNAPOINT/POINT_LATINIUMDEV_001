...
{
	/// <summary>
	/// Descripción breve de frmReporteMargenUtilidadPorFactura.
	/// </summary>
	public class frmReporteMargenUtilidadPorFactura : System.Windows.Forms.Form
	{
		...
		public frmReporteMargenUtilidadPorFactura()
		{
			//
     ...
     string sBodega=""; 
		...
		public frmReporteMargenUtilidadPorFactura(string SBodega, DateTime DDesde, DateTime DHasta, int IBodega )
		{
			//
			// Necesario para admitir el Diseñador de Windows Forms
			//
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmReporteMargenUtilidadPorFactura));
			...
			Infragistics.Win.UltraWinGrid.UltraGridColumn ultraGridColumn10 = new Infragistics.Win.UltraWinGrid.UltraGridColumn("Descuento");
			...
			Infragistics.Win.UltraWinGrid.SummarySettings summarySettings1 = new Infragistics.Win.UltraWinGrid.SummarySettings("", Infragistics.Win.UltraWinGrid.SummaryType.Sum, null, "Subtotal", 10, true, "Band 0", 0, Infragistics.Win.UltraWinGrid.SummaryPosition.UseSummaryPositionColumn, "Subtotal", 10, true);
			Infragistics.Win.Appearance appearance7 = new Infragistics.Win.Appearance();
			Infragistics.Win.UltraWinGrid.SummarySettings summarySettings2 = new Infragistics.Win.UltraWinGrid.SummarySettings("", Infragistics.Win.UltraWinGrid.SummaryType.Sum, null, "Descuento", 9, true, "Band 0", 0, Infragistics.Win.UltraWinGrid.SummaryPosition.UseSummaryPositionColumn, "Descuento", 9, true);
			...
			Infragistics.Win.UltraWinGrid.SummarySettings summarySettings4 = new Infragistics.Win.UltraWinGrid.SummarySettings("", Infragistics.Win.UltraWinGrid.SummaryType.Sum, null, "DescuentoPorc", 6, true, "Band 0", 0, Infragistics.Win.UltraWinGrid.SummaryPosition.UseSummaryPositionColumn, "DescuentoPorc", 6, true);
			...
			this.lblContador.Location = new System.Drawing.Point(-4, 111);
			this.lblContador.Name = "lblContador";
			this.lblContador.Size = new System.Drawing.Size(0, 20);
			this.lblContador.TabIndex = 964;
			...
			this.groupBox2.Location = new System.Drawing.Point(-104, 40);
			this.groupBox2.Name = "groupBox2";
			this.groupBox2.Size = new System.Drawing.Size(1304, 8);
			this.groupBox2.TabIndex = 962;
			...
			ultraGridColumn7.Header.Caption = "Dsc. Articulo";
			...
			this.uGridInformacion.Size = new System.Drawing.Size(1024, 312);
			this.uGridInformacion.TabIndex = 961;
			// 
			// lblContadores
			// 
			this.lblContadores.AutoSize = true;
			this.lblContadores.Font = new System.Drawing.Font("Tahoma", 10F);
			this.lblContadores.ForeColor = System.Drawing.Color.Firebrick;
			this.lblContadores.Location = new System.Drawing.Point(16, 8);
			this.lblContadores.Name = "lblContadores";
			this.lblContadores.Size = new System.Drawing.Size(0, 20);
			this.lblContadores.TabIndex = 965;
			this.lblContadores.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// ultraDataSource1
			// 
			...
			this.ultraDataSource1.Band.Columns.AddRange(new object[] {
																																 ...
																																 ultraDataColumn11});
			// 
			// frmReporteMargenUtilidadPorFactura
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(1040, 374);
			...
			this.Name = "frmReporteMargenUtilidadPorFactura";
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmReporteMargenUtilidadPorFactura_KeyDown);
			this.Load += new System.EventHandler(this.frmReporteMargenUtilidadPorFactura_Load);
		...
		private void frmReporteMargenUtilidadPorFactura_Load(object sender, System.EventArgs e)
		{
			string sSQLPc = string.Format("Exec ResumenMargenDeUtilidadDetalado '{0}', '{1}', '{2}' ", 
				iBodega, Convert.ToDateTime(dDesde).ToString("yyyyMMdd"), Convert.ToDateTime(dHasta).ToString("yyyyMMdd") );

			this.uGridInformacion.DataSource = FuncionesProcedimientos.dtGeneral(sSQLPc);		

			this.Text = this.Text + " * ALMACEN :  " + sBodega + " * Desde: "+ Convert.ToDateTime(dDesde).ToString("yyyyMMdd")+ " *  Hasta: " + Convert.ToDateTime(dHasta).ToString("yyyyMMdd")+ " * ";

		this.lblContadores.Text = this.uGridInformacion.Rows.Count + " REGISTROS ENCONTRADOS";
		}

		private void frmReporteMargenUtilidadPorFactura_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
