...
namespace Latinium
{
	...
	public class frmKardexSeriales : DevExpress.XtraEditors.XtraForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.dtpHasta.Location = new System.Drawing.Point(352, 48);
			...
			this.btnExcel.Location = new System.Drawing.Point(968, 8);
			this.btnExcel.Name = "btnExcel";
			this.btnExcel.Size = new System.Drawing.Size(88, 24);
			this.btnExcel.TabIndex = 697;
		...
		private void btnVer_Click(object sender, System.EventArgs e)
		{
			...
			string sSQL = string.Format("Exec ReporteSerialesKAR '{0}', {1}, {2}, {3}, '{4}', '{5}'", 
				this.txtArticulo.Text.ToString(), iEstado, iBodega, (int)this.rdgTipoConsulta.EditValue, dtHasta.ToString("yyyyMMdd"), Convert.ToDateTime(this.dtpHasta.Value).ToString("yyyyMMdd"));
